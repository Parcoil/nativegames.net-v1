...
pc.extend(pc, function() {
        ...
        return {
            ...
            ElasticInOut: function(t) {
                var i, e = .1,
                    n = .4;
                return 0 === t ? 0 : 1 === t ? 1 : (!e || e < 1 ? (e = 1, i = .1) : i = n * Math.asin(1 / e) / (2 * Math.PI), (t *= 2) < 1 ? e * Math.pow(2, 10 * (t -= 1)) * Math.sin((t - i) * (2 * Math.PI) / n) * -.5 : e * Math.pow(2, -10 * (t -= 1)) * Math.sin((t - i) * (2 * Math.PI) / n) * .5 + 1)
            }
        }
    }()),
    function() {
...
var Utils = {
    ...
    getAssetFromURL: function(e, t) {
        var r = new pc.Asset(e, "texture", {
            ...
            a = new Image;
        return a.crossOrigin = "anonymous", a.onload = function() {
            this && (n.setSource(this), n.upload(), r.loaded = !0)
        }, a.src = "map" == t ? Utils.prefixMapCDN + e : Utils.prefixCDN + e, r.resource = n, pc.app.assets.add(r), r
    },
    ...
    updateUsernames: function() {
        ...
        this.rainbowIndex++, clearTimeout(this.usernameTimeout), this.usernameTimeout = setTimeout((function(e) {
            e.updateUsernames()
        }), 50, this)
    },
    ...
    convertRainbow: function(e) {
        ...
        })).join(""), e.replace(/\[rainbow\](.*?)\[\/rainbow\](.*?)/, "\\[" + r + "]")) : e
    },
    ...
    mmssmm: function(e) {
        var t = e,
            ...
            o = "MM:SS:XX";
        return n < 10 && (n = "0" + n), a < 10 && (a = "0" + a), r < 100 && (r = "0" + r), o = (o = (o = o.replace(/MM/, a)).replace(/SS/, n)).replace(/XX/, r.toString().slice(0, 2))
    },
    mmss: function(e) {
        var t = e,
            r = Math.floor(1e3 * t % 1e3),
            ...
            a = Math.floor(1e3 * t / 6e4 % 60),
            o = "MM:SS";
        return n < 10 && (n = "0" + n), a < 10 && (a = "0" + a), r < 100 && (r = "0" + r), o = (o = o.replace(/MM/, a)).replace(/SS/, n), e >= 0 ? o : "00:00"
    },
...
var setMat4Forward = function() {
    var e, t, r;
    return e = new pc.Vec3, t = new pc.Vec3, r = new pc.Vec3,
        function(n, a, o) {
            r.copy(a).scale(-1), t.copy(o).normalize(), e.cross(t, r).normalize(), t.cross(r, e);
            var i = n.data;
...
Movement.attributes.add("defaultSpeed", {
    ...
    this.locked = !1, this.mouseLocked = !1, this.isMouseLocked = !1, this.lastDelta = 0, pc.dt = 1 / 60, this.heightVector = new pc.Vec3(0, -1e3, 0), this.glitchThreshold = 0, this.isZoomEffectEnabled = !1, this.reloadingFactor = 1, this.currentFriction = .2, this.previousVelocity = !1, this.collision = {
        start: {
            name: ""
        },
        end: {
    ...
    }, this.spreadCount = 0, this.spreadNumber = 0, this.jumpSpread = 0, this.force = new pc.Vec3(0, 0, 0), this.currentForce = new pc.Vec3(0, 0, 0), this.lastVelocity = new pc.Vec3(0, 0, 0), this.dynamicGravity = 0, this.footCount = 0, this.footForce = 0, this.groundMaterial = "Gravel", this.lastFootDate = this.now(), this.nearestPlayerPosition = new pc.Vec3(0, 0, 0), this.lastAutoLockTime = 0, this.timerBag = [], this.timerTween = [], this.animation = {
        jumpAngle: 0,
        landAngle: 0,
        jumpHeight: 0,
        bounceX: 0,
    ...
    this.isFocusing ? (this.lookX -= t * this.focusSensitivity * pc.settings.sensivity * this.mouseInvertAxis, this.lookY -= i * this.focusSensitivity * pc.settings.sensivity * this.mouseInvertAxis) : (this.lookX -= t * this.defaultSensitivity * pc.settings.sensivity * this.mouseInvertAxis, this.lookY -= i * this.defaultSensitivity * pc.settings.sensivity * this.mouseInvertAxis), this.isFocusing ? (this.senseX -= t * this.focusLookSense * this.mouseInvertAxis, this.senseY -= i * this.focusLookSense * this.mouseInvertAxis) : (this.senseX -= t * this.defaultLookSense * this.mouseInvertAxis, this.senseY -= i * this.defaultLookSense * this.mouseInvertAxis), this.lookX = this.lookX % 360
    ...
    this.entity.collision.enabled = !0, this.entity.rigidbody.enabled = !0, setTimeout((function() {
    ...
    return !this.player.isDeath && (!pc.isFinished && (!!pc.isMapLoaded && (t.other && ("Bounce" != t.other.name && "BouncePad" != t.other.name || this.bounceJump(this.airTime, t.other), ("Water" == t.other.name || t.other.tags.list().indexOf("Water") > -1) && this.app.fire("Network:Drown", !0), "Kill" == t.other.name && this.app.fire("Network:RequestRespawn", this.entity.getPosition().clone()), t.other && t.other.tags.list().indexOf("Damageable") > -1 && this.app.fire("Network:ObjectDamage", t.other._guid)), this.now() - this.leftAirTime > 1e3 && (this.airTime = this.now()), this.playerAbilities.isDashing && this.playerAbilities.triggerDashDamage(t), this.playerAbilities.isGrappling && this.playerAbilities.triggerGrappleDamage(t), this.collision.start = t.other, void((t.contacts[0].localPoint.y < -1.5 || t.contacts[0].localPoint.y < .001 && t.other && "Box" == t.other.name) && (this.isCollided = !0, this.land())))))
    ...
    this.isMouseLocked = t, this.isMouseLocked ? this.app.fire("Overlay:Pause", !1) : this.app.fire("Overlay:Pause", !0), this.app.fire("Overlay:Message@Hide", !0)
}, Movement.prototype.onMouseDown = function(t) {
    return !this.player.isDeath && (!this.player.isGliding && (!pc.isFinished && (!pc.isDisplayingAds && (!this.locked && (!this.mouseLocked && (!pc.isPauseActive && (!pc.isModeMenuActive && (("undefined" == typeof app || "Menu" != app.mode) && (this.app.fire("Mouse:Lock"), 2 === t.button && (this.isFocusing = !0, this.focusStartTime = this.now(), this.cancelInspect(!0), this.app.fire("Overlay:SetAmmo", !0)), 0 === t.button && (this.leftMouse = !0), void this.app.fire("Overlay:Message@Hide", !0))))))))))
}, Movement.prototype.onMouseMove = function(t) {
    return !this.player.isDeath && (!this.mouseLocked && (this.isMouseLocked && (this.isFocusing ? (this.lookX -= t.dx * this.focusSensitivity * pc.settings.adsSensivity * this.animation.movementFactor, this.lookY -= t.dy * this.focusSensitivity * pc.settings.adsSensivity * this.mouseInvertAxis * this.animation.movementFactor) : (this.lookX -= t.dx * this.defaultSensitivity * pc.settings.sensivity * this.animation.movementFactor, this.lookY -= t.dy * this.defaultSensitivity * pc.settings.sensivity * this.mouseInvertAxis * this.animation.movementFactor), this.isFocusing ? (this.senseX -= t.dx * this.focusLookSense * this.mouseInvertAxis, this.senseY -= t.dy * this.focusLookSense * this.mouseInvertAxis) : (this.senseX -= t.dx * this.defaultLookSense * this.mouseInvertAxis, this.senseY -= t.dy * this.defaultLookSense * this.mouseInvertAxis)), void(this.lookX = this.lookX % 360)))
}, Movement.prototype.onTouchMove = function(t, i) {
    if (this.player.isDeath) return !1;
    this.isFocusing ? (this.lookX -= t * this.focusSensitivity * pc.settings.sensivity * this.mouseInvertAxis, this.lookY -= i * this.focusSensitivity * pc.settings.sensivity * this.mouseInvertAxis) : (this.lookX -= t * this.defaultSensitivity * pc.settings.sensivity * this.mouseInvertAxis, this.lookY -= i * this.defaultSensitivity * pc.settings.sensivity * this.mouseInvertAxis), this.isFocusing ? (this.senseX -= t * this.focusLookSense * this.mouseInvertAxis, this.senseY -= i * this.focusLookSense * this.mouseInvertAxis) : (this.senseX -= t * this.defaultLookSense * this.mouseInvertAxis, this.senseY -= i * this.defaultLookSense * this.mouseInvertAxis), this.scanShootables(), this.lookX = this.lookX % 360
    ...
    this.isMobileForward = !1, this.isMobileBackward = !1, this.isMobileLeft = !1, this.isMobileRight = !1, "UP" == i && (this.isMobileForward = !0), "DOWN" == i && (this.isMobileBackward = !0), "RIGHT" == t && (this.isMobileRight = !0), "LEFT" == t && (this.isMobileLeft = !0), this.scanShootables()
    ...
    return !this.isFrozen && (!this.player.isDeath && (!pc.isFinished && (!this.locked && ("INPUT" != document.activeElement.tagName && (this.jumpingTime + this.jumpLandTime < this.timestamp && this.currentHeight < this.nearGround && (this.isForward = !1, this.isBackward = !1, this.isLeft = !1, this.isRight = !1), (this.app.keyboard.isPressed(pc.KEY_UP) || this.app.keyboard.isPressed(pc.KEY_W) || this.isMobileForward) && (this.isForward = !0), (this.app.keyboard.isPressed(pc.KEY_DOWN) || this.app.keyboard.isPressed(pc.KEY_S) || this.isMobileBackward) && (this.isBackward = !0), (this.app.keyboard.isPressed(pc.KEY_LEFT) || this.app.keyboard.isPressed(pc.KEY_A) || this.isMobileLeft) && (this.isLeft = !0), (this.app.keyboard.isPressed(pc.KEY_RIGHT) || this.app.keyboard.isPressed(pc.KEY_D) || this.isMobileRight) && (this.isRight = !0), this.app.keyboard.wasPressed(pc.KEY_SPACE) && this.jump(), this.app.keyboard.wasPressed(pc.KEY_R) && this.reload(), this.app.keyboard.wasPressed(pc.KEY_F) && this.triggerKeyF(), this.app.keyboard.wasPressed(pc.KEY_E) && this.triggerKeyE(), this.app.keyboard.wasPressed(pc.KEY_V) && this.player.spray(), this.app.keyboard.wasPressed(pc.KEY_X) && (this.leftMouse = !0, this.isMouseReleased = !0), this.app.keyboard.wasReleased(pc.KEY_X) && (this.leftMouse = !1), this.app.keyboard.wasPressed(pc.KEY_L) && (this.app.fire("Mouse:Lock"), this.app.fire("Overlay:Pause", !1)), this.app.keyboard.wasPressed(pc.KEY_M), this.app.keyboard.wasPressed(pc.KEY_J) && this.inspect(), this.app.keyboard.wasPressed(pc.KEY_SHIFT) && (this.isFocusing = !0), void(this.app.keyboard.wasReleased(pc.KEY_SHIFT) && (this.isFocusing = !1)))))))
    ...
    return this.now() - this.lastThrowDate < 1e3 * this.playerAbilities.throwCooldown && !this.playerAbilities.resetKeyF ? (this.entity.sound.play("Error"), !1) : !(this.isReloading > this.timestamp) && (!(this.playerAbilities.isHitting > this.timestamp) && (!this.player.isGliding && (this.isFocusing = !1, this.player.throw(), this.stopFiring(), this.playerAbilities.triggerKeyF(), void(this.lastThrowDate = this.now()))))
    ...
    this.isForward = !1, this.isBackward = !1, this.isLeft = !1, this.isRight = !1, pc.isFinished || pc.settings.hideCrosshair || (this.interface.crosshairEntity.enabled = !0), this.locked = !1
}, Movement.prototype.disableMovement = function() {
    this.isForward = !1, this.isBackward = !1, this.isLeft = !1, this.isRight = !1, this.currentSpeed = 0, this.interface.crosshairEntity.enabled = !1, this.isShooting = !1, this.isFocusing = !1, this.isFocused = !1, this.leftMouse = !1, this.isMouseReleased = !0, this.locked = !0
    ...
    return !(this.playerAbilities.isHitting > this.timestamp) && (this.isReloading > this.timestamp ? (this.inspectAfterReload = !0, !1) : !this.isInspect && (Math.random() > .6 && this.app.fire("Player:Speak", "Attack", 4), !(Math.random() > .8) && (this.timer.inspect0 = setTimeout((function(t) {
        t.isInspect = !0, t.tween.inspect0 = t.app.tween(t.animation).to({
            movementAngleX: 26.2,
            movementAngleY: 47.65,
            movementAngleZ: 2.89
        }, .5, pc.BackInOut).start()
    }), 1, this), this.timer.inspect1 = setTimeout((function(t) {
    ...
    }), 1200, this), this.timer.inspect2 = setTimeout((function(t) {
        t.tween.inspect2 = t.app.tween(t.animation).to({
            movementAngleX: 0,
            movementAngleY: 0,
            movementAngleZ: 0
        }, .5, pc.BackInOut).start(), t.isInspect = !1
    }), 2e3, this), void(this.inspectAfterReload = !1))))
}, Movement.prototype.cancelInspect = function(t) {
    t ? (this.animation.movementAngleX = 0, this.animation.movementAngleY = 0, this.animation.movementAngleZ = 0, this.inspectAfterReload = !1) : setTimeout((function(t) {
        t.animation.movementAngleX = 0, t.animation.movementAngleY = 0, t.animation.movementAngleZ = 0
    }), 500, this), this.tween.inspect0 && this.tween.inspect0.stop(), this.tween.inspect1 && this.tween.inspect1.stop(), this.tween.inspect2 && this.tween.inspect2.stop(), clearTimeout(this.timer.inspect0), clearTimeout(this.timer.inspect1), clearTimeout(this.timer.inspect2), this.interface.hidePrepare()
    ...
    this.isReloading = 0, this.animation.weaponAngleX = 0, this.animation.weaponAngleY = 0, this.animation.weaponAngleZ = 0, this.animation.takeX = 0, this.animation.takeY = 0, this.animation.takeZ = 0, this.currentWeapon.magazineAttach(), this.timerBag = [], this.timerTween = []
}, Movement.prototype.onTouchReload = function() {
    this.reload()
}, Movement.prototype.reload = function() {
    return !(this.playerAbilities.isHitting > this.timestamp) && (!(this.isReloading > this.timestamp) && (this.currentWeapon.capacity !== this.currentWeapon.ammo && (this.cancelInspect(), this.stopFiring(), this.player.fireNetworkEvent("r"), this.reloadingTime = this.currentWeapon.reloadingTime, this.reloadingTime = this.reloadingTime * this.reloadingFactor, this.isReloading = this.timestamp + this.reloadingTime, this.entity.sound.play("Takeout"), this.interface.showPrepare(), this.currentWeapon.tempAnimation && "Lilium" == this.player.characterName ? (this.entity.fire("Player:Reload", this.currentWeapon), this.timerBag.push(setTimeout((function(t) {
        t.setAmmoFull()
    }), 900 * this.reloadingTime, this)), !1) : (!0 === this.currentWeapon.hiddenReload ? (this.timerTween[0] = this.app.tween(this.animation).to({
        takeX: 19.86,
        takeY: 7.07,
        takeZ: -39.62
    }, .4 * .45 * this.reloadingTime, pc.BackInOut), this.timerTween[0].start()) : "Shotgun" == this.currentWeapon.type ? (this.timerTween[0] = this.app.tween(this.animation).to({
        weaponAngleX: -68.27,
        weaponAngleY: 29.63,
        weaponAngleZ: -14.15
    }, .4 * .45 * this.reloadingTime, pc.BackInOut), this.timerTween[0].start(), this.timerBag.push(setTimeout((function(t) {
        t.currentWeapon.hideArms()
    }), 67.5 * this.reloadingTime, this)), this.timerBag.push(setTimeout((function(t) {
        t.timerTween[1] = t.app.tween(t.animation).to({
            weaponAngleX: -65.42,
            weaponAngleY: 9.84,
            weaponAngleZ: 0,
            bounceAngle: 15
        }, .1, pc.BackInOut), t.timerTween[1].start(), t.currentWeapon.magazineThrow()
    }), 180 * this.reloadingTime, this))) : (this.timerTween[2] = this.app.tween(this.animation).to({
        weaponAngleX: 29.25,
        weaponAngleY: 6.02,
        weaponAngleZ: 30.34
    }, .4 * .45 * this.reloadingTime, pc.BackInOut), this.timerTween[2].start(), this.timerBag.push(setTimeout((function(t) {
        t.currentWeapon.hideArms()
    }), 67.5 * this.reloadingTime, this)), this.timerBag.push(setTimeout((function(t) {
        t.timerTween[3] = t.app.tween(t.animation).to({
            ...
            weaponAngleZ: 30.34,
            bounceAngle: 15
        }, .1, pc.BackInOut), t.timerTween[3].start(), t.currentWeapon.magazineThrow()
    }), 180 * this.reloadingTime, this))), this.timerBag.push(setTimeout((function(t) {
        t.timerTween[4] = t.app.tween(t.animation).to({
            bounceAngle: -5
        }, .1, pc.BackInOut), t.timerTween[4].start(), t.currentWeapon.magazineAttach()
    }), 450 * this.reloadingTime, this)), !1 === this.currentWeapon.hiddenReload && this.timerBag.push(setTimeout((function(t) {
        t.timerTween[5] = t.app.tween(t.animation).to({
            weaponAngleX: -68.27,
            weaponAngleY: 29.63,
            weaponAngleZ: -14.15
        }, .3, pc.BackInOut), t.timerTween[5].start()
    }), 630 * this.reloadingTime, this)), this.timerBag.push(setTimeout((function(t) {
        t.timerTween[6] = t.app.tween(t.animation).to({
            bounceZ: -.1
        }, .15, pc.BackInOut), t.timerTween[6].start(), t.currentWeapon.reload()
    }), 720 * this.reloadingTime, this)), this.timerBag.push(setTimeout((function(t) {
        t.timerTween[7] = t.app.tween(t.animation).to({
            weaponAngleX: 0,
            weaponAngleY: 0,
            weaponAngleZ: 0
        }, .15, pc.BackInOut), t.timerTween[7].start(), t.takeout()
    }), 1e3 * this.reloadingTime, this)), this.timerBag.push(setTimeout((function(t) {
        t.inspectAfterReload && t.inspect()
    }), 1e3 * this.reloadingTime + 900 * this.reloadingTime, this)), void this.timerBag.push(setTimeout((function(t) {
        t.setAmmoFull()
    }), 900 * this.reloadingTime, this))))))
}, Movement.prototype.hideWeapon = function() {
    this.isWeaponHidden = !0, this.app.tween(this.animation).to({
        takeX: -.52,
        takeY: 22.19,
        takeZ: -55.11
    }, .3, pc.BackInOut).start(), this.entity.sound.play("Takeout"), this.interface.hidePrepare()
}, Movement.prototype.takeout = function() {
    this.isWeaponHidden = !1, this.animation && (this.animation.takeX = -.52, this.animation.takeY = 22.19, this.animation.takeZ = -55.11, this.app.tween(this.animation).to({
        takeX: 0,
        takeY: 0,
        takeZ: 0
    }, .3, pc.BackInOut).start()), this.entity.sound.play("Takeout"), this.interface.hidePrepare(), this.app.fire("Overlay:SetAmmo", !0)
    ...
    if (this.app.tween(this.animation).to({
            cameraImpact: -t
        }, .09, pc.BackOut).start(), this.now() - this.lastImpactTime < 2e3) return !1;
    var i = "Grunt-" + (Math.round(1 * Math.random()) + 1);
    this.app.fire("Character:Sound", i, .1 * Math.random()), this.lastImpactTime = this.now()
    ...
    if (this.jumpingTime = this.timestamp + this.jumpDuration, this.isJumping = !0, this.isLanded = !1, this.airTime = this.now(), this.randomDirection = Math.random() > .5 ? -1 : 1, this.previousVelocity, this.now() - this.lastImpactTime > 3e3) {
        var t = "Jump-" + (Math.round(1 * Math.random()) + 1);
        this.app.fire("Character:Sound", t, .1 * Math.random()), this.entity.sound.play("Only-Jump"), this.entity.sound.slots["Only-Jump"].pitch = .1 * Math.random() + 1.1
    }
    ...
    if (this.airTime = this.now(), this.isLanded = !0, this.isJumping = !1, this.isForward = !1, this.isBackward = !1, this.isLeft = !1, this.isRight = !1, this.deltaHeight = 0, this.dynamicGravity = 0, this.previousVelocity = this.entity.rigidbody.linearVelocity.clone(), this.player.fireNetworkEvent("l"), this.entity.fire("Player:Land", !0), t < .3) return !1;
    if (this.isShooting > this.timestamp) return !1;
    if (Math.abs(this.currentHeight - this.lastHeight) > .1) {
        var i = Math.round(Math.random()) + 1;
        this.entity.sound.play("Land-" + i), this.app.tween(this.animation).to({
            landAngle: -.4 * t,
            cameraShootBounce: -5 * t
        }, .15, pc.BackOut).start(), this.footForce = 1
    }
}, Movement.prototype.setDamping = function(t) {
    if (this.player.isGliding) this.entity.rigidbody.linearDamping = this.airDamping, this.entity.rigidbody.applyForce(0, .5 * this.gravity, 0);
    ...
    } else this.movementSpeed < .5 ? this.entity.rigidbody.linearDamping = pc.math.lerp(this.entity.rigidbody.linearDamping, this.stopDamping, this.stoppingSpeed) : this.entity.rigidbody.linearDamping = this.groundDamping
}, Movement.prototype.setCurrentValues = function(t) {
    this.isLanded ? this.animation.jumpAngle = pc.math.lerp(this.animation.jumpAngle, 0, .2) : this.animation.jumpAngle = pc.math.lerp(this.animation.jumpAngle, 0, .05), this.animation.landAngle = pc.math.lerp(this.animation.landAngle, 0, .1);
    var i = 1;
    this.isLanded || (i = .1), this.currentForce.x = pc.math.lerp(this.currentForce.x, this.force.x, i), this.currentForce.y = pc.math.lerp(this.currentForce.y, this.force.y, i), this.currentForce.z = pc.math.lerp(this.currentForce.z, this.force.z, i)
    ...
    this.leftMouse && !this.isShootingLocked && !this.playerAbilities.isThrowing && this.isReloading < this.timestamp && this.playerAbilities.isHitting < this.timestamp && (this.isShooting = this.currentWeapon.shootTime + this.timestamp), this.isShooting > this.timestamp && !this.isShootingLocked && (this.cancelInspect(!0), this.app.tween(this.animation).rotate({
        takeX: -17.14,
        takeY: -30.81,
        takeZ: 42.11
    }, .2, pc.BackOut).start(), setTimeout((function(t) {
        t.app.tween(t.animation).rotate({
            takeX: 0,
            takeY: 0,
            takeZ: -67.42
        }, .1, pc.BackOut).start()
    }), 200, this), setTimeout((function(t) {
        t.playerAbilities.throwTrigger(t.currentWeapon)
    }), 160, this), setTimeout((function(t) {
        t.stopMeleeShooting()
    }), 1e3, this), this.isShootingLocked = !0, this.isShooting = this.currentWeapon.shootTime + this.timestamp), this.isShooting < this.timestamp && this.isShootingLocked && (this.isShootingLocked = !1)
}, Movement.prototype.setMeleeShoot = function() {
    if (this.leftMouse && !this.isShootingLocked && !this.playerAbilities.isThrowing && this.isReloading < this.timestamp && this.playerAbilities.isHitting < this.timestamp && (this.isShooting = this.currentWeapon.shootTime + this.timestamp), this.isShooting > this.timestamp && !this.isShootingLocked) {
        if (this.cancelInspect(!0), this.meleeShootingIndex % 2 == 0 ? (this.app.tween(this.animation).rotate({
                takeX: 137.28,
                takeY: 0,
                takeZ: 52.78
            }, .05, pc.BackOut).start(), setTimeout((function(t) {
                t.app.tween(t.animation).rotate({
                    takeX: 137.28,
                    takeY: 110,
                    takeZ: 52.78
                }, .2, pc.BackOut).start()
            }), 100, this), setTimeout((function(t) {
            ...
            }), 100, this), this.now() - this.lastImpactTime > 3e3 && Math.random() > .1) {
            var t = "Jump-" + (Math.round(1 * Math.random()) + 1);
            this.app.fire("Character:Sound", t, .1 * Math.random()), this.entity.sound.play("Only-Jump"), this.entity.sound.slots["Only-Jump"].pitch = .1 * Math.random() + 1.1
        }
    ...
    if (this.leftMouse && !this.isShootingLocked && !this.playerAbilities.isThrowing && this.isReloading < this.timestamp && this.playerAbilities.isHitting < this.timestamp && (this.isShooting = this.currentWeapon.shootTime + this.timestamp), this.isShooting > this.timestamp && !this.isShootingLocked) {
        ...
        this.app.fire("EffectManager:Rocket", i, this.raycastTo, !0), this.app.fire("NetworkManager:Rocket", i, this.raycastTo), this.isShootingLocked = !0, this.isShooting = this.currentWeapon.shootTime + this.timestamp, this.currentWeapon.shoot(), this.setShakeAnimation(t)
    }
    ...
    this.isFocusing && "Rifle" == this.currentWeapon.type && (o = -.05, n = .5, a = -.2, e *= .5, h = .05, r = this.currentWeapon.focusSpread, c = this.currentWeapon.focusSpread * p), "Sniper" != this.currentWeapon.type && "Shotgun" != this.currentWeapon.type || (a = -5, h = 5.2), this.lookY += .04 * e, this.spreadNumber = pc.math.lerp(this.spreadNumber, r, .1), this.spreadCount += t, this.currentWeapon.ammo--, this.app.fire("Overlay:Shoot", !0), this.app.tween(this.animation).to({
        bounceX: s,
        bounceZ: o,
        bounceAngle: n,
        shootSwing: h
    }, .03, pc.BackOut).start(), this.app.tween(this.animation).to({
        cameraShootBounce: a,
        cameraBounce: this.animation.cameraBounce + .025 * e
    }, .09, pc.BackOut).start(), this.animation.activeBounce = pc.math.lerp(this.animation.activeBounce, -e, .05), this.animation.horizantalSpread = pc.math.lerp(this.animation.horizantalSpread, .04 * c, .1)
    ...
    if ("Melee" == this.currentWeapon.type && this.setMeleeShoot(), "Throwable" == this.currentWeapon.type && this.setThrowShoot(), "Launcher" == this.currentWeapon.type && this.setLauncherShoot(t), this.player.checkShooting(), !this.currentWeapon.isShootable) return !1;
    if (this.leftMouse || this.isShootingLocked || this.isFireStopped || (this.stopFiring(), 0 === this.currentWeapon.ammo && this.reload()), this.leftMouse && !this.isWeaponHidden && !this.isShootingLocked && !this.playerAbilities.isThrowing && this.isReloading < this.timestamp && this.playerAbilities.isHitting < this.timestamp && (this.currentWeapon.ammo > 0 ? this.isShooting = this.currentWeapon.shootTime + this.timestamp : this.reload()), this.isShooting > this.timestamp && !this.isShootingLocked) {
        ...
        if ("Shotgun" == this.currentWeapon.type) {
            ...
            for (var u = 1, l = 0; l < 10; l++) l > 5 && (u = .5), a = Math.cos(l / 3 * Math.PI) * this.spreadNumber * u, h = Math.sin(l / 3 * Math.PI) * this.spreadNumber * u, r = Math.cos(l / 3 * Math.PI) * this.spreadNumber * u, p = this.raycastTo.clone().add(new pc.Vec3(a, h, r)), this.app.fire("EffectManager:Fire", n, p, o, this.player.playerId, c, "Shotgun", m)
    ...
    e && e.entity.tags && e.entity.tags.list().indexOf("Player") > -1 && e.entity.script && e.entity.script.enemy && ("-1" != e.entity.script.enemy.playerId && (("Sniper" != this.currentWeapon.type || "Sniper" == this.currentWeapon.type && this.isFocusing) && (this.leftMouse = !0), clearTimeout(this.mobileShootTimer), this.mobileShootTimer = setTimeout((function(t) {
        t.leftMouse = !1
    }), 300, this)))
}, Movement.prototype.setAutoLock = function(t) {
    this.lastAutoLockTime < this.timestamp && (this.nearestPlayerPosition = t, this.lastAutoLockTime = this.timestamp + .1)
    ...
    this.entity.rigidbody.linearVelocity.length() > 300 || this.currentHeight > 100 ? (this.glitchThreshold > 2 && this.app.fire("Network:Respawn", !0), this.glitchThreshold += t) : this.glitchThreshold = pc.math.lerp(this.glitchThreshold, 0, .1)
    ...
    this.jumpSpread = pc.math.lerp(this.jumpSpread, 0, .01)
    ...
    i > pc.dt - .001 && (this.setCommon(), this.setHandAngle(i), this.setCurrentValues(i), this.setMovementAnimation(i), this.checkGlitches(i), this.setShooting(i), (this.isMobile || pc.isGamepadActive) && this.updateAutoLock(), this.triggerGlobalEvents(), this.timestamp += i, this.lastDelta = 0)
...
"undefined" != typeof document && (
    ...
    function(t, e) {
        ...
        function D(t, e) {
            ...
            function r() {
                O.legend.fps !== L && (O.legend.fps = L, O.legend[c] = L ? "FPS" : "ms"), v = L ? y.fps : y.duration, O.count[c] = 999 < v ? "999+" : v.toFixed(99 < v ? 0 : F.decimals)
            }

            function m() {
                for (h = n(), A < h - F.threshold && (y.fps -= y.fps / Math.max(1, 60 * F.smoothing / F.interval), y.duration = 1e3 / y.fps), b = F.history; b--;) T[b] = 0 === b ? y.fps : T[b - 1], j[b] = 0 === b ? y.duration : j[b - 1];
                if (r(), F.heat) {
                    if (z.length)
                        for (b = z.length; b--;) z[b].el.style[o[z[b].name].heatOn] = L ? g(o[z[b].name].heatmap, y.fps, 0, F.maxFps) : g(o[z[b].name].heatmap, y.duration, F.threshold, 0);
                    if (O.graph && o.column.heatOn)
                        for (b = M.length; b--;) M[b].style[o.column.heatOn] = L ? g(o.column.heatmap, T[b], 0, F.maxFps) : g(o.column.heatmap, j[b], F.threshold, 0)
                }
                if (O.graph)
                    for (w = 0; w < F.history; w++) M[w].style.height = (L ? T[w] ? Math.round(x / F.maxFps * Math.min(T[w], F.maxFps)) : 0 : j[w] ? Math.round(x / F.threshold * Math.min(j[w], F.threshold)) : 0) + "px"
            }
            ...
            function V() {
                if (O.container && U(), o = D.theme[F.theme], !(p = o.compiledHeatmaps || []).length && o.heatmaps.length) {
                    for (w = 0; w < o.heatmaps.length; w++)
                        for (p[w] = [], b = 0; b <= C; b++) {
                            ...
                            var i = o.heatmaps[w].saturation,
                                ...
                                f = l = c = void 0;
                            f = void 0;
                            0 === (u = .5 >= h ? h * (1 + i) : h + i - h * i) ? e = "#000" : (c = (u - (d = 2 * h - u)) / u, f = (e *= 6) - (l = Math.floor(e)), f *= u * c, 0 === l || 6 === l ? (l = u, c = d + f, u = d) : 1 === l ? (l = u - f, c = u, u = d) : 2 === l ? (l = d, c = u, u = d + f) : 3 === l ? (l = d, c = u - f) : 4 === l ? (l = d + f, c = d) : (l = u, c = d, u -= f), e = "#" + N(l) + N(c) + N(u)), n[a] = e
                        }
                    o.compiledHeatmaps = p
                }
                for (var v in O.container = s(document.createElement("div"), o.container), O.count = O.container.appendChild(s(document.createElement("div"), o.count)), O.legend = O.container.appendChild(s(document.createElement("div"), o.legend)), O.graph = F.graph ? O.container.appendChild(s(document.createElement("div"), o.graph)) : 0, z.length = 0, O) O[v] && o[v].heatOn && z.push({
                    name: v,
                    el: O[v]
                });
                if (M.length = 0, O.graph)
                    for (O.graph.style.width = F.history * o.column.width + (F.history - 1) * o.column.spacing + "px", b = 0; b < F.history; b++) M[b] = O.graph.appendChild(s(document.createElement("div"), o.column)), M[b].style.position = "absolute", M[b].style.bottom = 0, M[b].style.right = b * o.column.width + b * o.column.spacing + "px", M[b].style.width = o.column.width + "px", M[b].style.height = "0px";
            ...
            y.options = F, y.fps = 0, y.duration = 0, y.isPaused = 0, y.tickStart = function() {
                ...
                h = n(), E += (h - A - E) / F.smoothing, y.fps = 1e3 / E, y.duration = P < A ? E : h - P, A = h
            }, y.pause = function() {
                return l && (y.isPaused = 1, clearTimeout(l), a(l), a(f), l = f = 0), y
            }, y.resume = function() {
                return l || (y.isPaused = 0, k()), y
            }, y.set = function(t, e) {
                return F[t] = e, L = "fps" === F.show, -1 !== R(t, u) && V(), -1 !== R(t, d) && s(O.container, F), y
        ...
        for (var a = t.cancelAnimationFrame || t.cancelRequestAnimationFrame, i = t.requestAnimationFrame, p = 0, h = 0, l = (o = ["moz", "webkit", "o"]).length; h < l && !a; ++h) i = (a = t[o[h] + "CancelAnimationFrame"] || t[o[h] + "CancelRequestAnimationFrame"]) && t[o[h] + "RequestAnimationFrame"];
        a || (i = function(e) {
            var o = n(),
                a = Math.max(0, 16 - (o - p));
            return p = o + a, t.setTimeout((function() {
                e(o + a)
            }), a)
        }, a = function(t) {
            clearTimeout(t)
...
Fps.prototype.initialize = function() {
    this.fps = new FPSMeter({
        heat: !0,
        graph: !0
    }), this.total = 0, this.count = 0, this.averageFps = 0, this.lowerFps = 20, this.mediumFps = 45, this.higherFps = 46, this.fpsResult = "", setTimeout((function(t) {
        t.averageFps = (t.total / t.count).toFixed(2), t.averageFps >= t.higherFps ? t.fpsResult = "Higher FPS (" + t.averageFps + ")" : t.averageFps >= t.lowerFps && t.averageFps <= t.mediumFps ? t.fpsResult = "Medium FPS (" + t.averageFps + ")" : t.fpsResult = "Low FPS (" + t.averageFps + ")", pc.currentMap && pc.app.fire("Analytics:Event", "FPS:" + pc.currentMap, t.fpsResult)
    }), 5e4, this)
...
Overlay.attributes.add("focusBulletsEntity", {
...
}, Overlay.prototype.hideBlackShadow = function() {}, Overlay.prototype.onDestroy = function() {
    for (var t in this.app.off("View:State", this.onState, this), clearTimeout(this.circularMenuTimer), clearTimeout(this.friendlyFireTimer), clearTimeout(this.teamChangeTimer), clearTimeout(this.holdTimer), clearTimeout(this.cardTimeout), clearTimeout(this.lastWeaponSelection), clearTimeout(this.activeTaskTimer), clearTimeout(this.taskHideTimer), clearTimeout(this.announceTimer), this.timers) clearTimeout(this.timers[t]), this.timers[t] = !1
}, Overlay.prototype.timeout = function(t, e, i, a, n) {
    var s = this.generateFunctionHash(t, e);
    return clearTimeout(this.timers[s]), this.timers[s] = setTimeout((function(e, i, a) {
        t(e, i, a)
    }), e, i, a, n), this.timers[s]
    ...
    var e = t.map;
    if (!e) return !1;
    e.split(" - ").length > 1 && (e = e.split(" - ")[0]) && (e = e.trim()), this.mapNameEntity.element.text = e.toLowerCase(), this.mapImageEntity.element.textureAsset = Utils.getAssetFromURL(e + "-Large.jpg", "map"), this.mapImageEntity.element.color = pc.colors.white, this.app.fire("Timeline:Focus", !0)
}, Overlay.prototype.onMessageShow = function(t) {
    this.messageEntity.enabled = !0, this.messageText.element.text = t, clearTimeout(this.messageTimer), this.messageTimer = setTimeout((function(t) {
    ...
    !0 === pc.settings.hideChat ? this.chatWrapperEntity.enabled = !1 : this.chatWrapperEntity.enabled = !0, pc.settings && !0 === pc.settings.fpsCounter ? this.statsEntity.enabled = !0 : this.statsEntity.enabled = !1, pc.settings && !0 === pc.settings.hideUIElements ? this.hideGameplay() : this.showGameplay()
    ...
    this.app.fire("View:Pause", "ReQueue"), pc.currentServer || (pc.currentServer = "EU"), pc.serverCode || (pc.serverCode = "1.0.22"), pc.currentMap || (pc.currentMap = "Sierra"), pc.maxPlayers || (pc.maxPlayers = 4), this.app.fire("Fetcher:ReQueue", {
    ...
    for (var n in a) {
        var s = a[n]; - 1 === s.tags.list().indexOf(t) ? s.enabled = !1 : s.enabled = !0, i && i.team && s.tags.list().indexOf("CUSTOM-TEAM") > -1 && (s.enabled = !0), i && i.allowAbilities && s.tags.list().indexOf("CUSTOM-ABILITY") > -1 && (s.enabled = !0)
    }
    "GUNGAME" == pc.currentMode ? this.weaponKeyEntity.parent.enabled = !1 : this.weaponKeyEntity.parent.enabled = !0, "TDM" == pc.currentMode || "PAYLOAD" == pc.currentMode || pc.currentModeOptions && pc.currentModeOptions.team || (this.healthBarColor.element.color = pc.colors.health)
}, Overlay.prototype.setQuestMessage = function(t, e) {
    if (this.questText.element.text = e, this.questEntity.enabled) return !1;
    this.questEntity.enabled = !0, this.questIcon.element.textureAsset = this.app.assets.find(t), this.timeout((function(t) {
...
}, Overlay.prototype.allowRespawn = function() {}, Overlay.prototype.onRespawn = function() {}, Overlay.prototype.onPreStart = function() {}, Overlay.prototype.onLoaded = function() {
    this.app.fire("DOM:Update", !0)
}, Overlay.prototype.onFriendlyFire = function() {
    this.friendlyFire.enabled = !0, clearTimeout(this.friendlyFireTimer), this.friendlyFireTimer = setTimeout((function(t) {
    ...
    return !Utils.isMobile() && (!pc.isFinished && ("undefined" != typeof app && (t ? (app.showPauseMenu(this.stats), this.hideGameplay()) : (app.hidePauseMenu(), this.showGameplay())), void(pc.isPauseActive = t)))
}, Overlay.prototype.openReport = function() {
    this.app.fire("View:Pause", "Report"), this.app.fire("Table:Users", {
        result: this.stats
    }), this.app.fire("Table:KickUsers", {
        result: this.stats
    })
}, Overlay.prototype.openKickMenu = function() {
    this.app.fire("View:Pause", "Kick"), this.app.fire("Table:KickUsers", {
        result: this.stats
    })
    ...
    "Melee" == t && (this.meleeTimer.setLocalScale(2.5, 2.5, 2.5), this.meleeTimer.tween(this.meleeTimer.getLocalScale()).to({
        x: 1,
        y: 1,
        z: 1
    }, .4, pc.BackOut).start(), this.entity.sound.play("Error"), this.entity.sound.play("Tick-Tock-Short"))
    ...
    for (var a in t) {
        ...
        h.element.text = Utils.displayUsername(n.username, h.element), l.findByName("Kill").element.text = n.kill + "", l.findByName("Death").element.text = n.death + "", l.findByName("Score").element.text = n.score + "", l.findByName("Tier").element.textureAsset = o, l.findByName("Character").element.textureAsset = r, n.verified && (l.findByName("Username").findByName("Verified").enabled = !0, l.findByName("Username").setLocalPosition(65, 0, 0)), n.emoji && (l.findByName("Username").findByName("Emoji").enabled = !0, l.findByName("Username").findByName("Emoji").enabled = this.app.assets.find("Charm-" + n.emoji + "-Emoji.png"), l.findByName("Username").setLocalPosition(65, 0, 0)), this.pausePlayers.push(l), e.addChild(l)
    }
    ...
    for (var a in t) {
        ...
        l.enabled = !0, l.setLocalPosition(0, s, 0);
        var h = l.findByName("Username");
        h.element.text = Utils.displayUsername(n.username, h.element), l.findByName("Kill").element.text = n.kill + "", l.findByName("Death").element.text = n.death + "", l.findByName("Score").element.text = n.score + "", l.findByName("Tier").element.textureAsset = o, l.findByName("Character").element.textureAsset = r, n.verified && (l.findByName("Username").findByName("Verified").enabled = !0, l.findByName("Username").setLocalPosition(65, 0, 0)), n.emoji && (l.findByName("Username").findByName("Emoji").enabled = !0, l.findByName("Username").findByName("Emoji").enabled = this.app.assets.find("Charm-" + n.emoji + "-Emoji.png"), l.findByName("Username").setLocalPosition(65, 0, 0)), this.playerStats.push(l), e.addChild(l)
    }
}, Overlay.prototype.onTeamChange = function(t) {
    if (pc.currentTeam == t) return !1;
    this.teamNotification.enabled = !0, this.teamNotification.setLocalPosition(0, -100, 0), this.teamNotificationText.element.text = "Your team changed to " + t + ".", this.teamNotification.tween(this.teamNotification.getLocalPosition()).to({
        x: 0,
        y: 150,
        z: 0
    }, .8, pc.BackOut).start(), "red" == t ? (this.teamNotification.element.color = pc.colors.redTeam, this.healthBarColor.element.color = pc.colors.redTeam, this.teamNameEntity.element.color = pc.colors.redTeam, this.teamNameEntity.element.text = "RED") : "blue" == t && (this.teamNotification.element.color = pc.colors.blueTeam, this.healthBarColor.element.color = pc.colors.blueTeam, this.teamNameEntity.element.color = pc.colors.blueTeam, this.teamNameEntity.element.text = "BLUE"), clearTimeout(this.teamChangeTimer), this.teamChangeTimer = setTimeout((function(t) {
        t.teamNotification.enabled = !1
    }), 7e3, this)
}, Overlay.prototype.setWhiteShadow = function(t) {
    t ? (this.entity.sound.play("White-Shadow"), this.whiteShadowEntity.enabled = !0, this.whiteShadowEntity.setLocalScale(80, 80, 80), this.whiteShadowEntity.tween(this.whiteShadowEntity.getLocalScale()).to({
        x: 45,
        y: 45,
        z: 45
    }, 1, pc.SineIn).start(), this.whiteShadowColor.element.opacity = 0, this.whiteShadowColor.tween(this.whiteShadowColor.element).to({
        opacity: 1
    }, 1, pc.SineIn).start(), this.holdEntity.enabled = !0, clearTimeout(this.holdTimer), this.holdBarEntity.setLocalScale(.01, 1, 1), this.holdAnimation && this.holdAnimation.stop(), this.holdAnimation = this.holdBarEntity.tween(this.holdBarEntity.getLocalScale()).to({
        x: 1,
        y: 1,
        z: 1
    }, 1, pc.SineIn), this.holdAnimation.start()) : this.holdAnimation && (this.entity.sound.stop("White-Shadow"), this.entity.sound.play("Whoosh"), this.whiteShadowEntity.enabled = !1, this.holdAnimation.stop(), this.holdAnimation = this.holdBarEntity.tween(this.holdBarEntity.getLocalScale()).to({
        x: .01,
        y: 1,
        z: 1
    }, .5, pc.SineIn), this.holdAnimation.start(), this.holdTimer = setTimeout((function(t) {
    ...
    this.app.fire("Overlay:Gameplay", !0), this.clearAbilityList(), this.abilityBar.setLocalScale(1, .001, 1), this.abilityHolderEntity.enabled = !1, this.skillIcon.enabled = !0, this.abilityNotification.enabled = !1, this.abilityBuyClock.enabled = !0, this.abilityBuyKey.enabled = !1, this.abilityBuyButton.findByName("TierLevel").element.color = pc.colors.gray, this.abilityBuyButton.findByName("Thumbnail").element.color = pc.colors.gray, this.isAbilitySelected = !1, this.isOvertime = !1
}, Overlay.prototype.onFinish = function() {
    pc.isPauseActive = !1, this.taskEntity.enabled = !1, this.achievementEntity.enabled = !1, this.focusBulletsEntity.enabled = !1, this.cardEntity.enabled = !1, this.entity.sound.stop("Card-Selection-Loop"), this.entity.sound.stop("Overtime-Loop"), this.abilities = [], this.hideAllGameplay()
}, Overlay.prototype.onPoint = function(t) {
    if (pc.isFinished) return !1;
    if (this.isDeath) return !1;
    var e = this.pointNumberEntity.clone();
    e.element.text = t + "", e.enabled = !0, e.setLocalPosition(0, -50, 0), this.pointHolder.addChild(e), this.entity.sound.play("Point"), e.tween(e.getLocalPosition()).to({
        x: 0,
        y: 0,
        z: 0
    }, .2, pc.BackOut).start(), e.tween(e.element).to({
        opacity: 1
    }, .2, pc.Linear).start(), this.timeout((function(t) {
        t.tween(t.getLocalPosition()).to({
            x: 0,
            y: 50,
            z: 0
        }, .2, pc.BackOut).start(), t.tween(t.element).to({
            opacity: 0
        }, .2, pc.Linear).start()
    }), 400, e), this.timeout((function(t) {
        t.destroy()
    }), 600, e)
}, Overlay.prototype.onCards = function(t) {
    for (var e in this.taskEntity.enabled = !1, this.achievementEntity.enabled = !1, this.focusBulletsEntity.enabled = !1, this.cardEntity.enabled = !0, this.cardTimer.enabled = !0, this.cardTitle.enabled = !0, this.isAbilitySelected = !1, this.abilityBuyClock.enabled = !0, this.abilityBuyKey.enabled = !1, this.abilityBuyButton.findByName("TierLevel").element.color = pc.colors.gray, this.abilityBuyButton.findByName("Thumbnail").element.color = pc.colors.gray, this.cardBackground.element.color = pc.colors.gray, this.cardBackground.element.opacity = .5, this.currentCards = t, this.entity.sound.play("Card-Selection-Loop"), this.entity.sound.play("Show-Cards"), this.entity.sound.play("Praying"), this.currentCards) {
        var i = this.currentCards[e],
            a = this.app.assets.find(i + "-Card.png"),
            n = 0,
            s = 220 * ((r = parseInt(e)) - 1);
        0 === r ? n = 3 : 2 === r && (n = -3), this.cardEntities[e].glow || (this.cardEntities[e].glow = this.cardEntities[e].findByName("Glow"), this.cardEntities[e].key = this.cardEntities[e].findByName("Key")), this.cardEntities[e].glow.setLocalScale(1, 1, 1), this.cardEntities[e].glow.element.opacity = 0, this.cardEntities[e].glow.element.color = pc.colors.white, this.cardEntities[e].key.enabled = !1, this.cardEntities[e].setLocalScale(.5, .5, .5), this.cardEntities[e].setLocalPosition(s, 0, 0), this.cardEntities[e].setLocalEulerAngles(0, 0, n), this.cardEntities[e].enabled = !0, this.cardEntities[e].element.opacity = 0, this.cardEntities[e].element.textureAsset = a
    }
    for (var o in this.cardEntities) {
        var r, l = this.cardEntities[o],
            h = (s = 220 * ((r = parseInt(o)) - 1), r % 2 == 0 ? 0 : 30),
            y = .6 * (r + 1);
        l.tween(l.getLocalPosition()).to({
            x: s,
            y: h,
            z: 0
        }, .5, pc.BackOut).delay(y).start(), l.tween(l.getLocalScale()).to({
            x: .7,
            y: .7,
            z: .7
        }, 1, pc.BackOut).delay(y).start(), this.timeout((function(t, e) {
            e.key.enabled = !0, e.glow.enabled = !0, e.glow.tween(e.glow.element).to({
                opacity: .1
            }, .2, pc.Linear).delay(.3).start(), e.glow.tween(e.glow.getLocalScale()).to({
                x: 1.1,
                y: 1.1,
                z: 1.1
            }, .2, pc.BackOut).delay(.3).start(), t.entity.sound.slots["Show-Card"].pitch = .1 * Math.random() + 1, t.entity.sound.play("Show-Card")
        }), 1e3 * y, this, l), l.tween(l.element).to({
            opacity: 1
        }, .5, pc.Linear).delay(y).start()
    }
    clearTimeout(this.cardTimeout), this.cardTimeout = setTimeout((function(t) {
    ...
    this.cardTimer.enabled = !1, this.cardTitle.enabled = !1, this.entity.sound.play("Select-Ability"), this.app.fire("Player:Speak", "Weapon-Selection", 1), e.key.enabled = !1, e.glow.element.opacity = .8, e.glow.element.color = pc.colors.active, e.glow.setLocalScale(1.05, 1.05, 1.05), e.tween(e.getLocalPosition()).to({
        x: 0,
        y: 0,
        z: 0
    }, .5, pc.BackOut).start(), e.tween(e.getLocalScale()).to({
        x: 1.1,
        y: 1.1,
        z: 1.1
    }, .5, pc.BackOut).delay(.4).start(), e.tween(e.getEulerAngles()).rotate({
        x: 0,
        y: 0,
        z: 0
    }, .3, pc.BackOut).start(), this.timeout((function(t) {
        t.entity.sound.play("Add-Ability"), e.tween(e.getLocalPosition()).to({
            x: 600,
            y: -100,
            z: 0
        }, .4, pc.Linear).start(), e.tween(e.getLocalScale()).to({
            x: .32,
            y: .32,
            z: .32
        }, .35, pc.Linear).delay(.05).start(), e.tween(e.getLocalEulerAngles()).rotate({
            x: 0,
            y: 0,
            z: 90
        }, .2, pc.BackOut).delay(.2).start(), t.timeout((function() {
            t.cardBackground.tween(t.cardBackground.element).to({
                opacity: 1,
                color: pc.colors.black
            }, .2, pc.Linear).start()
        }), 400), t.timeout((function() {
            t.entity.sound.stop("Card-Selection-Loop"), t.entity.sound.stop("Praying"), t.cardEntity.enabled = !1
        }), 600)
    }), 1400, this), -1 === this.abilities.indexOf(i) && this.abilities.push(i), this.setAbilityList(), this.app.fire("Analytics:Event", "Card", i)
    ...
    return !pc.isFinished && (!this.isDeath && (this.subtitleEntity.element.text = t, this.subtitleEntity.enabled = !0, void this.timeout((function(t) {
    ...
    this.weaponTimer = 8, this.weaponTimeout.enabled = !0, this.weaponTimeoutSet(), clearTimeout(this.lastWeaponSelection), this.lastWeaponSelection = setTimeout((function(t) {
        t.weaponTimeout.enabled = !1
    }), 8e3, this)
}, Overlay.prototype.weaponTimeoutSet = function() {
    this.weaponTimeoutText.element.text = "Please wait " + this.weaponTimer + " seconds...", this.weaponTimer--, this.weaponTimer > 0 && this.timeout((function(t) {
        t.weaponTimeoutSet()
    }), 1e3, this)
...
}, Overlay.prototype.showSmallBanner = function(t) {}, Overlay.prototype.triggerSmallBanner = function(t) {}, Overlay.prototype.onCircularMenu = function(t) {
    ...
    for (var a in t) {
        ...
        l.setLocalScale(.5, .5, .5), l.findByName("Key").element.text = o + 1 + "", l.findByName("Icon").element.textureAsset = s, l.findByName("Icon").setLocalEulerAngles(0, 0, -e - i), l.setLocalEulerAngles(0, 0, e), l.tween(l.getLocalScale()).to({
            x: 1.1,
            y: 1.1,
            z: 1.1
        }, .35 + r, pc.BackOut).delay(r).start(), this.timeout((function(t, e) {
            e.enabled = !0, t.entity.sound.play("Whoosh")
        }), 1e3 * r, this, l), this.circularHolder.addChild(l), this.circularItems.push(l), this.circularItemsList.push(n), e -= 62
    }
    this.circularHolder.setLocalEulerAngles(0, 0, i), this.circularSpinner.enabled = !0, this.circularEntity.setLocalPosition(0, -300, 0), this.circularEntity.tween(this.circularEntity.getLocalPosition()).to({
        x: 0,
        y: 125,
        z: 0
    }, .5, pc.BackOut).start(), this.timeout((function(t) {
        t.hideCircularMenu()
    }), 3500, this)
}, Overlay.prototype.showDeathBanner = function() {
    this.deathBannerEntity.enabled = !0, this.deathLoadingEntity.enabled = !0, setTimeout((function(t) {
        t.setDeathBanner()
    }), 100, this), this.lastBannerShow = Date.now()
}, Overlay.prototype.setDeathBanner = function() {
    var t = this;
    if ("undefined" != typeof PokiSDK && PokiSDK && !PokiSDK.isAdBlocked()) {
        var e = document.getElementById("death-venge-728x90");
        e ? (PokiSDK.destroyAd(e), PokiSDK.displayAd(e, "728x90", (function() {
            t.setRespawnTimer()
        }))) : this.setRespawnTimer()
    } else this.setRespawnTimer()
}, Overlay.prototype.setRespawnTimer = function() {
    this.app.fire("Network:SetRespawnTimer"), setTimeout((function(t) {
    ...
    if (i > -1) {
        ...
        if (a && a.element && a.element.color) {
            ...
            for (var n in a.element.color = pc.colors.active, a.tween(a.getLocalScale()).to({
                    x: 1.2,
                    y: 1.2,
                    z: 1.2
                }, .2, pc.BackOut).start(), a.setLocalEulerAngles(0, 0, 0), a.findByName("Icon").setLocalEulerAngles(0, 0, 0), this.circularHolder.tween(this.circularHolder.getLocalEulerAngles()).rotate({
                    x: 0,
                    y: 0,
                    z: 0
                }, .2, pc.BackOut).start(), this.circularSpinner.enabled = !1, this.circularItems) {
    ...
    this.circularMenuTimer = setTimeout((function(t) {
        t.hideCircularMenu()
    }), 1500, this)
}, Overlay.prototype.hideCircularMenu = function() {
    this.entity.sound.play("Whoosh"), this.circularEntity.tween(this.circularEntity.getLocalPosition()).to({
        x: 0,
        y: -300,
        z: 0
    }, .5, pc.BackOut).start(), clearTimeout(this.circularMenuTimer), this.circularMenuTimer = setTimeout((function(t) {
    ...
    for (var s in t) {
        ...
        o.heroSkin && "Default" != o.heroSkin && (h = Utils.getAssetFromURL(o.heroThumbnail)), "GUNGAME" == pc.currentMode && (l = this.app.assets.find("Rank-" + o.tier + ".png"));
        var y = this.leaderboardItem.clone();
        y.enabled = !0, this.lastRank[o.username] > -1e3 ? (y.setLocalPosition(-3 * parseInt(s), this.lastRank[o.username], 0), y.tween(y.getLocalPosition()).to({
            x: -3 * parseInt(s),
            y: a,
            z: 0
        }, .3, pc.Linear).start(), this.lastRank[o.username] != a && (this.app.fire("Timeline:SortingEffect", !0), this.entity.sound.play("Small-Whoosh"))) : y.setLocalPosition(-3 * parseInt(s), a, 0), y.setLocalScale(i, i, i), y.findByName("Bar").setLocalScale(o.bar, 1, 1), y.findByName("Tier").element.textureAsset = l, y.findByName("Rank").element.text = r + 1 + ".", y.findByName("Character").element.textureAsset = h;
        var c = y.findByName("Username");
        c.element.text = Utils.displayUsername(o.username, c.element), "red" == o.team ? (y.findByName("Team").element.color = pc.colors.redTeam, y.findByName("Team").enabled = !0) : "blue" == o.team ? (y.findByName("Team").element.color = pc.colors.blueTeam, y.findByName("Team").enabled = !0) : y.findByName("Team").enabled = !1, o.isMe && (y.findByName("Username").element.color = pc.colors.me, y.findByName("Leader").element.color = pc.colors.me, n = r);
        var p = 200;
        o.verified ? (y.findByName("Username").findByName("Verified").enabled = !0, y.findByName("Username").setLocalPosition(55, -7, 0), p = Math.max(y.findByName("Username").element.width + 90 + 20, 165), y.element.width = p) : o.emoji ? (y.findByName("Username").findByName("Emoji").enabled = !0, statRow.findByName("Username").findByName("Emoji").enabled = this.app.assets.find("Charm-" + stat.emoji + "-Emoji.png"), y.findByName("Username").setLocalPosition(55, -7, 0), p = Math.max(y.findByName("Username").element.width + 90 + 20, 165), y.element.width = p) : (p = Math.max(y.findByName("Username").element.width + 90, 165), y.element.width = p), y.findByName("Leader").enabled = 0 === r, this.leaderboardEntity.addChild(y), this.leaderboardItems.push(y), this.lastRank[o.username] = a, a += -45 * (i -= .15) - 10
    }
    this.leaderboardEntity.element.height = 50 - a, this.myLastRank != n && (0 === n && 0 !== this.myLastRank && this.app.fire("Overlay:Subtitle", "You are the leader now!"), 0 === this.myLastRank && 0 !== n && this.app.fire("Overlay:Subtitle", "You are no longer leader."), this.myLastRank = n)
    ...
    this.currentSkillTime--, this.skillCountText.element.text = this.currentSkillTime + "", this.currentSkillTime <= 0 ? this.setSkillState(!0) : this.timeout((function(t) {
        t.setSkillTime()
    }), 1e3, this)
}, Overlay.prototype.setMeleeTime = function() {
    this.currentMeleeTime--, this.meleeCountText.element.text = this.currentMeleeTime + "", this.currentMeleeTime <= 0 ? this.setMeleeState(!0) : this.timeout((function(t) {
        t.setMeleeTime()
    }), 1e3, this)
    ...
    this.skillKeyEntity.enabled = t, this.skillTimer.enabled = !t, t ? (this.abilityIcon.element.color = new pc.Color(1, 1, 1), this.skillIcon.element.color = new pc.Color(1, 1, 1), this.entity.sound.play("Active")) : (this.skillIcon.element.color = this.skillClockIcon.element.color, this.abilityIcon.element.color = this.skillClockIcon.element.color)
}, Overlay.prototype.onExplosive = function(t) {
    if ("Star" == t.type) return !1;
    this.explosiveEntity = t, this.lastExplosiveWarning = this.now(), this.explosiveIndicator.enabled = !0, this.explosiveAnimation1 = this.explosiveIndicator.tween(this.explosiveIndicator.getLocalScale()).to({
        x: 1.05,
        y: 1.05,
        z: 1.05
    }, .15, pc.Linear).yoyo(!0).loop(!0), this.explosiveAnimation2 = this.explosiveIndicatorArrow.tween(this.explosiveIndicatorArrow.getLocalScale()).to({
        x: 1.35,
        y: 1.35,
        z: 1.35
    }, .1, pc.Linear).yoyo(!0).loop(!0), this.explosiveAnimation1.start(), this.explosiveAnimation2.start(), this.entity.sound.play("Tick-Tock"), this.timeout((function(t) {
    ...
    i > 1e3 && i < 1400 ? (this.explosiveIndicatorArrow.element.color = pc.colors.danger, this.entity.sound.slots["Emergency-Alarm"].isPlaying || this.entity.sound.play("Emergency-Alarm")) : this.explosiveIndicatorArrow.element.color = pc.colors.explosive;
    ...
    return !this.isTransitionPlaying && (!!pc.isMapLoaded && (t ? (this.leftCinema.element.color = t, this.rightCinema.element.color = t) : (this.leftCinema.element.color = pc.colors.black, this.rightCinema.element.color = pc.colors.black), this.isTransitionPlaying = !0, this.leftCinema.enabled = !0, this.rightCinema.enabled = !0, this.entity.sound.slots.Whoosh.pitch = 1.1, this.entity.sound.play("Whoosh"), this.leftCinema.setLocalEulerAngles(0, 0, 15), this.leftCinema.setLocalScale(.1, 0, 0), this.leftCinema.tween(this.leftCinema.getLocalScale()).to({
        x: 1.4,
        y: 1,
        z: 1
    }, .35, pc.Linear).start(), this.rightCinema.setLocalEulerAngles(0, 0, 15), this.rightCinema.setLocalScale(.1, 0, 0), this.rightCinema.tween(this.rightCinema.getLocalScale()).to({
        x: 1.4,
        y: 1,
        z: 1
    }, .35, pc.Linear).start(), this.timeout((function(t) {
        t.leftCinema.setLocalEulerAngles(0, 0, -15), t.leftCinema.tween(t.leftCinema.getLocalScale()).to({
            x: .1,
            y: 1,
            z: 1
        }, .35, pc.Linear).start(), t.rightCinema.setLocalEulerAngles(0, 0, -15), t.rightCinema.tween(t.rightCinema.getLocalScale()).to({
            x: .1,
            y: 1,
            z: 1
        }, .35, pc.Linear).start(), t.entity.sound.slots.Whoosh.pitch = 1, t.entity.sound.play("Whoosh")
    }), 400, this), void this.timeout((function(t) {
    ...
    this.healthBarEntity.tween(this.healthBarEntity.element).to({
        width: e
    }, .5, pc.SineOut).start(), this.healthValue.element.text = Math.abs(this.health) + "", "TDM" == pc.currentMode || "PAYLOAD" == pc.currentMode || pc.currentModeOptions && pc.currentModeOptions.team || (this.health < 30 ? this.healthBarColor.element.color = pc.colors.lowHealth : this.healthBarColor.element.color = pc.colors.health)
}, Overlay.prototype.setStatus = function(t) {
    this.statusEntity.enabled = !0, this.statusEntity.setLocalPosition(0, 50, 0), this.statusEntity.tween(this.statusEntity.getLocalPosition()).to({
        x: 0,
        y: -85,
        z: 0
    }, .2, pc.BackOut).start(), this.statusEntity.element.text = t, this.timeout((function(t) {
        t.statusEntity.enabled = !1
    }), 4e3, this)
}, Overlay.prototype.setRespawn = function() {
    this.respawnEntity.enabled = !1, this.isDeath = !1, pc.isFinished || pc.isPauseActive || this.showGameplay()
}, Overlay.prototype.setReminder = function(t) {
    if (this.reminderEntity.enabled) return !1;
    this.reminderEntity.enabled = !0, this.reminderEntity.setLocalPosition(0, -140, 0), this.reminderEntity.tween(this.reminderEntity.getLocalPosition()).to({
        x: 0,
        y: 130,
        z: 0
    }, .25, pc.BackOut).start(), this.reminderTextEntity.element.text = t.toUpperCase(), this.timeout((function(t) {
    ...
    var o = 2500;
    i - e < 5 && (o = 800), s ? this.taskLabelEntity.enabled = !1 : (this.abilityBuyButton.findByName("TierLevel").element.text = t, this.taskLabelEntity.enabled = !0), n && (this.taskIconEntity.element.textureAsset = this.app.assets.find(n)), this.activeTaskTimer = setTimeout((function(s) {
        s._onTaskMessage(t, e, i, a, n)
    }), o, this)
}, Overlay.prototype.setTaskScore = function(t, e, i, a, n) {
    this.taskTitleEntity.element.text = t, this.taskCountEntity.element.text = i + " / " + a, this.taskLevelEntity.setLocalScale(e / a, 1, 1), this.taskLevelEntity.tween(this.taskLevelEntity.getLocalScale()).to({
        x: i / a,
        y: 1,
        z: 1
    }, .8, pc.BackOut).delay(n).start(), this.abilityBar.setLocalScale(1, e / a, 1), this.abilityBar.tween(this.abilityBar.getLocalScale()).to({
        x: 1,
        y: i / a,
        z: 1
    }, .8, pc.BackOut).delay(n).start(), this.setTaskHideTimer()
}, Overlay.prototype._onTaskMessage = function(t, e, i, a, n) {
    this.taskEntity.enabled = !0, this.taskEntity.setLocalPosition(0, -75, 0), this.taskEntity.tween(this.taskEntity.getLocalPosition()).to({
        x: 0,
        y: 25,
        z: 0
    }, .25, pc.BackOut).start(), this.setTaskScore(t, e, i, a, .25), this.timeout((function(t) {
        t.entity.sound.play("Data-Increase")
    }), 250, this), this.setTaskHideTimer()
}, Overlay.prototype.setTaskHideTimer = function() {
    clearTimeout(this.taskHideTimer), this.taskHideTimer = setTimeout((function(t) {
        t.taskEntity.tween(t.taskEntity.getLocalPosition()).to({
            x: 0,
            y: -75,
            z: 0
        }, .1, pc.BackOut).start(), t.timeout((function() {
            t.taskEntity.enabled = !1, t.activeTaskTimer = !1
        }), 100)
    }), 3e3, this)
}, Overlay.prototype.onUnlock = function(t, e) {
    this.taskEntity.enabled = !1, this.abilityNotification.enabled = !1, this.abilityBuyClock.enabled = !1, this.abilityBuyKey.enabled = !0, this.abilityBuyButton.findByName("TierLevel").element.color = pc.colors.white, this.abilityBuyButton.findByName("Thumbnail").element.color = pc.colors.white, this.abilityBuyButton.findByName("TierLevel").element.text = t, this.achievementName.element.text = t + " - Abilities", this.achievementLevel.element.text = "Unlocked (" + e + "/" + e + ")";
    var i = this.achievementEntity.findByTag("Card");
    for (var a in i) {
        var n = i[a],
            s = .3 * parseInt(a) + .5;
        n.setLocalPosition(84.136, 89.082, 0), n.setLocalEulerAngles(0, 0, 0), n.element.opacity = 1, n.tween(n.getLocalPosition()).to({
            x: 640,
            y: 265
        }, 1, pc.BackOut).delay(s).start(), n.tween(n.getLocalEulerAngles()).rotate({
            z: 165
        }, 1, pc.Linear).delay(s).start(), n.tween(n.element).to({
            opacity: 0
        }, .2, pc.Linear).delay(s + .5).start(), this.timeout((function(t) {
            t.entity.sound.play("Whoosh")
        }), 1e3 * s, this)
    }
    this.achievementEntity.enabled = !0, this.achievementEntity.setLocalPosition(0, -75, 0), this.achievementEntity.tween(this.achievementEntity.getLocalPosition()).to({
        x: 0,
        y: 38,
        z: 0
    }, .15, pc.BackOut).start(), this.hasAbility || (this.abilityNotification.enabled = !0, this.abilityInfo.enabled = !0, this.abilityInfo.setLocalPosition(-145, 0, 0), this.abilityInfo.tween(this.abilityInfo.getLocalPosition()).to({
        x: -165,
        y: 0,
        z: 0
    }, .3, pc.Linear).yoyo(!0).repeat(7).start(), this.timeout((function(t) {
        t.abilityInfo.enabled = !1, t.abilityNotification.enabled = !1
    }), 1e4, this), this.hasAbility = !0), this.entity.sound.play("Deep-Whoosh"), this.timeout((function(t) {
    ...
    a > -180 && a < 0 && (this.leftDamageEntity.element.opacity = .8), a > 0 && a < 180 && (this.rightDamageEntity.element.opacity = .8), a < -180 && a > -360 && (this.rightDamageEntity.element.opacity = .8), this.damageIndictator.setLocalScale(1.8, 1.8, 1.8), this.damageIndictator.tween(this.damageIndictator.getLocalScale()).to({
        x: .92,
        y: .92,
        z: .92
    ...
    this.announceEntity.enabled = !0, this.announceIconEntity.setLocalScale(3, 3, 3), this.announceIconEntity.tween(this.announceIconEntity.getLocalScale()).to({
        x: 1,
        y: 1,
        z: 1
    }, .15, pc.SineOut).start();
    var n = this.app.assets.find(a + ".png");
    if (this.announceIconEntity.element.textureAsset = n, this.announceIconEntity.element.opacity = 0, this.announceIconEntity.tween(this.announceIconEntity.element).to({
            opacity: 1
        }, .15, pc.SineOut).start(), this.announceTextEntity.element.text = t.toUpperCase(), this.announceTextEntity.element.opacity = 0, this.announceTextEntity.tween(this.announceTextEntity.element).to({
            opacity: 1
        }, .15, pc.SineOut).delay(.15).start(), this.announceStripeEntity.setLocalScale(2.5, 1, 1), this.announceStripeEntity.tween(this.announceStripeEntity.getLocalScale()).to({
            x: .015,
            y: 1,
            z: 1
        }, .3, pc.SineOut).start(), this.announceStripeEntity.element.opacity = .3, this.announceStripeEntity.tween(this.announceStripeEntity.element).to({
            opacity: 0
        }, .15, pc.SineOut).delay(.25).start(), this.announceInfoEntity.element.text = e.toUpperCase(), this.announceInfoEntity.element.opacity = 0, this.announceInfoEntity.tween(this.announceInfoEntity.element).to({
            opacity: 1
        }, .3, pc.SineOut).delay(.5).start(), e.startsWith("-") ? this.announceInfoEntity.element.color = pc.colors.danger : this.announceInfoEntity.element.color = pc.colors.green, this.announceTextBackground.element.width = this.announceTextEntity.element.width + 100, this.announceInfoEntity.setLocalPosition(0, -7, 0), this.announceInfoEntity.tween(this.announceInfoEntity.getLocalPosition()).to({
            x: 0,
            y: -22,
            z: 0
        }, .3, pc.SineOut).delay(.5).start(), clearTimeout(this.announceTimer), this.announceTimer = setTimeout((function(t) {
            t.announceEntity.enabled = !1
        }), 4500, this), i) {
        var s = "Announce-" + i;
        Date.now() - this.lastAnnounceDate < 3e3 ? this.entity.sound.slots[s].pitch += .1 : this.entity.sound.slots[s].pitch = 1, this.entity.sound.play(s)
    }
    this.lastAnnounceDate = Date.now()
}, Overlay.prototype.updateCrosshair = function(t) {
    var e = this.cameraEntity.getPosition(),
        i = this.movement.lookX % 360;
    if (this.crosshairEntity.element.width = pc.math.lerp(this.crosshairEntity.element.width, this.defaultCrosshairSize, .25), this.crosshairEntity.element.height = this.crosshairEntity.element.width, this.ricochetTime > this.timestamp) {
        var a = Utils.lookAt(e.x, e.z, this.ricochetPosition.x, this.ricochetPosition.z);
        this.ricochetIndictator.element.opacity = pc.math.lerp(this.ricochetIndictator.element.opacity, 0, .1), this.ricochetIndictator.setLocalEulerAngles(0, 0, a * pc.math.RAD_TO_DEG - i)
    }
    if (this.damageTime > this.timestamp) {
        var n = Utils.lookAt(e.x, e.z, this.damagePosition.x, this.damagePosition.z);
        this.damageIndictator.element.opacity = pc.math.lerp(this.damageIndictator.element.opacity, 0, .05), this.leftDamageEntity.element.opacity = pc.math.lerp(this.leftDamageEntity.element.opacity, 0, .01), this.rightDamageEntity.element.opacity = pc.math.lerp(this.rightDamageEntity.element.opacity, 0, .01), this.damageIndictator.setLocalEulerAngles(0, 0, n * pc.math.RAD_TO_DEG - i)
    }
    ...
    this.focusBulletsMask.setLocalEulerAngles(0, 0, -(this.maxAmmoValue - this.movement.currentWeapon.ammo) * this.ammoAngleFactor), this.focusBulletsInner.setLocalEulerAngles(0, 0, (this.maxAmmoValue - this.movement.currentWeapon.ammo) * this.ammoAngleFactor), this.focusAmmoEntity.setLocalScale(1.5, 1.5, 1.5), this.focusAmmoEntity.tween(this.focusAmmoEntity.getLocalScale()).to({
        x: 1,
        y: 1,
        z: 1
    ...
    this.crosshairEntity.tween(this.crosshairEntity.element).to({
        width: 65,
        height: 65
    }, .045, pc.SineOut).start(), this.setAmmo()
    ...
    var n = 35 * -this.notifications.length,
        s = !1;
    if ("message" == t)(s = this.notificationMessage.clone()).findByName("Message").element.text = e, s.element.width = 8 * (Utils.cleanUsername(e).length + 1);
    else if ("kill" == t && e.killer && e.killed) {
        var o = Utils.cleanUsername(e.killer).length,
            r = o + Utils.cleanUsername(e.killed).length,
            l = e.killedSkin,
            h = e.killerSkin;
        if ((s = this.notificationKill.clone()).findByName("Gibbon").element.color = e.color, s.findByName("Gibbon").element.width = 7 * (o + 20), s.findByName("Killer").element.text = e.killer, s.findByName("Killed").element.text = e.killed, s.element.width = 7 * (r + 17), console.log(e), e.weapon) {
            var y = e.weapon;
    ...
    if (!s) return !1;
    s.enabled = !0, s.setLocalPosition(180, n, 0), s.tween(s.getLocalPosition()).to({
        x: 0,
        y: n,
        z: 0
    }, .15, pc.BackOut).start(), this.notificationHolder.addChild(s), this.notifications.push(s), this.entity.sound.play("Whoosh"), a && this.entity.sound.play(a), this.timeout((function(t, e) {
        t.destroy(), e.notifications.splice(0, 1)
    }), 3500, s, this)
}, Overlay.prototype.onTick = function(t, e) {
    this.isOvertime ? (this.timeEntity.element.text = t, this.timeEntity.element.color = pc.colors.health, this.timeEntity.element.fontSize = 35) : (this.timeEntity.element.text = Utils.mmss(e), this.timeEntity.element.color = pc.colors.white, this.timeEntity.element.fontSize = 25), t < 0 && !pc.isFinished ? (this.alreadyStarted.enabled = !0, this.alreadyStartedCount.element.text = 20 + t) : this.alreadyStarted.enabled = !1, t >= 0 && t <= 5 ? (this.countBackEntity.enabled = !0, this.countBackEntity.element.text = t, this.entity.sound.play("Count")) : (this.countBackEntity.enabled = !1, this.isOvertime && !pc.isFinished && this.entity.sound.play("Overtime-Count"))
}, Overlay.prototype.onInfoMessage = function(t) {
    this.infoEntity.enabled || (this.infoEntity.enabled = !0, this.infoEntity.findByName("Message").element.text = t + "", this.app.fire("Mouse:Unlock"), window.onbeforeunload = null)
}, Overlay.prototype.onInfoClose = function() {
    this.infoEntity.enabled = !1
}, Overlay.prototype.showPrepare = function() {
    this.prepareEntity.enabled = !0, this.prepareEntity.setLocalScale(.5, .5, .5), this.prepareEntity.tween(this.prepareEntity.getLocalScale()).to({
        x: 1.5,
        y: 1.5,
        z: 1.5
    }, .1, pc.SineOut).start(), this.reloadingTime = 2.2
    ...
    this.ping = t, this.avgPing += t, this.avgPingCount++, this.avgPing / this.avgPingCount > 300 && this.avgPingCount > 10 ? this.connectivityIssue.enabled = !0 : this.connectivityIssue.enabled = !1, this.avgPingCount > 10 && (this.avgPingCount = 1, this.avgPing = 1)
}, Overlay.prototype.updateStatsEntity = function(t) {
    if (Date.now() - this.lastStatUpdate < 1e3) return !1;
    var e = Math.floor(1e3 / (1e3 * t));
    this.statsEntity.element.text = e + "FPS - " + this.ping + "MS", this.lastStatUpdate = Date.now(), e < 30 || this.ping > 300 ? this.statsEntity.element.color = pc.colors.danger : this.statsEntity.element.color = pc.colors.green
}, Overlay.prototype.now = function() {
    return this.app._time
}, Overlay.prototype.update = function(t) {
    if (this.updateCrosshair(t), this.updateExplosiveIndicator(), this.updateStatsEntity(t), !0 === this.prepareEntity.enabled && (this.reloadingTimeEntity.element.text = Math.max(this.reloadingTime, 0).toFixed(1), this.reloadingTime -= t), "undefined" != typeof app) {
        var e = "Pause" == app.page && app.transition.completed || pc.isFinished || !app.transition.completed;
...
Weapon.attributes.add("type", {
    ...
    this.currentDoodahSpeed = 0, this.player = !1, this.locked = !1, this.doodahEntity && (this.doodahReference.setLocalPosition(this.entity.findByName("DoodahPoint").getLocalPosition()), this.accessory = this.doodahEntity.findByName("Model"), !0 === pc.settings.hideCharms && (this.doodahEntity.enabled = !1)), this.hasSlider && (this.slider = this.entity.findByName(this.sliderName), this.bounceZ = 0, this.slider && (this.sliderStartPosition = this.slider.getLocalPosition().clone())), this.rotationSlider && (this.slider = this.entity.findByName(this.sliderName), this.bounceZ = 0, this.slider && (this.sliderStartRotation = this.slider.getLocalEulerAngles().clone())), this.magazineName && (this.magazine = this.entity.findByName(this.magazineName), this.magazine && this.magazine.reparent(this.magazinePoint)), this.barrelName && (this.barrel = this.entity.findByName(this.barrelName), this.barrel && this.barrel.reparent(this.barrelPoint)), this.app.on("Weapon:Lock", this.onLockChange, this), this.on("destroy", this.onDestroy, this)
    ...
    this.barrelPoint && (this.barrelPoint.tween(this.barrelPoint.getLocalEulerAngles()).rotate({
        ...
        y: 0,
        z: -55
    }, .4, pc.BackInOut).start(), this.ammoEntity.setLocalPosition(-500, 0, 0), this.ammoEntity.tween(this.ammoEntity.getLocalPosition()).to({
        x: 0,
        y: 0,
        z: 0
    }, .2, pc.BackInOut).delay(.3).start(), setTimeout((function(t) {
        t.entity.sound.play("Bullet-Put"), t.entity.sound.play("Whoosh")
    }), 350, this)), this.magazinePoint.setLocalPosition(0, 0, 0), this.magazinePoint.setLocalEulerAngles(0, 0, 0), this.magazinePoint.tween(this.magazinePoint.getLocalPosition()).to({
        x: .5,
        y: -7,
        z: 0
    }, .4, pc.BackInOut).start(), this.magazinePoint.tween(this.magazinePoint.getLocalEulerAngles()).rotate({
        x: 0,
        y: 0,
        z: 30
    }, .3, pc.BackInOut).start(), this.entity.sound.play("Unload"), this.app.fire("Player:Shake", !0)
}, Weapon.prototype.magazineAttach = function() {
    this.barrelPoint && this.barrelPoint.tween(this.barrelPoint.getLocalEulerAngles()).rotate({
        x: 0,
        y: 0,
        z: 0
    }, .2, pc.BackInOut).start(), this.magazinePoint.tween(this.magazinePoint.getLocalPosition()).to({
        x: 0,
        y: 0,
        z: 0
    }, .2, pc.BackInOut).start(), this.magazinePoint.tween(this.magazinePoint.getLocalEulerAngles()).rotate({
        x: 0,
        y: 0,
        z: 0
    }, .2, pc.BackInOut).start();
    ...
    this.armEntity.tween(this.armEntity.getLocalPosition()).to({
        ...
        y: t.y,
        z: t.z
    }, .2, pc.BackInOut).delay(.2).start(), this.entity.sound.play("Load"), this.app.fire("Player:Shake", !0)
}, Weapon.prototype.shoot = function() {
    this.entity.sound.slots.Fire.pitch = 1 - .1 * Math.random(), this.entity.sound.play("Fire"), this.bounceZ = this.sliderLimit, "Sniper" == this.entity.name && (clearTimeout(this.reloadSound), this.reloadSound = setTimeout((function(t) {
        t.entity.sound.play("Reload")
    }), 700, this))
}, Weapon.prototype.focus = function() {
    this.entity.sound.slots.Focus && (this.entity.sound.slots.Focus.pitch = 1 - .1 * Math.random(), this.entity.sound.play("Focus"))
    ...
    this.currentDoodahSpeed = i > .16 && t > .1 ? pc.math.lerp(this.currentDoodahSpeed, i, .5) : pc.math.lerp(this.currentDoodahSpeed, 0, .01), this.accessory && this.accessory.setLocalEulerAngles(0, 0, 500 * a), this.doodahReference.setLocalPosition(a, 0, 0), this.doodahEntity.lookAt(e)
}, Weapon.prototype.update = function(t) {
    if (this.locked) return !1;
    this.hasSlider && this.slider && (this.slider.setLocalPosition(this.sliderStartPosition.x + this.bounceZ, this.sliderStartPosition.y, this.sliderStartPosition.z), this.bounceZ = pc.math.lerp(this.bounceZ, 0, .1)), this.rotationSlider && this.slider && (this.slider.setLocalEulerAngles(this.sliderStartRotation.x + this.bounceZ, this.sliderStartRotation.y, this.sliderStartRotation.z), this.bounceZ = pc.math.lerp(this.bounceZ, 0, .1)), this.doodahEntity && this.updateDoodah(t)
};
...
EffectManager.attributes.add("shootRay", {
    ...
    i.on("update", (function(t) {
        e.opacity = pc.math.lerp(e.opacity, 0, .06), e.update()
    })), i.start(), clearTimeout(this.killSphereTimer), this.killSphereTimer = setTimeout((function(t) {
    ...
    this.killEffect.setLocalPosition(t), this.killEffect.findByName("Sprite").sprite.play("Fire"), this.skullEntity.setLocalPosition(e), this.skullEntity.sprite.play("Fire"), this.skullAnimation && this.skullAnimation.stop(), this.skullAnimation = this.skullEntity.tween(this.skullEntity.getLocalPosition()).to({
        y: e.y + 1
    }, 1, pc.SineOut), this.skullAnimation.start()
    ...
    t.length > 0 ? (e.enabled = !0, setTimeout((function(t) {
        t.thunder()
    }), 5e3, this)) : (e.enabled = !1, clearTimeout(this.thunderTimer)), this.lookAtEntities = this.app.root.findByTag("LookAt"), this.birdEntities = this.app.root.findByTag("Bird"), this.checkpointEntities = this.app.root.findByTag("Checkpoint")
    ...
    this.app.fire("Map:Thunder", !0), this.thunderTimer = setTimeout((function(t) {
        t.thunder()
    }), 1e3 * t, this)
    ...
    for (var t = 0; t < this.shootRayCount; t++) {
        ...
        e.sprite1 = e.findByName("Sprite1").sprite, e.sprite2 = e.findByName("Sprite2").sprite, e.sprite3 = e.findByName("Sprite3").sprite, e.sprite4 = e.findByName("Sprite4").sprite, e.hole = e.findByName("Hole"), e.setPosition(Utils.nullVector), this.impactParticles.push(e), this.garbageEntity.addChild(e)
    }
    ...
    this.totemEntity.enabled = !0, this.totemEntity.setLocalPosition(t), this.totemEntity.setLocalEulerAngles(e), this.totemEntity.script.totem.objectId = i, this.totemEntity.sound.play("Impact"), this.totemEntity.sound.play("Place"), this.app.fire("BakedPhysics:GroundCrackPhysics", new pc.Vec3(0, 0, 0)), this.app.fire("Timeline:Totem")
    ...
    this.crackEffect.enabled = !0, this.crackEffect.setLocalPosition(t), this.crackEffect.setLocalEulerAngles(e), this.crackEffect.sound.play("Impact"), this.crackEffect.sound.play("Sound-1"), this.app.fire("BakedPhysics:CrackBakedPhysics", new pc.Vec3(0, 0, 0)), this.app.fire("Timeline:Crack"), this.app.fire("Camera:Shake", 1.5, .55)
}, EffectManager.prototype.setPlace = function(t, e, i) {
    var a = this.getPlaceableObject(t);
    if (a) {
        var s = e.clone().add(new pc.Vec3(0, 2, 0)),
            n = a.clone();
        n.setLocalPosition(s), n.setLocalEulerAngles(0, 180 * Math.random(), 0), n.enabled = !0, n.tween(n.getLocalPosition()).to({
            x: e.x,
            y: e.y,
            z: e.z
        }, .5, pc.BounceOut).start(), this.mapHolder.addChild(n), i > 0 && setTimeout((function(t, e) {
            e.destroy()
        }), 1e3 * i, this, n)
    }
    ...
    r.setPosition(e), r.enabled = !0, r.type = t, r.startTime = Date.now(), r.owner = a, r.hasSpell = s, r.self = this, r.exploded = !1, this.traceEntity.reparent(r), this.traceEntity.particlesystem && this.traceEntity.particlesystem.reset();
    try {
    ...
    r.collision.on("collisionstart", (function(t) {
        var e = this.entity.self,
            i = !1;
        pc.isFinished || this.entity.sound.play("Collision"), t && t.contacts && t.contacts.length > 0 && (i = t.contacts[0].point), t.other && "Player" == t.other.name && Date.now() - this.entity.startTime > 50 && "Star" == this.entity.type ? pc.app.fire("Network:Hurt", this.entity.type, this.entity.owner) : t.other && this.entity.self.checkEntityBreakable(t.other), "Star" == this.entity.type && Date.now() - this.entity.startTime > 50 && (this.entity.rigidbody.linearVelocity.x = 0, this.entity.rigidbody.linearVelocity.y = 0, this.entity.rigidbody.linearVelocity.z = 0, this.entity.collision.enabled = !1, this.entity.rigidbody.enabled = !1, this.entity.star.script.rotate.enabled = !1, i && (e.explosionSmokeEntity.setLocalScale(2, 2, 2), e.explosionSmokeEntity.setPosition(i), Date.now() - e.lastSmoke > 700 && (e.explosionSmokeEntity.particlesystem.reset(), e.explosionSmokeEntity.particlesystem.play(), e.lastSmoke = Date.now()), this.entity.holder.setPosition(i)), this.entity.sound.play("Stuck"), this.entity.sound.stop("Loop"))
    })), body = r.rigidbody.body, body.setCcdMotionThreshold(1), body.setCcdSweptSphereRadius(.2), r.rigidbody.applyImpulse(o), r.explode = function() {
        this && this.self.setExplosion(this)
    }, this.garbageEntity.addChild(r), this.grenades.push(r), setTimeout((function(t) {
        t.traceEntity.reparent(t.garbageEntity)
    }), 1e3 * this.grenadeTime - 700, this), setTimeout((function(t, e) {
        e.explode()
    }), 1e3 * this.grenadeTime, this, r), this.app.fire("Overlay:Explosive", r)
}, EffectManager.prototype.setExplosionEffect = function(t) {
    this.loudSoundEntity.setPosition(t), this.loudSoundEntity.sound.play("Explosion-1"), this.explosionEntity.setPosition(t), this.explosionEntity.findByName("Sprite").sprite.play("Fire"), this.explosionSmokeEntity.setLocalScale(10, 10, 10), this.explosionSmokeEntity.setPosition(t), this.explosionSmokeEntity.particlesystem.reset(), this.explosionSmokeEntity.particlesystem.play(), this.app.fire("Player:Shake", !0)
    ...
    t.exploded = !0, "Grenade" == t.type && this.setExplosionEffect(e), pc.isFinished || "Grenade" == t.type && (this.app.fire("Network:RadiusEffect", "Grenade", t.getPosition(), t.owner), t.hasSpell && this.app.fire("Spell:Wind", t.getPosition(), "Big")), "Grenade" == t.type && (this.breakDamageRadius(t.getPosition()), this.explosiveDamageRadius(t.getPosition()), this.lastSmoke = Date.now());
    ...
    for (var e = this.bullets.length; e--;) this.bullets[e].time > this.maxBulletTime ? this.bullets[e].setPosition(Utils.nullVector) : (this.bullets[e].time += t, this.bullets[e].rotateLocal(this.bulletRotate.x * t, this.bulletRotate.y * t, this.bulletRotate.z * t), this.bullets[e].translateLocal(this.bulletTranslate.x * t, this.bulletTranslate.y * t, this.bulletTranslate.z * t))
    ...
    var n = Math.floor(15 * Math.random() + 20),
        ...
        r = new pc.Vec3(0, 0, 0);
    r = o ? o.point : i.clone(), o && setTimeout((function(t) {
        t.dealHitEntity("Grapple", o, n, a, !0)
    }), 100, this), this.grapples[this.currentGrappleIndex].script.grapple.onThrow(t, e, r), this.currentGrappleIndex++, this.currentGrappleIndex = this.currentGrappleIndex % 3
}, EffectManager.prototype.onAxeThrow = function(t, e, i, a) {
    var s = Math.floor(45 * Math.random() + 40),
        n = this.testRaycast(t, e.clone().add(t)),
        o = new pc.Vec3(0, 0, 0);
    o = n ? n.point : e.clone();
    var r = this.axes[this.currentAxeIndex];
    r.setLocalPosition(t), r.lookAt(o), r.enabled = !0, r.originEntity = r.findByName("Origin"), r.rayEntity = r.findByName("Ray"), r.rayEntity.enabled = !0, r.originEntity.enabled = !0, r.originEntity.script.enabled = !0, r.sound.play("Loop"), this.currentAxeIndex++, this.currentAxeIndex = this.currentAxeIndex % 3, r.tween(r.getLocalPosition()).to({
        x: o.x,
        y: o.y,
        z: o.z
    }, .25, pc.Linear).start(), setTimeout((function(t, e, n) {
        t.sound.stop("Loop"), t.rayEntity.enabled = !1, t.originEntity.script.enabled = !1, t.originEntity.setLocalEulerAngles(18.68, 0, 0), e && n.dealHitEntity("Axe", e, s, i, !0), a && n.app.fire("Spell:Wind", t.getPosition().clone(), "Small")
    }), 250, r, n, this), n && n.entity && "Player" == n.entity.name ? setTimeout((function(t, e) {
        t.enabled = !1
    ...
    h.setLocalPosition(t), h.lookAt(l), h.enabled = !0, h.ray = h.findByName("Ray"), h.shurikenModel = h.findByName("Model"), s && (h.shurikenModel.enabled = !1), h.tween(h.getLocalPosition()).to({
        x: l.x,
        y: l.y,
        z: l.z
    }, .2, pc.Linear).start(), p && setTimeout((function(t, e, a, s) {
        t.ray.enabled = !1, a && (1 === s ? e.dealHitEntity("Shuriken", a, n, i, !0) : e.dealHitEntity("Shuriken", a, n, i, !1))
    }), 50, h, this, p, this.shurikenSpread), setTimeout((function(t) {
        t.destroy()
    }), 1e3, h), this.garbageEntity.addChild(h), this.shurikenSpread++, this.shurikenSpread > 2 && (this.shurikenSpread = 0)
}, EffectManager.prototype.onSpray = function(t, e, i) {
    var a = this,
        s = Utils.getAssetFromURL("Spray-" + i + ".png");
    this.sprayEntity.setPosition(t.x, t.y, t.z), this.sprayEntity.setEulerAngles(e.x, e.y, e.z), this.sprayEntityLight.enabled = !0, s && s.ready((function() {
        a.sprayEntityLight.light.cookieAsset = s
    })), this.sprayEntityLight.light.isStatic = !1, clearTimeout(this.sprayTimer), this.sprayTimer = setTimeout((function(t) {
    ...
    if (o.indexOf("Player") > -1) {
        ...
        if (l.setPosition(e.point), l.setEulerAngles(r), l.setLocalScale(p, p, p), l.sprite.stop(), pc.controls.player.playerId == a && i > 0) {
            ...
            h && h.script && h.script.enemy && (h.script.enemy.damage(a, i, y), "-1" !== h.script.enemy.playerId && (c = !0), s && h.script.enemy.dealSpell(t), c && this.app.fire("Hit:Point", h, i)), this.entity.setPosition(e.point), this.entity.sound.play("Impact-Iron"), c && l.sprite.play("Impact")
        }
    ...
    if (p) {
        ...
        if (f.indexOf("Player") > -1) {
        ...
        } else if (f.indexOf("Water") > -1) this.entity.setPosition(p.point), this.entity.sound.play("Water-Splash"), this.splashEntity.setPosition(p.point), this.splashEntity.splash1.sprite.stop(), this.splashEntity.splash2.sprite.stop(), this.splashEntity.splash1.sprite.play("Fire"), this.splashEntity.splash2.sprite.play("Fire");
            ...
            if (m.setPosition(p.point), m.setEulerAngles(y), m.setLocalScale(d, d, d), m.sprite1.play("Impact"), m.sprite2.play("Impact"), m.sprite3.play("Impact"), m.sprite4.play("Impact"), this.app.fire("EffectManager:SetEntityPosition", p.point), "Shotgun" != n && (Math.random() > .4 || "Melee" == n))
            ...
            for (var S in this.explosive) {
                ...
                f.indexOf(v) > -1 && (this.setExplosionEffect(p.point), p.entity.parent.destroy(), E = !1)
            }
            Date.now() - this.lastSmoke > 700 && (this.explosionSmokeEntity.setLocalScale(2, 2, 2), this.explosionSmokeEntity.setPosition(p.point), this.explosionSmokeEntity.particlesystem.reset(), this.explosionSmokeEntity.particlesystem.play(), this.lastSmoke = Date.now()), E && -1 === p.entity.tags.list().indexOf("Player") ? (m.hole.setLocalScale(.17, .17, .17), m.hole.setLocalEulerAngles(0, g, 0)) : m.hole.setLocalScale(.001, .001, .001), f.indexOf("Damageable") > -1 && this.app.fire("Network:ObjectDamage", p.entity._guid)
        }
    ...
    if ("Melee" != n) {
        ...
        I.setPosition(i), I.lookAt(e), I.sprite1.stop(), I.sprite1.play("Fire"), I.sprite2.stop(), I.sprite2.play("Fire"), "Shotgun" == n ? (I.sprite1.opacity = .1, I.sprite1.speed = 1.2, I.sprite2.opacity = .1, I.sprite2.speed = 1.2) : "Sniper" == n ? (I.sprite1.opacity = .9, I.sprite1.speed = .5, I.sprite2.opacity = .9, I.sprite2.speed = .5) : s > 40 ? (I.sprite1.opacity = .3, I.sprite1.speed = .7, I.sprite2.opacity = .3, I.sprite2.speed = .7) : (I.sprite1.opacity = .1, I.sprite1.speed = 1.2, I.sprite2.opacity = .1, I.sprite2.speed = 1.2), I.trace.setLocalPosition(0, 0, -5), pc.controls.player.playerId, I.trace.tween(I.trace.getLocalPosition()).to({
            x: 0,
            y: 0,
            z: -l
        }, .2, pc.Linear).start(), clearTimeout(I.timer), I.timer = setTimeout((function(t) {
    ...
    this.impactSoundEntity.setPosition(e.point), this.impactSoundEntity.sound.play(t + "-" + a), Math.random() > .4 && "Melee" != i && this.impactSoundEntity.sound.play("Ricochet-" + a)
    ...
    for (var e in this.birdEntities) {
        ...
        i && i.animation && a < 25 && !i.isFlied && (i.isFlied = !0, i.animation.speed = 1.2 + Math.random(), i.animation.loop = !1, i.animation.play("Bird-Fly"), i.lastFlyDate = Date.now(), i.sound && i.sound.play("Fly"), setTimeout((function(t) {
            t.enabled = !1
        }), 2e3, i))
    }
    ...
    for (var i in this.birdEntities) {
        ...
        a && a.animation && s > 60 && !0 === a.isFlied && Date.now() - a.lastFlyDate > 25e3 && (a.enabled = !0, a.setLocalEulerAngles(0, 180 * Math.random(), 0), a.animation.speed = 1, a.animation.loop = !0, a.animation.play("Bird-Idle"), a.isFlied = !1)
    }
...
WeaponManager.attributes.add("defaultWeapon", {
    ...
    type: "entity"
}), WeaponManager.attributes.add("armModelLeftEntity", {
    type: "entity"
}), WeaponManager.attributes.add("armModelRightEntity", {
    type: "entity"
    ...
    this.currentWeapon = !1, this.currentWeaponEntity = !1, this.isShooting = 0, this.currentWeaponName = !1, this.isAnimatedSkin = !1, this.videoTexture = !1, this.currentFlameScale = 0, this.currentFlameAngle = 0, this.movement = this.entity.script.movement, this.weaponSkins = {}, this.currentCharm = "Default-Charm.glb", this.characterName = "Lilium", this.app.on("WeaponManager:Skins", this.setSkins, this), this.app.on("WeaponManager:Set", this.setWeapon, this), this.app.on("WeaponManager:SetSkin", this.setSkin, this), this.app.on("WeaponManager:SetCharm", this.setCharm, this), this.app.on("WeaponManager:Swing", this.playSwing, this), this.app.on("Player:Character", this.setCharacter, this), this.app.on("Player:WeaponLayout", this.setWeaponLayout, this), this.app.on("Map:Loaded", this.onMapLoaded, this), this.setWeaponModel("Scar"), this.setWeapon("Scar"), this.setWeapons()
}, WeaponManager.prototype.setCharacter = function(e) {
    this.characterName = e
}, WeaponManager.prototype.onMapLoaded = function(e) {
    "GUNGAME" != pc.currentMode && "CUSTOM" != pc.currentMode && this.weapons && this.weapons.length
    ...
    this.weaponSkins = e, e && setTimeout((function(e) {
    ...
    this.app.fire("Player:Focus", !1), t || this.app.fire("Network:Weapon", e), this.movement.hideWeapon(), this.currentWeapon ? (clearTimeout(this.takeOutTimer), this.takeOutTimer = setTimeout((function(a) {
        a.setWeaponModel(e, t), a.movement.takeout()
    }), 300, this)) : this.setWeaponModel(e, t), this.app.fire("Overlay:CircularSelect", e), this.app.fire("Overlay:Weapon", e), this.currentWeaponName = e
    ...
    var t = this.app,
        a = e.replace(".jpg", ".mp4"),
        n = new pc.Texture(t.graphicsDevice, {
    ...
    return i.addEventListener("canplay", (function(e) {
        n.setSource(i)
    })), i.setAttribute("webkit-playsinline", "webkit-playsinline"), i.muted = !0, i.src = Utils.prefixCDN + a, i.crossOrigin = "anonymous", i.loop = !0, i.play(), this.isAnimatedSkin = !0, this.videoTexture = n, n
    ...
    if (e && this.currentWeaponEntity && this.currentWeapon.doodahEntity) {
        ...
        t && a && (this.app.assets.load(t), t.ready((function() {
            a.model.asset = t
        })))
    }
...
Sprite.attributes.add("type", {
    ...
    if ("blending" == this.type) {
        ...
        this.entity.sprite.material.opacityMap = t, this.entity.sprite.material.blendType = pc.BLEND_ADDITIVEALPHA, this.entity.sprite.material.opacityMapChannel = "r", this.materialEntity && (this.materialEntity.model.model.meshInstances[0].material = this.entity.sprite.material), this.entity.script.destroy()
    } else if ("animated-2d" == this.type) {
        var e = this;
        this.currentSpriteFrame = 0, this.on("state", (function(t) {
...
Hitmarker.attributes.add("hitPointEntity", {
    ...
    this.points = [], this.lastHitTime = Date.now(), this.lastHeadshot = Date.now(), this.hitPointEntity.enabled = !1, this.crosshairEntity.enabled = !1, this.app.on("Hit:Point", this.onHitPoint, this), this.app.on("Hit:Headshot", this.onHeadshot, this)
}, Hitmarker.prototype.onHeadshot = function(t, e) {
    if (Date.now() - this.lastHeadshot < 1e3) return !1;
    this.app.fire("DealtDamage:Trigger", e, t, !0), this.screenEntity.sound.play("Headshot"), this.hitmarkerEntity.element.opacity = 1, this.hitmarkerEntity.setLocalScale(.3, .3, .3), this.hitmarkerEntity.tween(this.hitmarkerEntity.getLocalScale()).to({
        x: 1.2,
        y: 1.2,
        z: 1.2
    }, .25, pc.BackOut).start(), this.lastHeadshot = Date.now()
}, Hitmarker.prototype.onHitPoint = function(t, e) {
    this.app.fire("DealtDamage:Trigger", e, t), this.screenEntity.sound.play("Hitmarker"), this.hitmarkerEntity.element.opacity = 1, this.hitmarkerEntity.setLocalScale(.5, .5, .5), this.hitmarkerEntity.tween(this.hitmarkerEntity.getLocalScale()).to({
        x: 1.8,
        y: 1.8,
        z: 1.8
    }, .15, pc.BackOut).start(), this.lastHitTime = Date.now()
    ...
    a.x > 0 && a.x < this.app.graphicsDevice.width && a.y > 0 && a.y < this.app.graphicsDevice.height && a.z > 0 ? (t.direction > .5 ? t.rotateLocal(0, 0, this.rotateSpeed * e) : t.rotateLocal(0, 0, -this.rotateSpeed * e), t.setLocalPosition(a.x / r, (n.height - a.y) / r, 0), t.enabled = !0) : t.enabled = !1
    ...
    this.updatePoints(t), Date.now() - this.lastHitTime > 350 && (this.hitmarkerEntity.element.opacity = pc.math.lerp(this.hitmarkerEntity.element.opacity, 0, .2))
};
...
NetworkManager.attributes.add("isDebug", {
    ...
    this.setRespawn(), void 0 !== pc.nextObjectivePoint && this.app.fire("Mode:NextObjective", pc.nextObjectivePoint)
}, NetworkManager.prototype.setOptions = function(e) {
    e ? (this.URL = "wss://" + e.server, this.options.map = e.map, this.options.maxPlayer = e.max_player, this.isDebug || this.connect(this.URL), this.setOwnerInterface(e.is_owner)) : this.setOwnerInterface(!1)
    ...
    this.ws && (this.ws.close(), this.ws = !1, this.app.fire("Game:Finish", !0)), this.clearPlayers(), this.keys = this.getKeys(), this.roomId = this.getRoomId(), pc.isSpectator = this.isSpectator, this.roomId && (pc.isDebug ? this.ws = new WebSocket("ws://127.0.0.1:8080/?" + this.roomId) : this.ws = new WebSocket(e + "/?" + this.roomId), this.ws.binaryType = "arraybuffer", this.ws.onopen = this.onOpen.bind(this), this.ws.onclose = this.onClose.bind(this), this.ws.onmessage = this.onMessage.bind(this)), this.app.fire("Analytics:Event", "Checkpoint", "ConnectRoom")
    ...
    var t = e[0];
    this.app.fire("Overlay:Info", "You have been kicked. Reason : " + t), this.app.fire("Mouse:Unlock"), this.app.fire("Player:Lock", !1), this.app.fire("Overlay:Pause", !1)
    ...
    if (!0 === e[0]) {
        "undefined" != typeof app && (this.characterName = app.session.character, this.hash = app.session.hash, this.username = app.session.username, app.session.localCharacter && (this.characterName = app.session.localCharacter)), this.send([this.keys.auth, this.roomId, this.username, this.characterName, this.currentWeapon, this.options, this.hash, this.isSpectator]), this.skin = this.characterName, this.isSpectator ? (this.playerEntity.enabled = !1, this.overlayEntity.enabled = !1, this.spectatorEntity.enabled = !0) : (this.playerEntity.enabled = !0, this.overlayEntity.enabled = !0, this.spectatorEntity.enabled = !1), this.app.fire("Map:Loaded", !0);
        var t = this.app.root.findByTag("SpawnPoint");
        t && t.length > 0 && this.playerEntity.rigidbody.teleport(t[0].getPosition().clone().add(new pc.Vec3(0, 1, 0))), this.app.fire("Analytics:Event", "NewCheckPoint", "MatchConnected"), this.app.fire("Overlay:SetLoading", this.options), this.authDate = Date.now()
    }
    ...
    var t = e[1];
    e[0] && (this.lastMode = this.currentMode + "", this.currentMode = e[0], pc.currentMode = this.currentMode, pc.currentModeOptions = e[3], this.options.gameMode = pc.currentMode, pc.isPrivate = e[2], this.app.fire("Game:Mode", this.currentMode, t, e[3])), this.app.fire("View:State", "Game"), this.app.fire("Mouse:Lock"), this.setModeState(this.lastMode, !1), this.setModeState(this.currentMode, !0), this.app.fire("Game:PreStart", !0), this.app.fire("Outline:Restart", !0), this.app.fire("Result:Remove", !0), pc.currentMap = t, pc.isRequeuing = !1, clearTimeout(this.mapTimer), this.mapTimer = setTimeout((function(e) {
        t ? e.app.fire("Map:Load", t) : e.app.fire("Map:Load", "Sierra")
    }), 100, this), pc.isFinished = !1, pc.isPauseActive = !1, this.isTeamSelected = !1, this.app.fire("Game:Start", !0), "GUNGAME" != pc.currentMode && pc.session && pc.session.weapon, setTimeout((function(e) {
        e.app.fire("DOM:Update", !0)
    }), 500, this), "undefined" != typeof app && (app.mode = "Game", this.isAlreadyConnected && (pc.app.fire("Player:Hide", !0), app.midrollAds((function() {
        pc.app.fire("Player:Lock", !0), pc.app.fire("Player:Show", !0), pc.app.fire("Analytics:Event", "Ads", "PrerollAds")
    ...
    this.currentPing = e, this.app.fire("Overlay:Ping", e), setTimeout((function(e) {
        e.sendPing()
    }), 1e3, this)
    ...
    this.isMuted && (this.currentVolume > 0 ? this.app.systems.sound.volume = this.currentVolume : this.app.systems.sound.volume = .25, this.isMuted = !1), pc.isPauseActive = !1, this.send([this.keys.show, !0])
    ...
    if (e.length > 0) {
        var t = e[0],
            ...
            l = new pc.Vec3(a, i, r),
            y = new pc.Vec3(s, o, n);
        "Grenade" == t ? this.app.fire("EffectManager:Throw", t, l, y, !1, h) : "Grapple" == t ? this.app.fire("EffectManager:Grapple", c, l, y, !1, h) : "Axe" == t ? this.app.fire("EffectManager:Axe", l, y, !1, h) : "Shuriken" == t ? this.app.fire("EffectManager:Shuriken", l, [s, o, n], p, h, !1) : "Crack" == t && this.app.fire("EffectManager:Crack", l, y)
    }
    ...
    "undefined" != typeof app ? this.app.fire("Player:Character", app.session.character) : this.app.fire("Player:Character", this.characterName), e.length > 0 && (this.app.fire("WeaponManager:SetCharm", e[0]), this.app.fire("WeaponManager:SetSpray", e[1]), this.app.fire("Player:Skin", e[2]))
    ...
    if (this.app.fire("Overlay:Gameplay", !1), this.app.fire("Overlay:Pause", !1), this.app.fire("Game:Overtime", !1), this.app.fire("Analytics:GameplayStop", !0), this.app.fire("Network:Finish", !0), pc.isFinished = !0, e.length > 0) {
        var t = e[0];
        for (var a in t) {
            var i = t[a];
    ...
    if (e.length > 0) {
        var t = e[0];
        this.send(["discard_object", t.id, Utils.generateId(t.position), {
            x: 0,
            y: 0,
            z: 0
        }])
    ...
    t == this.playerId ? (this.app.fire("Analytics:GameplayStop", !0), this.app.fire("Player:Death", s, i)) : r && (r.script.enemy.death(i), a == this.playerId && this.kills++)
    ...
    if (e.length > 0) {
        var t = e[0],
            ...
            i = e[1];
        "console" == t ? this.app.fire("Chat:Message", "Console", i) : "custom" == t ? this.app.fire("Chat:Message", e[1], e[2]) : "consoleLog" == t ? console.log(e) : t == this.playerId ? this.app.fire("Chat:Message", this.username, i, !0, !1, a.team) : this.app.fire("Chat:Message", a.username, i, !1, !1, a.team)
    }
    ...
    if (e && e.length > 0) {
        var t = e[0],
            a = e[1],
            i = this.getPlayerById(t);
        t == this.playerId ? (this.app.fire("Player:AllowRespawn", !0), this.app.fire("Overlay:Transition", !0), clearTimeout(this.respawnTimer), this.respawnTimer = setTimeout((function(e) {
            e.app.fire("Player:Respawn", a)
        }), 300, this), this.app.fire("Game:Respawned")) : i && i.script.enemy.respawn(a)
    }
}, NetworkManager.prototype.info = function(e) {
    var t = e[0];
    app && "Server is at max capacity! Please try refresh page!" == t && (app.stopMatchmaking(), app.startMatchmaking()), this.app.fire("Overlay:Info", t)
    ...
    var t = e.team;
    this.isTeamSelected || (this.send([this.keys.team, t]), pc.app.fire("View:Pause", "Popup"), setTimeout((function() {
        pc.app.fire("Player:PointerLock", !0)
    }), 50), this.isTeamSelected = !0, pc.isModeMenuActive = !1)
    ...
    if (e.length > 0) {
        var t = e[0];
        this.playerId = t.playerId, this.group = t.group, this.username = t.username, this.playerEntity.script.player.playerId = this.playerId, this.playerEntity.script.player.group = this.group, this.playerEntity.username = this.username, pc.currentTeam = t.team
    }
    ...
    for (var t = this.players.length; t--;)
        if (this.players[t].script && this.players[t].script.enemy && this.players[t].script.enemy.playerId == e) return this.players[t];
    return !1
}, NetworkManager.prototype.getPlayerScriptById = function(e) {
    if (this.playerId == e) return this;
    for (var t = this.players.length; t--;)
        if (this.players[t].script && this.players[t].script.enemy && this.players[t].script.enemy.playerId == e) return this.players[t].script.enemy;
    return !1
    ...
    t.enabled = !0, t.script.enemy.playerId = e.playerId, t.script.enemy.username = e.username, t.script.enemy.team = e.team, t.script.enemy.skin = e.skin, t.script.enemy.level = e.level, t.script.enemy.group = e.group, t.script.enemy.setUsername(e.username, e.team, e.level), t.script.enemy.weaponSkins = e.weaponSkins, t.script.enemy.setWeapon(e.weapon), t.script.enemy.setCharacterSkin(e.skin, e.heroSkin, e.dance), t.script.enemy.setKillMessage(e.killMessage), this.playerHolder.addChild(t), this.players.push(t)
}, NetworkManager.prototype.tick = function(e) {
    var t = parseInt(e[0]),
        a = t;
    0 === t && (pc.isMapLoaded = !1), this.app.fire("Server:Tick", t, a), this.app.fire("VengeGuard:Check", !0), this.selfTick()
...
! function(t, r) {
    ...
    var q, g_toByteArray = function(t) {
            for (var r, g = l(t), R = g[0], D = g[1], Y = new U(function(t, r, g) {
                    return 3 * (r + g) / 4 - g
                }(0, R, D)), q = 0, X = D > 0 ? R - 4 : R, $ = 0; $ < X; $ += 4) r = d[t.charCodeAt($)] << 18 | d[t.charCodeAt($ + 1)] << 12 | d[t.charCodeAt($ + 2)] << 6 | d[t.charCodeAt($ + 3)], Y[q++] = r >> 16 & 255, Y[q++] = r >> 8 & 255, Y[q++] = 255 & r;
            return 2 === D && (r = d[t.charCodeAt($)] << 2 | d[t.charCodeAt($ + 1)] >> 4, Y[q++] = 255 & r), 1 === D && (r = d[t.charCodeAt($)] << 10 | d[t.charCodeAt($ + 1)] << 4 | d[t.charCodeAt($ + 2)] >> 2, Y[q++] = r >> 8 & 255, Y[q++] = 255 & r), Y
        },
        ...
        d_write = function(t, r, g, d, U, R) {
            var D, Y, q, X = 8 * R - U - 1,
                ...
                G = d ? 1 : -1,
                J = r < 0 || 0 === r && 1 / r < 0 ? 1 : 0;
            for (r = Math.abs(r), isNaN(r) || r === 1 / 0 ? (Y = isNaN(r) ? 1 : 0, D = $) : (D = Math.floor(Math.log(r) / Math.LN2), r * (q = Math.pow(2, -D)) < 1 && (D--, q *= 2), (r += D + V >= 1 ? W / q : W * Math.pow(2, 1 - V)) * q >= 2 && (D++, q /= 2), D + V >= $ ? (Y = 0, D = $) : D + V >= 1 ? (Y = (r * q - 1) * Math.pow(2, U), D += V) : (Y = r * Math.pow(2, V - 1) * Math.pow(2, U), D = 0)); U >= 8; t[g + Z] = 255 & Y, Z += G, Y /= 256, U -= 8);
        ...
        X = (function(t, r) {
            ...
            function o(t, r, g) {
                ...
                if (j(t, ArrayBuffer) || t && j(t.buffer, ArrayBuffer)) return function(t, r, g) {
                ...
                for (var U = [], R = r; R < g;) {
                    ...
                    if (R + W <= g) switch (W) {
                        ...
                        case 3:
                            ...
                            break;
                        case 4:
                            D = t[R + 1], Y = t[R + 2], q = t[R + 3], 128 == (192 & D) && 128 == (192 & Y) && 128 == (192 & q) && (X = (15 & $) << 18 | (63 & D) << 12 | (63 & Y) << 6 | 63 & q) > 65535 && X < 1114112 && (V = X)
                    }
            ...
            r.kMaxLength = g, i.TYPED_ARRAY_SUPPORT = function() {
                try {
                ...
                enumerable: !1,
                writable: !1
            }), i.poolSize = 8192, i.from = function(t, r, g) {
                return o(t, r, g)
            }, i.prototype.__proto__ = Uint8Array.prototype, i.__proto__ = Uint8Array, i.alloc = function(t, r, g) {
                ...
                var g;
                if (void 0 === r)
                    for (r = 0, g = 0; g < t.length; ++g) r += t[g].length;
                ...
                var t = this.length;
                return 0 === t ? "" : 0 === arguments.length ? A(this, 0, t) : function(t, r, g) {
                    var d = !1;
                ...
                return t = this.toString("hex", 0, g).replace(/(.{2})/g, "$1 ").trim(), this.length > g && (t += " ... "), "<Buffer " + t + ">"
                ...
                if (void 0 === r && (r = 0), void 0 === g && (g = t ? t.length : 0), void 0 === d && (d = 0), void 0 === U && (U = this.length), r < 0 || g > t.length || d < 0 || U > this.length) throw new RangeError("out of range index");
                if (d >= U && r >= g) return 0;
                if (d >= U) return -1;
                if (r >= g) return 1;
                if (this === t) return 0;
            ...
            i.prototype.slice = function(t, r) {
                ...
                if (g <= r) return this;
                var R;
                if (r >>>= 0, g = void 0 === g ? this.length : g >>> 0, t || (t = 0), "number" == typeof t)
            ...
            function P(t) {
                return g_toByteArray(function(t) {
    ...
    var V = {
            initialize: (t, g) => {
                ...
                if (void 0 !== g) {
                    ...
                    g(`@initialize : setting buffer limit to ${((t,g)=>{if(!Number.isFinite(t))throw new TypeError(`Expected a finite number, got ${typeof t}: ${t}`);if((g=Object.assign({},g)).signed&&0===t)return" 0 B";const d=t<0,U=d?"-":g.signed?"+":"";if(d&&(t=-t),t<1)return U+e(t,g.locale)+" B";const R=Math.min(Math.floor(Math.log10(t)/3),r.length-1);return t=Number((t/Math.pow(1e3,R)).toPrecision(3)),U+e(t,g.locale)+" "+r[R]})(t)}`)
                }
                const d = {};
                let U = !1,
                    R = -33;
                    ...
                    switch (typeof t) {
                        case "string":
                            if ((r = $.byteLength(t)) < 32) {
                                ...
                                D[Y += 1] = 160 | r;
                                for (let r = 0, g = 0, d = t.length; r < d; r += 1)(g = t.charCodeAt(r)) < 128 ? D[Y += 1] = g : g < 1280 ? (D[Y += 1] = 192 | g >> 6, D[Y += 1] = 128 | 63 & g) : g < 55296 || g >= 57344 ? (D[Y += 1] = 224 | g >> 12, D[Y += 1] = 128 | g >> 6 & 63, D[Y += 1] = 128 | 63 & g) : (r += 1, g = 65536 + ((1023 & g) << 10 | 1023 & t.charCodeAt(r)), D[Y += 1] = 240 | g >> 18, D[Y += 1] = 128 | g >> 12 & 63, D[Y += 1] = 128 | g >> 6 & 63, D[Y += 1] = 128 | 63 & g)
                        ...
                        case "object":
                            ...
                            if (t instanceof ArrayBuffer && (t = $.from(t)), t instanceof $ == 0 && (t instanceof Int8Array || t instanceof Int16Array || t instanceof Int32Array || t instanceof Uint8Array || t instanceof Uint8ClampedArray || t instanceof Uint16Array || t instanceof Uint32Array || t instanceof Float32Array || t instanceof Float64Array)) {
                                let r = $.from(t.buffer);
                            ...
                            if (t instanceof $) {
                                ...
                                if (!0 === U)
                                    for (let U = 0; U < r; U += 1) s(d[g[U]] || g[U]), s(t[g[U]]);
                                else
                                    for (let d = 0; d < r; d += 1) s(g[d]), s(t[g[d]])
                            }
                            break;
                        default:
                            switch (t) {
                ...
                const l = () => {
                    ...
                    switch (q[X]) {
                        ...
                        case 212:
                            if (0 === q.readInt8(X += 1)) switch (q.readInt8(X += 1)) {
                                case 0:
                                    return void(X += 1);
                                case 1:
                                    return X += 1, NaN;
        ...
        W = V.initialize,
        Z = V.Buffer;
    t.default = V, t.initialize = W, t.Buffer = Z, Object.defineProperty(t, "__esModule", {
        value: !0
    })
}));
...
Player.attributes.add("playerId", {
    ...
    this.animation.cameraFov = this.app.tween(this.movement.animation).to({
        fov: 10
    }, .5, pc.SineIn), this.animation.cameraShake = this.app.tween(pc.controls.animation).to({
        cameraBounce: 1
    }, .04, pc.Linear).yoyo(!0).repeat(10), this.animation.cameraShake.start(), this.animation.cameraFov.start(), setTimeout((function(t) {
    ...
    var o = this.app.assets.find(this.characterName + "-Character"),
        n = this.app.assets.find(this.characterName + "-Character");
    this.app.assets.load(o), this.app.assets.load(n), this.characterArmLeft.model.asset = o, this.characterArmRight.model.asset = n, o.ready((function() {
    ...
    if (i) {
        ...
        s.push(i.id), this.characterEntity.animation.assets = s, this.entity.sound.slots.Emote.asset = a.id, setTimeout((function(t) {
            t.characterHolder.enabled = !1
        }), 500, this), this.danceName = e + "-" + t
    }
    ...
    if (2 != this.armsLoaded) return this.skinCheckTimer = setTimeout((function(t) {
        t.checkLoadedSkins()
    }), 500, this), !1;
    this.onWeaponChange()
}, Player.prototype.onWeaponChange = function() {
    this.characterArmLeft.fire("CustomSkin:Set", {
        skin: this.skinName
    }), this.characterArmRight.fire("CustomSkin:Set", {
        skin: this.skinName
    }), this.characterArmLeft.animation.play(this.characterName + "-Left"), this.characterArmRight.animation.play(this.characterName + "-Right")
    ...
    this.movement.setAmmoFull(), this.cards = [], setTimeout((function(t) {
    ...
    !1 === t ? (this.app.fire("Overlay:Pause", !0), this.app.fire("Mouse:Unlock")) : this.app.fire("Mouse:Lock", (function() {
        pc.app.fire("Button:Continue:Resolve"), pc.app.fire("Overlay:Pause", !1)
    }))
}, Player.prototype.onLeave = function() {}, Player.prototype.onBuyStart = function() {
    this.buyAbility()
    ...
    this.isCardSelection = !0, this.movement.disableMovement(), this.app.fire("Overlay:Gameplay", !1), this.app.fire("Overlay:Transition", new pc.Color(1, 1, 1)), setTimeout((function(t) {
        t._onCards()
    }), 100, this)
    ...
    this.entity.rigidbody.teleport(0, -50, 0, 0, 0, 0), this.entity.rigidbody.linearVelocity = new pc.Vec3(0, 0, 0), this.characterHolder.enabled = !0, this.characterCamera.script.blackWhite.enabled = !1, this.characterCamera.setLocalPosition(0, .95, 7), this.characterEntity.setLocalEulerAngles(0, -180, 0), this.characterCameraHolder.setLocalScale(0, 0, 0), this.characterCameraHolder.tween(this.characterCameraHolder.getLocalScale()).to({
        x: .5,
        y: .5,
        z: .5
    }, 1.5, pc.SineOut).start(), this.characterCameraHolder.tween(this.characterCameraHolder.getLocalEulerAngles()).rotate({
        x: -165,
        y: 0,
        z: 180
    }, 2, pc.SineOut).start(), setTimeout((function(t) {
        t.characterEntity.animation.play("Sit"), t.movement.lookEntity.enabled = !1
    }), 100, this)
}, Player.prototype.onAbilitySet = function(t) {
    this.cards.push(t), setTimeout((function(t) {
        t._onAbilitySet()
    }), 2e3, this)
}, Player.prototype._onAbilitySet = function() {
    this.app.fire("Overlay:Gameplay", !0), this.app.fire("Network:Respawn", !0), setTimeout((function(t) {
        t.afterAbilitySet()
    }), 150, this)
    ...
    t ? (this.animation.cameraFov = this.app.tween(this.movement.animation).to({
        fov: 20
    }, 1, pc.SineIn), this.animation.cameraShake = this.app.tween(pc.controls.animation).to({
        cameraBounce: .8
    }, .04, pc.Linear).yoyo(!0).repeat(10), this.animation.cameraShake.start(), this.animation.cameraFov.start()) : (this.animation.cameraShake && this.animation.cameraShake.stop(), this.animation.cameraFov && this.animation.cameraFov.stop())
}, Player.prototype.onKill = function(t, e) {
    this.emoteReminder || "Suicide" == e || "FirstBlood" == e || (Math.random() > .5 ? this.app.fire("Overlay:Reminder", "Press [" + keyboardMap[pc.KEY_H] + "] to emote!") : this.app.fire("Overlay:Reminder", "Press [" + keyboardMap[pc.KEY_V] + "] to spray!"), this.emoteReminder = !0), this.app.fire("Player:Frag", !0), "Capture" != e && "Suicide" != e && this.killCount++
    ...
    var t = this.movement.raycastShootFrom,
        ...
        a = 1e3;
    i && (a = i.point.clone().sub(t).length(), tags = i.entity.tags.list(), a < 20 ? this.app.fire("Network:Spray", i.point, this.raycastEntity.getEulerAngles().clone()) : this.entity.sound.play("Error"))
    ...
    return !this.isGliding && (!this.isDeath && (this.movement.lookEntity.enabled = !1, this.characterHolder.enabled = !0, this.characterEntity.setLocalPosition(0, -2.15, 0), this.characterCamera.script.blackWhite.enabled = !1, this.characterCamera.setLocalPosition(0, 1.215, -.115), this.characterCamera.tween(this.characterCamera.getLocalPosition()).to({
        x: 0,
        y: 4.015,
        z: 8
    }, 1, pc.SineOut).start(), this.characterCamera.setLocalEulerAngles(0, 0, 0), this.characterCamera.tween(this.characterCamera.getLocalEulerAngles()).rotate({
        x: -18,
        y: 0,
        z: 0
    }, .7, pc.BackOut).start(), this.characterEntity.animation.play("Glide"), this.app.fire("Effect:Trigger", "Wind", 2500), this.fireNetworkEvent("glide", !0), this.entity.sound.play("Heavy-Wind"), this.entity.sound.play("Parachute-Open"), this.timers.gliderMessage = setTimeout((function(t) {
        t.app.fire("Overlay:Reminder", "Press [SPACE] to cancel glider!")
    }), 1500, this), this.gliderEntity.enabled = !0, this.lastGlidingTime = Date.now(), void(this.isGliding = !0)))
}, Player.prototype.flowJump = function() {
    this.isGliding && (Date.now() - this.lastFlowJump > 1e3 && (this.entity.rigidbody.applyImpulse(0, this.movement.bounceJumpForce, 0), this.entity.sound.play("Flow-Jump"), this.fireNetworkEvent("flowJump", !0)), this.lastFlowJump = Date.now())
}, Player.prototype.updateGliding = function() {
    this.setBackRaycast(), this.animation.lookX = pc.math.lerpAngle(this.animation.lookX, this.movement.lookX, .05), this.characterEntity.setLocalEulerAngles(180, -this.animation.lookX, 180), this.gliderEntity.setLocalEulerAngles(0, this.animation.lookX, 0), this.characterCameraHolder.setLocalEulerAngles(this.movement.lookY, this.movement.lookX, 0)
}, Player.prototype.cancelGliding = function() {
    return !!this.isGliding && (!(Date.now() - this.lastGlidingTime < 1e3) && (this.isGliding = !1, this.gliderEntity.enabled = !1, this.fireNetworkEvent("j"), this.entity.sound.stop("Heavy-Wind"), this.entity.sound.play("Parachute-Close"), clearTimeout(this.timers.gliderMessage), void this.onCameraReturn()))
    ...
    this.isEmotePlaying = !0, this.movement.disableMovement(), this.characterHolder.enabled = !0, this.gliderEntity.enabled = !1, this.app.fire("CustomSkin:Set", {
        skin: this.skinName
    }), this.characterEntity.setLocalPosition(0, -2.15, 0), this.characterEntity.animation.play(t + "-Animation"), this.characterEntity.animation.speed = 1, this.characterEntity.animation.loop = !0, this.entity.sound.play("Emote"), setTimeout((function(t) {
        t.movement.lookEntity.enabled = !1
    }), 100, this), this.characterCamera.script.blackWhite.enabled = !1, this.characterCamera.setLocalPosition(0, 1.215, -.115), this.characterCamera.tween(this.characterCamera.getLocalPosition()).to({
        x: 0,
        y: 3.015,
        z: 7
    }, 1, pc.SineOut).start(), this.characterCamera.setLocalEulerAngles(0, 0, 0), this.characterCamera.tween(this.characterCamera.getLocalEulerAngles()).rotate({
        ...
        y: 0,
        z: 0
    }, .7, pc.BackOut).start(), this.fireNetworkEvent("emote", t), setTimeout((function(t) {
        t.allowEmoteCancelation = !0
    }), 1500, this), this.emoteTimeout = setTimeout((function(t) {
        t.finishEmote()
    }), 4500, this)
}, Player.prototype.finishEmote = function() {
    if (!this.isEmotePlaying) return !1;
    this.isDeath || (this.onCameraReturn(), clearTimeout(this.emoteTimeout), setTimeout((function(t) {
    ...
    if (this.killedBy = t, this.isDeath = !0, this.deathCount++, this.movement.death(), this.gliderEntity.enabled = !1, this.characterHolder.enabled = !0, this.characterEntity.setLocalEulerAngles(0, this.movement.lookX, 0), setTimeout((function(t) {
            t.movement.lookEntity.enabled = !1
        }), 100, this), this.characterEntity.setLocalPosition(0, -2.15, 0), this.characterEntity.animation.speed = 1, this.app.fire("CustomText:KillMessage", ""), "Drown" == e ? (this.characterEntity.animation.play("Floating"), this.characterEntity.animation.speed = 3, this.characterEntity.animation.loop = !0, this.entity.sound.play("Splash"), this.characterEntity.setLocalPosition(0, -3.5, 0), this.characterEntity.tween(this.characterEntity.getLocalPosition()).to({
            x: 0,
            y: -6.5,
            z: 0
        }, 2, pc.Linear).start()) : (this.characterEntity.animation.play("Death"), this.characterEntity.animation.loop = !1), this.characterCamera.script.blackWhite.enabled = !0, this.characterCamera.setLocalPosition(0, 1.215, -.115), this.characterCamera.tween(this.characterCamera.getLocalPosition()).to({
            x: 0,
            y: 3.015,
            z: 7
        }, 1, pc.SineOut).start(), this.characterCamera.setLocalEulerAngles(0, 0, 0), this.characterCamera.tween(this.characterCamera.getLocalEulerAngles()).rotate({
            ...
            y: 0,
            z: 0
        }, .7, pc.BackOut).start(), this.interface.hideGameplay(), this.killedBy && this.killedBy != this.entity) {
    ...
    t - this.health > 30 && t > 80 && (this.app.fire("Character:Sound", "Sigh", .1 * Math.random()), setTimeout((function(t) {
        t.app.fire("Player:Speak", "Heal", 1)
    }), 1e3, this)), t - this.health > 40 && this.app.fire("Timeline:Heal"), this.health = t
    ...
    this.characterCamera.tween(this.characterCamera.getLocalPosition()).to({
        ...
        y: 1.19,
        z: 0
    }, .4, pc.SineOut).start(), this.characterCamera.tween(this.characterCamera.getLocalEulerAngles()).rotate({
        x: 0,
        y: 0,
        z: 0
    }, .4, pc.BackOut).start(), this.timers.camera = setTimeout((function(t) {
    ...
    for (var i in e) {
        ...
        a = this.entity.getPosition().clone().sub(o).length(), "TDM" != pc.currentMode && "PAYLOAD" != pc.currentMode || pc.currentTeam != s.name || t.push({
            score: a,
            point: o,
            angle: n
    ...
    this.isDeath = !1, this.isEmotePlaying = !1, this.cancelGliding(), this.movement.currentWeapon.entity.name != this.lastWeapon ? ("Shotgun" == this.movement.currentWeapon.entity.name ? this.app.fire("Player:Speak", "Shotgun", 1) : this.app.fire("Player:Speak", "Weapon-Selection", 2), this.lastWeapon = this.movement.currentWeapon.entity.name + "") : Math.random() > .8 && this.app.fire("Player:Speak", "Respawn", 3), this.onCameraReturn(!0), this.movement.enableMovement(), this.movement.setAmmoFull(), this.interface.showGameplay();
    ...
    if (e) {
        ...
        var i = e,
            a = t.rotation;
        this.entity.rigidbody.linearVelocity = new pc.Vec3(0, 0, 0), this.entity.rigidbody.teleport(i.x, i.y, i.z, 0, 0, 0), this.spawnPosition.x = i.x, this.spawnPosition.y = i.y, this.spawnPosition.z = i.z, this.leftSpawnPoint = !1, a && (180 == a.x && 180 == a.z ? this.movement.lookX = 90 - a.y : this.movement.lookX = a.y + 45)
    }
    ...
    this.movement.isForward != this.past.isForward && this.app.fire("Network:State", "w", this.movement.isForward), this.movement.isBackward != this.past.isBackward && this.app.fire("Network:State", "s", this.movement.isBackward), this.movement.isLeft != this.past.isLeft && this.app.fire("Network:State", "a", this.movement.isLeft), this.movement.isRight != this.past.isRight && this.app.fire("Network:State", "d", this.movement.isRight), this.past.isForward = this.movement.isForward, this.past.isBackward = this.movement.isBackward, this.past.isLeft = this.movement.isLeft, this.past.isRight = this.movement.isRight
    ...
    this.canBuy ? (this.app.fire("Overlay:WhiteShadow", !0), this.whiteShadowTimer = setTimeout((function(t) {
        t.canBuy = !1, pc.app.fire("Network:Buy"), setTimeout((function() {
    ...
    return !this.isCircularMenuActive && ((!pc.currentModeOptions || !0 !== pc.currentModeOptions.noWeaponChange) && (Date.now() - this.lastCircularMenu < 5e3 ? (this.entity.sound.play("Error"), !1) : (this.isCircularMenuActive = !0, this.lastCircularMenu = Date.now(), this.app.fire("Overlay:Circular", this.weapons), void setTimeout((function(t) {
        t.isCircularMenuActive = !1
    }), 3500, this))))
}, Player.prototype.checkDistanceFromSpawnPosition = function() {
    if (this.leftSpawnPoint) return !1;
    this.spawnPosition.clone().sub(this.entity.getPosition().clone()).length() > 2 && (this.app.fire("Enemy:Collision", !0), this.leftSpawnPoint = !0)
}, Player.prototype.update = function(t) {
    this.currentDate = Date.now(), this.setPosition(), this.setStates(), this.setKeyboard(), this.checkDistanceFromSpawnPosition(), this.isEmotePlaying && this.updateEmotePlaying(), this.isGliding && this.updateGliding(), this.isDeath && this.setDeathAnimation()
};
...
Enemy.attributes.add("playerId", {
    ...
    this.lastDelta = 0, this.delta = .3, this.timestamp = 0, this.deltaTotal = .3, this.deltaCount = 1, this.lastDeltaDate = Date.now(), this.isActivated = !1, this.heroSkin = "Default", this.killMessage = "", this.skinMaterial = !1, this.isActive = !0, this.isDashing = !1, this.isGrappling = !1, this.isEmotePlaying = !1, this.isGliding = !1, this.isLanded = !0, this.headAngle = 52, this.bodyAngle = 62, this.isSkinSet = !1, this.spineFactorX = 1, this.spineFactorY = 0, this.spineFactorZ = -1, this.spineDirectionX = 0, this.spineDirectionY = -10, this.spineDirectionZ = 0, this.headAngleX = -90, this.headAngleY = 40, this.headAngleZ = 30, this.lastRespawnTalk = Date.now(), pc.testAngle = -10, pc.testAngleX = .5, pc.testAngleZ = .5, this.sex = "Female", this.skin = "Lilium", this.currentAnimation = "none", this.lastDirection = "none", this.weaponSkins = {}, this.health = 100, this.damageAngle = 0, this.currentPosition = new pc.Vec3(0, 0, 0), this.currentAngle = new pc.Vec3(0, 0, 0), this.nextPosition = new pc.Vec3(0, 0, 0), this.nextAngle = new pc.Vec3(0, 0, 0), this.tempAngle = new pc.Vec3(0, 0, 0), this.currentPosition.y = Utils.nullVector.y, this.nextPosition.y = Utils.nullVector.y, this.isDeath = !1, this.isJumping = !1, this.isShooting = 0, this.isForward = !1, this.isBackward = !1, this.isLeft = !1, this.isRight = !1, this.shootingState = !1, this.isShootingLocked = !1, this.lastDamage = Date.now(), this.timeout = {}, this.currentWeapon = {}, this.setWeapon("Scar", !1), this.farPoint.setLocalPosition(0, 0, 200), this.meleeEntity.enabled = !1, this.app.on("Player:Death", this.onPlayerDeath, this), this.app.on("Player:Respawn", this.onPlayerRespawn, this), this.app.on("Player:Ready", this.onPlayerReady, this), this.app.on("Enemy:Collision", this.setEnemyCollisionState, this), setTimeout((function(t) {
        t.setConnectionState()
    }), 1500, this), this.entity.on("destroy", this.onDestroy, this)
    ...
    this.weaponHolder.destroy(), this.app.off("Player:Death", this.onPlayerDeath, this), this.app.off("Player:Respawn", this.onPlayerRespawn, this), this.app.off("Player:Ready", this.onPlayerReady, this)
    ...
    this.entity.script.label.enabled = !0, this.entity.script.label.setInitalize(), this.team = i, this.isActivated = "-1" == this.playerId, this.isActivated ? this.entity.script.label.setDestroy() : this.entity.script.label.setUsername(t, i, e)
}, Enemy.prototype.setKillMessage = function(t) {
    this.killMessage = t
}, Enemy.prototype.onPlayerRespawn = function() {
    this.entity && (this.disableRigidbodyTemporary(), this.disableDamage(), clearTimeout(this.timeout.damageTimer), this.timeout.damageTimer = setTimeout((function(t) {
        t.enableDamage()
    }), 1e3, this))
    ...
    this.currentWeapon = i.findByName(t).script.weapon, this.currentWeapon.name = this.currentWeapon.entity.name;
    var e = this.entity.findByTag("Weapon");
    for (var n in e) {
        e[n].enabled = !1
    }
    var s = this.entity.findByName(t + "-Enemy");
    if (s && (s.enabled = !0, this.weaponEntity = s, this.weaponSkins && void 0 !== this.weaponSkins[t])) {
    ...
    "Lilium" == this.skin ? (this.hammerEntity.enabled = !0, this.katanaEntity.enabled = !1) : "Shin" == this.skin && (this.hammerEntity.enabled = !1, this.katanaEntity.enabled = !0), e && this.setDanceAnimation(this.skin, e), i && "undefined" !== i && i.length > 0 && (this.heroSkin = i, this.setHeroSkin()), this.app.assets.find(this.skin + "-Character").ready((function() {
    ...
    this.healthRegenEntity.enabled = !0, this.entity.sound.play("Health-Regen"), this.lastHealthRegen = Date.now(), clearTimeout(this.healthRegen), this.healthRegen = setTimeout((function(t) {
    ...
    var t = this.danceName;
    this.isEmotePlaying = !0, this.characterEntity.animation.speed = 1, this.characterEntity.animation.play(t + "-Animation"), this.entity.sound.play("Emote"), this.timeout.emote = setTimeout((function(t) {
        t.isEmotePlaying = !1
    }), 3e3, this)
}, Enemy.prototype.setGlide = function() {
    if (this.isGliding) return !1;
    this.isGliding = !0, this.gliderEntity.enabled = !0, this.characterEntity.animation.speed = 1, this.characterEntity.animation.play("Glide"), this.entity.sound.play("Parachute"), this.entity.sound.play("Heavy-Wind"), clearTimeout(this.timeout.glide), this.timeout.glide = setTimeout((function(t) {
        t.cancelGliding()
    }), 8e3, this)
    ...
    this.enableDamage(), this.characterEntity.enabled = !0, this.characterEntity.fire("Frensel:ResetBurn", !0)
}, Enemy.prototype.burn = function() {
    this.entity && this.entity.sound && (this.entity.sound.play("Burn"), this.characterEntity.fire("Frensel:Burn", !0))
}, Enemy.prototype.death = function(t) {
    this.isDeath = !0, this.isForward = !1, this.isBackward = !1, this.isLeft = !1, this.isRight = !1, this.isJumping = !1, this.gliderEntity.enabled = !1, this.disableDamage(), "Drown" == t ? (this.entity.sound.play("Splash"), this.characterEntity.animation.speed = 4, this.characterEntity.setLocalPosition(0, -3.5, 0), this.setAnimation("Floating", .1, !0)) : (this.characterEntity.animation.speed = 1, this.characterEntity.setLocalPosition(0, -2, 0), this.setAnimation("Death", .1, !1), clearTimeout(this.timeout.burn), this.timeout.burn = setTimeout((function(t) {
        t.burn()
    }), 800, this));
    var i = this.entity.getPosition().clone(),
        e = this.entity.up.scale(-100),
        n = this.app.systems.rigidbody.raycastFirst(i, e);
    n && n.point && this.app.tween(this.nextPosition).to({
        x: n.point.x,
        y: n.point.y + 2.05,
        z: n.point.z
    }, .8, pc.BackOut).start(), this.app.fire("EffectManager:Skull", this.currentPosition), this.app.fire("EffectManager:KillSphere", this.currentPosition), this.nextAngle.y = this.damageAngle, this.currentAngle.y = this.damageAngle, clearTimeout(this.timeout.death), this.timeout.death = setTimeout((function(t) {
    ...
    return !!this.entity && (!!this.entity.rigidbody && (this.entity.rigidbody.enabled = !1, clearTimeout(this.timeout.respawnTimer), void(this.timeout.respawnTimer = setTimeout((function(t) {
        t.entity && t.entity.rigidbody && (t.entity.rigidbody.enabled = !0)
    }), 2e3, this))))
}, Enemy.prototype.respawn = function(t) {
    this.disableRigidbodyTemporary(), this.nextPosition.x = t.position.x, this.nextPosition.y = t.position.y, this.nextPosition.z = t.position.z, this.entity.setPosition(t.position.x, t.position.y, t.position.z), this.cancelGliding(), this.teleport(), this.characterEntity.animation.speed = 1, this.characterEntity.setLocalPosition(0, -2, 0);
    var i = Math.round(1 * Math.random()) + 1,
        e = this.skin + "-Talk-" + i;
    Date.now() - this.lastRespawnTalk > 5e3 && (this.characterEntity.fire("Frensel:ResetBurn", !0), this.entity.sound.play("Respawn"), Math.random() > .5 && (this.entity.sound.play(e), this.lastRespawnTalk = Date.now())), clearTimeout(this.timeout.death), clearTimeout(this.timeout.respawn), clearTimeout(this.timeout.burn), this.timeout.respawn = setTimeout((function(t) {
        t && (t.showCharacter(), t.setAnimation("Idle", .1, !0), t.isDeath = !1)
    }), 800, this)
    ...
    var n = !1;
    if (e && e.y > .9 && (n = !0), this.damageAngle = Utils.lookAt(0, 0, e.x, e.z), this.characterEntity.fire("Frensel:Damage", i), this.tempAngle.x += 3 * Math.random() - 3 * Math.random(), this.tempAngle.y += 2 * Math.random() - 2 * Math.random(), this.entity.script.label.onDamage(i), !this.isActivated) {
        var s = Math.round(2 * Math.random()) + 1,
            a = this.skin + "-Grunt-" + s,
            h = !0;
        "TDM" != pc.currentMode && "PAYLOAD" != pc.currentMode || pc.currentTeam == this.team && (h = !1, this.app.fire("Overlay:FriendlyFire", !0)), h && (this.app.fire("Hit:Point", this.entity, Math.floor(20 * Math.random()) + 5), this.entity.sound.play(a), n && this.app.fire("Hit:Headshot", this.entity, Math.floor(20 * Math.random()) + 5)), this.lastDamage = Date.now(), "TDM" == pc.currentMode || pc.currentMode
    }
    ...
    t - this.health > 20 && t > 90 && this.setHealthRegen(), this.health = t, this.entity && this.entity.fire("Health", this.health)
    ...
    this.entity.sound.slots[o] && (this.entity.sound.slots[o].pitch = 1 - .1 * Math.random(), this.entity.sound.play(o)), "Melee" != this.currentWeapon.type && "Launcher" != this.currentWeapon.type && this.app.fire("EffectManager:Fire", t, a, t, h), this.showCharacter(), this.isShootingLocked = !0
    ...
    this.characterEntity.animation.speed = .1, this.setAnimation("Echo-Grapple", .1, !1)
}, Enemy.prototype.dash = function() {
    if (this.isDashing) return !1;
    "Shin" == this.skin && (this.isDashing = !0, this.entity.sound.play(this.skin + "-Dash"), this.entity.sound.play("Whoosh-High"), this.entity.sound.play("Buff-Attack-1"), this.characterEntity.animation.speed = 1, this.setAnimation("Shin-Dash", .1, !1), this.dashEntity.enabled = !0, setTimeout((function(t) {
    ...
    this.cancelGliding(), this.isJumping = !0, this.isLanded = !1, this.characterEntity.animation.speed = 1, this.setAnimation("Jump-" + t, .1, !1);
    var i = this.skin + "-Jump-" + t;
    this.entity.sound.play(i), this.timeout.jump = setTimeout((function(t) {
        t.land()
    }), 2e3, this)
}, Enemy.prototype.melee = function() {
    var t = Math.round(1 * Math.random()) + 1,
        i = this.skin + "-Jump-" + t;
    this.entity.sound.play(i), this.currentAngle.x = this.currentAngle.x - 2, this.meleeEntity.enabled = !0, this.entity.sound.play("Whoosh"), this.entity.sound.play("Impact-Iron"), this.meleeEntity.setLocalEulerAngles(170.53, 21.25, 158.02), this.meleeEntity.tween(this.meleeEntity.getLocalEulerAngles()).rotate({
        x: 130.23,
        y: -78.41,
        z: -149.33
    }, .3, pc.BackOut).start();
    ...
    this.app.fire("EffectManager:Hit", "Melee", e, n, this.playerId, s), setTimeout((function(t) {
        t.meleeEntity.enabled = !1
    }), 300, this)
}, Enemy.prototype.bounceJump = function() {
    var t = Math.round(1 * Math.random()) + 1;
    this.isJumping = !0, this.characterEntity.animation.speed = 1, this.setAnimation("Jump-" + t, .1, !1);
    this.entity.sound.play("Bounce-Jump")
}, Enemy.prototype.setLagCompensatorMovement = function(t) {}, Enemy.prototype.setDirection = function() {
    if (this.isDeath || this.isJumping || this.isEmotePlaying || this.isDashing || this.isGliding || this.isGrappling) return !1;
    var t = "none";
    if (this.isForward && this.isLeft ? t = "Forward-Left" : this.isForward && this.isRight ? t = "Forward-Right" : this.isBackward && this.isLeft ? t = "Backward-Left" : this.isBackward && this.isRight ? t = "Backward-Right" : this.isForward ? t = "Forward" : this.isBackward ? t = "Backward" : this.isLeft ? t = "Left" : this.isRight && (t = "Right"), "none" != t) {
        var i = Math.min(Math.max(this.speed / pc.variables.enemySpeed, pc.variables.minEnemySpeed), pc.variables.maxEnemySpeed);
        "none" != this.lastDirection && this.setAnimation(this.lastDirection, .1, !0), this.characterEntity.animation.speed = pc.math.lerp(this.characterEntity.animation.speed, i, .3), this.setLagCompensatorMovement(t), this.entity.sound.slots.Footsteps.isPlaying || this.entity.sound.play("Footsteps"), this.lastDirection = t
    } else this.entity.sound.stop("Footsteps"), this.setAnimation("Idle", .2, !0)
}, Enemy.prototype.updateShooting = function() {
    this.shootingState && !this.isShootingLocked && (this.isShooting = this.currentWeapon.shootTime + this.timestamp), this.isShooting > this.timestamp && !this.isShootingLocked && this.shoot(), this.isShooting < this.timestamp && this.isShootingLocked && (this.isShootingLocked = !1)
    ...
    a = a < 40 ? .3 : a < 200 ? .03 : a < 600 ? .01 : .4, this.app.fire("EffectManager:SetEntityPosition", this.nextPosition), this.lastDeltaDate = Date.now(), this.delta = pc.math.lerp(this.delta, a, .05)
    ...
    this.speed = this.entity.getPosition().clone().sub(this.nextPosition.clone()).length(), this.speed > 20 && this.teleport(), this.tempAngle = this.tempAngle.lerp(this.tempAngle, Utils.zeroVector, .1), this.currentPosition = this.currentPosition.lerp(this.currentPosition, this.nextPosition, this.delta), this.currentAngle.x = pc.math.lerpAngle(this.currentAngle.x, this.nextAngle.x, this.delta), this.currentAngle.y = pc.math.lerpAngle(this.currentAngle.y, this.nextAngle.y, this.delta), this.entity.setPosition(this.currentPosition);
    var i = -this.currentAngle.x * pc.math.RAD_TO_DEG - this.tempAngle.x * pc.math.RAD_TO_DEG;
    this.headEntity && this.headEntity.setLocalEulerAngles(this.headAngleX, this.headAngleY, this.headAngleZ), this.spineEntity && this.spineEntity.setLocalEulerAngles(i * this.spineFactorX + this.spineDirectionX, i * this.spineFactorY + this.spineDirectionY, i * this.spineFactorZ + this.spineDirectionZ), this.characterEntity.setLocalEulerAngles(0, this.currentAngle.y * pc.math.RAD_TO_DEG - this.tempAngle.y * pc.math.RAD_TO_DEG - this.bodyAngle, 0), this.bodyEntity.setLocalEulerAngles(-this.currentAngle.x * pc.math.RAD_TO_DEG, this.currentAngle.y * pc.math.RAD_TO_DEG - this.bodyAngle, 0)
}, Enemy.prototype.update = function(t) {
    if (this.isActivated) return !1;
    this.setMovement(t), this.lastDelta += t;
    var i = this.lastDelta;
    i > pc.dt - .001 && (this.setDirection(), this.updateShooting(), this.timestamp += i, this.lastDelta = 0)
};
...
MapManager.attributes.add("defaultMap", {
    ...
    this.autoLoad && ("undefined" != typeof app && (this.defaultMap = app.session.map), this.loadMap(this.defaultMap)), this.mapName = !1, this.mapTimer = !1, this.isLoaded = !1, this.isLoading = 0, this.app.on("Map:Load", this.loadMap, this), this.app.on("Map:Destroy", this.onDestroy, this), this.app.on("Map:Loaded", this.onMapLoaded, this), this.app.on("Map:Thunder", this.thunder, this), this.app.on("Game:PreStart", this.onPreStart, this), this.app.on("Game:Finish", this.onFinish, this), this.app.on("Game:Settings", this.onSettingsChange, this), pc.isMapLoaded = !1, this.setRandomSounds()
    ...
    this.currentMapName = a, console.log("Called map:", a), e ? this.clearHolder((function() {
        console.log("Holder is clear, loading: ", a), t.setMap(a)
    })) : (console.log("[DEBUG] This map is a custom map, loading from CDN"), this.clearHolder((function() {
    ...
    this.app.fire("Fetcher:MapManager", {
        ...
        noWeaponChange: !0
    }, this.isLoaded = !1, this._onMapLoad()
    ...
    i && i.sound && (i.sound.stop("Ambient"), i.sound.stop("Rain")), e && e.url && (this.app.scenes.loadSceneHierarchy(e.url + "?v=" + o, (function(a, i) {
        i && (t.mapHolder.reparent(i), t.app.scenes.loadSceneSettings(e.url + "?v=" + o, (function(a, e) {
            t.onMapLoad()
        })), pc.app.fire("Map:Reparent", !0)), a && console.log("[ERROR] ", a)
    })), this.isLoaded = !0)
    ...
    clearTimeout(pc.mapLoadTimer), pc.mapLoadTimer = setTimeout((function() {
        pc.isMapLoaded = !0, pc.app.fire("Map:Reparent", !0), pc.app.fire("Map:Loaded", !0), pc.app.batcher.generate()
    }), 2e3)
    ...
    this.app.scene.exposure = a + 15, this.app.tween(this.app.scene).to({
        exposure: a
    }, .1, pc.Linear).delay(.15).start(), this.entity.sound.slots.Thunder.pitch = 1 + .2 * Math.random(), this.entity.sound.play("Thunder")
}, MapManager.prototype.setRandomSounds = function() {
    "Mistle" == this.mapName && this.entity.sound.play("Seagull"), setTimeout((function(a) {
        a.setRandomSounds()
    }), 1e3 * (50 + 90 * Math.random()), this)
}, MapManager.prototype.clearHolder = function(a) {
    var t = this.app.root.findByName("MapHolder");
    t ? (this.isLoaded = !1, t.on("destroy", (function() {
        console.log("Destroy properly completed!"), a && a()
    })), t.destroy()) : a && a(), this.app.fire("MapLoader:Clear", !0)
};
...
Menu.attributes.add("cameraEntity", {
    ...
    if (this.currentWidth = 0, this.currentHeight = 0, this.timestamp = 0, this.originRotation = 10, this.isMatchFound = !1, this.isConnected = !1, pc.session = {
            weapon: "Scar",
            character: "Lilium",
            hash: !1,
            username: !1
        }, this.app.loader.getHandler("texture").crossOrigin = "anonymous", this.app.on("Player:Weapon", this.onWeaponSelect, this), this.app.on("Player:Character", this.onCharacterSelect, this), this.app.on("Template:Profile", this.onProfileData, this), this.app.on("Game:Found", this.onMatchFound, this), this.app.on("Game:Connect", this.onConnect, this), this.app.on("Menu:Mute", this.setMute, this), this.app.on("Menu:SetHome", this.setHome, this), this.app.on("Menu:CloseMobile", this.onCloseMobile, this), this.app.mouse.on("mousemove", this.onMouseMove, this), this.app.on("Menu:BuyOffer", this.onOfferBuy, this), this.app.on("Menu:CloseOffer", this.onOfferClose, this), this.app.on("Menu:GetBoost", this.onBoostGet, this), this.app.on("Menu:CloseBoost", this.onBoostClose, this), this.app.on("Menu:ClearQuests", this.clearQuests, this), this.app.on("Buy:State", this.onMobileBuyState, this), this.app.on("Buy:ApplyCode", this.applyCreatorCode, this), this.app.on("Buy:Coins", this.onBuyCoins, this), this.app.on("Menu:Music", this.setMenuMusic, this), this.mobileUUID = !1, this.app.on("Account:CreateMobileUser", this.createMobileUser, this), this.app.on("Account:SaveUUID", this.onSaveUUID, this), this.app.on("Account:ChangeUsername", this.triggerChangeUsername, this), this.app.on("Account:ChangeStatus", this.onChangeStatus, this), this.app.on("Account:Reward", this.onAccountReward, this), this.app.on("CustomCSS:Loaded", this.setCustomCSS, this), this.app.on("Page:Menu", this.onPageChange, this), this.app.on("Tab:Settings", this.onSettings, this), this.setProfile(), this.setBanner(), this.setMobileElements(), this.app.on("Sound:Play", this.onSoundPlay, this), this.attachCharacterEntity(), this.entity.on("destroy", this.onDestroy, this), "undefined" != typeof VERSION_CODE && (this.versionEntity.element.text = "v" + VERSION_CODE), this.mobileRedirection && pc.isMobile, Utils.isMobile() && (this.mobileFreeCoin.setLocalScale(1.2, 1.2, 1.2), this.sideEntity.setLocalScale(1.331, 1.331, 1.331)), pc.isMobile) {
    ...
    this.lightRoomEntity.enabled = !1, this.app.scene.layers.getLayerByName("Lightroom").enabled = !0, this.app.scene.layers.getLayerByName("Lightroom-Top").enabled = !0, setTimeout((function(t) {
        t.setShopNotification(), t.setLeftEarlyNotification()
    }), 100, this), this.app.fire("Ads:Adblock", !0), this.app.fire("Analytics:Event", "Checkpoint", "Menu")
    ...
    this.app.fire("Notify:Notify", "You don't have enough coins"), setTimeout((function(t) {
        t.app.fire("Popup:Coins")
    }), 1e3, this)
}, Menu.prototype.setCustomCSS = function() {
    accountManager.init()
}, Menu.prototype.setLeftEarlyNotification = function() {
    "Left" === Utils.getItem("LeftEarly") && Math.random() > .5 && this.app.fire("Alert:Menu", "Leaving matches early will affect your scores."), Utils.setItem("LeftEarly", "Clear")
}, Menu.prototype.setShopNotification = function() {
    var t = !1;
    Utils.getItem("LastVersion") != VERSION_CODE && (t = !0, Utils.setItem("LastVersion", VERSION_CODE)), this.app.fire("ConditionPositioning:Shop", {
        new_items: t
    })
    ...
    this.offerAccepted && ("error" == t ? this.app.fire("Alert:Menu", "An error occured on payment!") : ("successful" == t || "restored" == t) && (this.app.fire("Fetcher:MobilePayment", {
        token: "mobile-process",
        sku: "10000VG"
    }), this.onOfferClose(), Utils.setItem("MobileAds", "NoAds")))
    ...
    this.app.fire("Ads:Preroll", (function() {
        pc.app.fire("Alert:Menu", "Boost activated for your game session!"), pc.app.systems.sound.volume = .25
    }), (function() {
        pc.app.fire("Alert:Menu", "Please disable adblock to enable rewards!"), pc.app.systems.sound.volume = .25
    }))
    ...
    this.app.fire("Ads:BannerDestroy", "venge-io_728x90", "728x90"), this.app.systems.sound.volume = 0, this.app.fire("Ads:Preroll", (function() {
        pc.app.fire("Ads:BannerSet", "venge-io_728x90", "728x90"), pc.app.fire("Fetcher:Reward", !0), pc.app.systems.sound.volume = .25
    }), (function() {
        pc.app.fire("Ads:BannerSet", "venge-io_728x90", "728x90"), pc.app.fire("Alert:Menu", "Please disable adblock to enable rewards!"), pc.app.systems.sound.volume = .25
    ...
    this.originRotation += .01 * t.dx
}, Menu.prototype.onSaveUUID = function() {
    this.mobileUUID && (Utils.setItem("MobileHash", this.mobileUUID), setTimeout((function(t) {
        t.mobileWaiting.enabled = !1, window.location.reload(!0)
    }), 1e3, this))
}, Menu.prototype.createMobileUser = function(t) {
    var e = Utils.getItem("Hash");
    !Utils.isMobile() || e && "undefined" != e || (this.app.fire("Fetcher:MobileAccount", {
        username: "mobile_" + t,
        password: "pass_" + t
    }), this.mobileWaiting.enabled = !0, this.mobileUUID = t)
}, Menu.prototype.triggerChangeUsername = function() {
    var t = prompt("Enter new username", "");
    null !== t && this.app.fire("Fetcher:MobileUsername", {
        username: t
    })
    ...
    "Shop" == t ? (this.app.fire("Show:Character", "Hide"), this.lightRoomEntity.enabled = !0) : (this.app.fire("CustomColor:Background", {
        color: this.menuColor
    }), this.lightRoomEntity.enabled = !1), "Match" == t && this.app.fire("Show:Character", "Show"), setTimeout((function(t) {
        t.app.fire("DOM:Update", !0)
    }), 100, this), this.app.fire("ConditionPositioning:Menu", {
        page: t
    })
}, Menu.prototype.onSettings = function(t) {}, Menu.prototype.setHome = function(t) {
    if (this.isConnected) return !1;
    if ("undefined" != typeof VERSION_CODE && "DEV" != VERSION_CODE && (VERSION_CODE == t.version || pc.isMobile || (this.updateEntity.enabled = !0, this.updateVersionEntity.element.text = t.version)), t && t.official_stream_data) {
        var e = "";
        e += "<iframe", e += ' src="https://player.twitch.tv/?channel=' + t.official_stream_data, e += '&parent=venge.io"', e += ' height="100%"', e += ' width="100%"', e += ' frameborder="0"', e += ' scrolling="false"', e += ' allowfullscreen="true">', e += "</iframe>", this.streamEntity.enabled = !0, this.streamEntityContainer.script.container.element.innerHTML = e
    } else this.streamEntity.enabled = !1;
    this.streamerImage && t.preview_image ? (this.streamerImage.fire("CustomImage:Set", t), this.streamerImage.script.button.setLink(t.preview_link), this.app.fire("CustomText:StreamerText", t), this.streamerImage.enabled = !0) : this.streamerImage.enabled = !1, Math.random() > .2 ? (this.streamerImage.enabled = !0, this.bannerImage.enabled = !1) : (this.streamerImage.enabled = !1, this.bannerImage.enabled = !0), t.youtuber_shop && t.youtuber_shop.name && (this.youtubeShopName.element.text = t.youtuber_shop.name.slice(0, 50), this.youtubeShopButton.script.button.setLink(t.youtuber_shop.link)), t.server && this.app.fire("RoomManager:SetServer", t.server)
}, Menu.prototype.setMute = function() {
    this.entity.sound.stop("Loop")
}, Menu.prototype.setProfile = function() {
    var t = Utils.getItem("Hash");
    if (void 0 !== t && (pc.session.hash = t), window.location.href.search("create-account") > -1 && setTimeout((function() {
            pc.app.fire("AccountManager:Signup", !0)
        }), 50), window.location.href.search("login") > -1 && setTimeout((function() {
            pc.app.fire("Page:Menu", "Account"), setTimeout((function() {
                pc.app.fire("Tab:Login", "Login")
            }), 10)
        }), 50), window.location.href.search("code") > -1) {
        var e = window.location.href.split("=")[1];
        setTimeout((function() {
            pc.app.fire("Page:Menu", "Shop"), setTimeout((function() {
                pc.app.fire("Tab:Shop", "Buy VG"), setTimeout((function() {
    ...
    if (t && (pc.session.hash = t.hash, pc.session.username = t.username, Utils.setItem("Hash", t.hash), t.username && this.miniProfileEntity && this.miniProfileEntity.element)) this.miniProfileEntity.findByName("Username").element.width
    ...
    this.isMatchFound = !0, this.app.scene.layers.getLayerByName("Lightroom").enabled = !1, this.app.scene.layers.getLayerByName("Lightroom-Top").enabled = !1, clearTimeout(this.bannerTimeout), this.app.fire("Ads:BannerDestroy", "venge-io_728x90", "728x90"), this.app.fire("DOM:Clear", !0), this.app.off("Player:Character"), this.app.fire("Popup:Close", !0), this.matchFoundBackground.enabled = !0, this.matchFoundBackground.tween(this.matchFoundBackground.element).to({
        opacity: 1
    }, 1, pc.Linear).start(), this.matchFoundRectangle.element.opacity = 1, this.matchFoundRectangle.setLocalScale(20, 1, 1), this.matchFoundRectangle.tween(this.matchFoundRectangle.getLocalScale()).to({
        x: 1,
        y: 1,
        z: 1
    }, .5, pc.Linear).start(), this.matchFoundRectangle.tween(this.matchFoundRectangle.element).to({
        opacity: .1
    }, .5, pc.Linear).start(), this.matchFoundCenter.tween(this.matchFoundCenter.getLocalScale()).to({
        x: 1.2,
        y: 1.2,
        z: 1.2
    }, 2, pc.Linear).start(), setTimeout((function(t) {
        t.matchFoundLoading.enabled = !0, t.matchFoundRectangle.tween(t.matchFoundRectangle.element).to({
            opacity: 0
        }, .5, pc.Linear).start(), t.matchFoundText.tween(t.matchFoundText.element).to({
            opacity: 0
        }, .5, pc.Linear).start(), setTimeout((function() {
    ...
    var t = this.app.scenes.find("Prototype"),
        e = this.app.root,
        i = "1.0.0";
    "undefined" != typeof VERSION && (i = VERSION), this.isConnected = !0, this.app.root.findByName("MenuHolder").destroy(), this.app.scenes.loadSceneHierarchy(t.url + "?v=" + i, (function(t, i) {
        i.reparent(e)
    }))
    ...
    this.checkScreenSize(), this.originRotation = pc.math.lerp(this.originRotation, 0, .02), this.originEntity.setLocalEulerAngles(0, this.originRotation, 0), this.app.scene.skyboxRotation && (this.app.scene.skyboxRotation.y -= .005 * t, this.app.scene._resetSkyboxModel(), this.timestamp += t)
};
Object.assign(pc, function() {
    ...
    return (BlackWhiteEffect.prototype = Object.create(pc.PostEffect.prototype)).constructor = BlackWhiteEffect, Object.assign(BlackWhiteEffect.prototype, {
...
BlackWhite.prototype.initialize = function() {
    this.effect = new pc.BlackWhiteEffect(this.app.graphicsDevice), this.effect.offset = this.offset, this.effect.darkness = this.darkness, this.on("attr", (function(t, e) {
        this.effect[t] = e
    }), this);
...
Label.attributes.add("headPoint", {
    ...
    this.isInitalized = !1, this.alwaysShow = !1, this.team = "none", this.isEnabled = !1, this.originalUsername = "Guest", this.usernameEntity = !1, this.entity.on("Health", this.setHealth, this), this.app.on("Game:Mode", this.onGameMode, this), this.app.on("Game:Finish", this.onGameFinish, this), this.app.on("Player:Respawn", this.onPlayerRespawn, this), this.app.on("Player:Death", this.onPlayerDeath, this), this.app.on("Game:Settings", this.onSettingsChange, this), this.app.on("Label:Show", this.showLabel, this), this.on("destroy", this.onDestroy, this)
}, Label.prototype.onDestroy = function() {
    this.app.off("Game:Mode", this.onGameMode, this), this.app.off("Game:Finish", this.onGameFinish, this), this.app.off("Player:Respawn", this.onPlayerRespawn, this), this.app.off("Player:Death", this.onPlayerDeath, this), this.app.off("Game:Settings", this.onSettingsChange, this), this.app.off("Label:Show", this.showLabel, this), this.entity.off("Health"), this.whiteBarTween && this.whiteBarTween.stop()
    ...
    this.labelEntity.findByName("Username").element.text = Utils.displayUsername(t), this.labelEntity.findByName("Level").element.text = i, this.originalUsername = t, this.usernameEntity = this.labelEntity.findByName("Username"), this.team = e, this.updateTeamColor()
    ...
    return this.maskEntity.setLocalPosition(i, 0, 0), this.healthBarEntity.setLocalPosition(-i, 0, 0), !!this.whiteBarEntity && (!!this.whiteBarEntity.element && (this.whiteBarEntity.element.opacity = 1, this.whiteBarEntity.tween(this.whiteBarEntity.getLocalScale()).to({
        x: e,
        y: 1,
        z: 1
    }, .5, pc.Linear).start(), this.whiteBarTween = this.whiteBarEntity.tween(this.whiteBarEntity.element).to({
        opacity: 0
    }, .5, pc.BackInOut), void this.whiteBarTween.start()))
    ...
    console.log(t), e && e.entity && "Player" == e.entity.name ? this.isVisible = !0 : this.isVisible = !1, console.log(this.isVisible)
    ...
    a.worldToScreen(e, i), i.x *= s, i.y *= s, i.x > 0 && i.x < this.app.graphicsDevice.width && i.y > 0 && i.y < this.app.graphicsDevice.height && i.z > 0 ? (this.labelEntity.setLocalPosition(i.x / n, (l.height - i.y) / n, 0), this.labelEntity.enabled = !0) : this.labelEntity.enabled = !1
};
...
Result.attributes.add("topLine", {
    ...
    for (var t in this.players = [], this.rankOpacity = 0, this.mapEntities = [], this.time = this.maxTime, this.tick(), this.rowEntity.enabled = !1, this.resultHolder.enabled = !0, this.scoresEntity.enabled = !1, pc.currentMap && (this.mapNameEntity.element.text = pc.currentMap + ""), pc.voteMaps || (pc.voteMaps = ["Sierra", "Xibalba", "Mistle", "Tundra", "Temple"]), !0 === pc.isSpectator ? this.showMessage("OVER") : pc.isVictory ? this.showMessage("VICTORY") : this.showMessage("DEFEAT"), setTimeout((function(t) {
            t.showResultPage(pc.stats)
        }), 3e3, this), this.app.fire("Overlay:Gameplay", !1), this.app.fire("Overlay:PlayerStats", !1), this.app.fire("Mouse:Unlock"), pc.isFinished = !0, this.app.fire("Player:Lock", !1), this.app.fire("Game:Finish", !0), this.currentSkillIndex = 0, this.skills = [], pc.stats) {
        var e = pc.stats[t];
        e.isMe && (this.skills = [{
            name: "Experience",
            score: e.experience
    ...
    this.skillPoints = [], this.voteBar.setLocalScale(.001, 1, 1), pc.isPrivate ? this.skillHolder.enabled = !1 : this.skillHolder.enabled = !0, this.on("state", this.onStateChange, this), this.entity.on("destroy", this.onDestroy, this), this.onStateChange(!0), this.rewardButtonTimer = setTimeout((function(t) {
        pc.app.fire("Result:DestroyBanner", !0)
    }), 2e4, this), window.onbeforeunload = !1
    ...
    t && (t.setLocalPosition(0, 0, 0), t.reparent(this.app.root.findByName("ChatGame"))), this.entity.destroy()
}, Result.prototype.onLeave = function() {
    this.removeResultScreen()
}, Result.prototype.setBanner = function() {
    Utils.isMobile() ? this.app.fire("Ads:BannerSet", "venge-io_320x50_2", "320x50", !0) : this.app.fire("Ads:BannerSet", "venge-io_728x90_2", "728x90", !0)
    ...
    var t = "Ads:Preroll";
    Math.random() > .3 && (t = "Ads:RewardAds"), this.app.fire(t, (function(t) {
    ...
    a.enabled = !0, a.findByName("Name").element.text = e, a.setLocalPosition(-15, n, 0), a.tween(a.getLocalPosition()).to({
        x: 0,
        y: n,
        z: 0
    }, .5, pc.BackOut).start();
    ...
    o.tween(o.getLocalScale()).to({
        ...
        y: 1,
        z: 1
    }, .7, pc.Linear).start(), a.findByName("Point").script.count.next = i, this.skillPoints.push(a), this.skillHolder.addChild(a), this.currentSkillIndex++, this.entity.sound.play("Data-Increase"), setTimeout((function(t) {
        t.setSkillPoint()
    }), 500, this)
    ...
    var t = Math.max(this.time, 0),
        e = this.time - 10;
    e = Math.max(e, 0), this.time--, t >= 0 && (this.timer = setTimeout((function(t) {
        t.tick()
    }), 1e3, this))
}, Result.prototype.clearVoteEntities = function() {
    for (var t = this.mapEntities.length; t--;) this.mapEntities[t].destroy();
    this.mapEntities = [], this.mapEntity.enabled = !1, this.cloudNoiseEntity.tween(this.cloudNoiseEntity.getLocalEulerAngles()).rotate({
        x: 0,
        y: 0,
        z: -170
    }, this.maxTime, pc.Linear).start(), this.barEntity.tween(this.barEntity.element).to({
        width: 1400
    ...
    for (var e in this.clearVoteEntities(), t) {
        ...
        n.name = i + "-Map", n.enabled = !0, n.setLocalPosition(this.mapEntities.length * (n.element.width + this.padding), 0, 0), n.findByName("Name").element.text = i, n.findByName("Picture").element.textureAsset = a, n.findByName("VoteButton").script.button.triggerFunction = 'result.vote("' + i + '");', this.mapHolder.addChild(n), this.mapEntities.push(n)
    }
    ...
    this.voteBar.tween(this.voteBar.getLocalScale()).to({
        ...
        y: 1,
        z: 1
    }, .4, pc.Linear).start(), this.voteCount.element.text = e + " / " + this.players.length, this.entity.sound.play("Vote")
    ...
    this.backgroundEntity && this.backgroundEntity.element && this.backgroundEntity.tween(this.backgroundEntity.element).to({
        opacity: .9
    }, 5, pc.Linear).start(), this.headerEntity && this.headerEntity.element && (this.headerEntity.element.width = 2e3, this.headerEntity.tween(this.headerEntity.element).to({
        width: 1e3
    }, .8, pc.BackOut).start());
    var s = this.app.root.findByName("ChatWrapper");
    s && (s.setLocalPosition(0, 0, 0), s.reparent(this.app.root.findByName("ChatHolder"))), setTimeout((function(t) {
        t.app.fire("DOM:Update", !0)
    }), 100, this), setTimeout((function(t) {}), 800, this)
    ...
    var n = i.findByName("SocialHub"),
        ...
        p = !1;
    t.isMe ? (i.findByName("You").enabled = !0, p = !1, o = !1) : (i.findByName("You").enabled = !1, p = !0, o = !0, t.username.search("Guest") > -1 && (p = !1, o = !1)), l.enabled = p, n.enabled = o, i.findByName("Rank").element.text = e, i.findByName("Rank").element.opacity = this.rankOpacity, l && l.script && l.script.button && (l.script.button.fireFunction = "Follow:User@" + Utils.onlyUsername(t.username)), n.script.button.triggerFunction = 'window.open("https://social.venge.io/#' + Utils.onlyUsername(t.username) + '")', r.script.button.triggerFunction = 'window.open("https://social.venge.io/#' + Utils.onlyUsername(t.username) + '")', this.rankOpacity -= .4;
    var h = this.players.length % 2 + 2;
    1 === e ? (h = 1, i.element.opacity = 1) : i.element.opacity = this.players.length % 2 ? .8 : .7;
    ...
    for (var u in t.achievements) {
        var c = t.achievements[u],
            ...
            f = y.clone();
        f.enabled = !0, f.setLocalPosition(34 * parseInt(u), 0, 0), f.element.textureAsset = m, d.addChild(f)
    }
    var g = this.app.assets.find(t.skin + "-Thumbnail-" + h);
    t.heroSkin && "Default" != t.heroSkin && (g = this.app.assets.find(t.skin + "-" + t.heroSkin + "-Thumbnail.png")), i.findByName("PlayerPicture").element.textureAsset = g, i.tween(i.getLocalPosition()).to({
        x: 0,
        y: s,
        z: 0
    }, .5, pc.BackOut).delay(.1 * e).start(), this.statsHolder.addChild(i), this.players.push(i), setTimeout((function(t) {
        t.entity.sound.slots.Whoosh.pitch = 1 + .1 * Math.random(), t.entity.sound.play("Whoosh")
    }), 100 * e, this)
    ...
    console.log(s), i.enabled = !0, i.setLocalPosition(-800, s, 0), i.findByName("Kill").element.text = t.kill.toString(), i.findByName("Death").element.text = t.death.toString(), i.findByName("Assist").element.text = t.assist.toString(), i.findByName("Headshot").element.text = t.headshot.toString(), i.findByName("DamageGiven").element.text = t.damageGiven.toString(), i.findByName("DamageTaken").element.text = t.damageTaken.toString(), i.findByName("Objective").element.text = t.totalCardPoint.toString(), i.findByName("Reward") && (t.reward > 0 ? i.findByName("Reward").element.text = "+" + t.reward.toString() : i.findByName("Reward").enabled = !1), i.findByName("Score").element.text = t.score.toString();
    var a = this.app.assets.find("Tier-" + t.tier + ".png");
    a && (i.findByName("Tier").element.textureAsset = a), i.findByName("Status").element.color = 0 == e ? this.victoryColor : this.defeatColor, this.rankOpacity -= .4;
    var n = this.players.length % 2 + 2;
    0 === e ? (n = 0, i.element.opacity = 1) : i.element.opacity = this.players.length % 2 ? .8 : .7;
    var o = this.app.assets.find(t.skin + "-Thumbnail-" + n);
    t.heroSkin && "Default" != t.heroSkin && (o = this.app.assets.find(t.skin + "-" + t.heroSkin + "-Thumbnail.png")), i.findByName("PlayerPicture").element.textureAsset = o, i.tween(i.getLocalPosition()).to({
        x: s,
        y: 0,
        z: 0
    }, .5, pc.BackOut).delay(.1 * e).start(), this.columnStatsHolder.addChild(i), setTimeout((function(t) {
        t.entity.sound.slots.Whoosh.pitch = 1 + .1 * Math.random(), t.entity.sound.play("Whoosh")
    }), 100 * e, this)
}, Result.prototype.showMessage = function(t) {
    this.resultMessage.element.text = t, this.resultMessageOpacity.element.text = t, this.resultTitleEntity.element.text = t, "VICTORY" == t ? (this.backgroundEntity.element.color = this.victoryBgColor, this.headerBackgroundEntity.element.color = this.victoryColor, this.topLine.element.color = this.victoryColor, this.bottomLine.element.color = this.victoryColor, this.resultMessage.element.color = this.victoryColor, this.entity.sound.play("Victory-Result")) : (this.backgroundEntity.element.color = this.defeatBgColor, this.headerBackgroundEntity.element.color = this.defeatColor, this.topLine.element.color = this.defeatColor, this.bottomLine.element.color = this.defeatColor, this.resultMessage.element.color = this.defeatColor, this.entity.sound.play("Defeat-Result")), this.cloudEntity.tween(this.cloudEntity.getLocalEulerAngles()).rotate({
        x: 0,
        y: 0,
        z: -20
    }, 3, pc.CubicOut).start(), this.cloudEntity.tween(this.cloudEntity.getLocalScale()).to({
        x: 3,
        y: 3,
        z: 3
    }, 3, pc.CubicOut).start(), this.cloudEntity.element.opacity = .15, this.cloudEntity.tween(this.cloudEntity.element).to({
        opacity: 0
    }, 3, pc.Linear).start(), this.resultMessage.setLocalScale(.1, .1, .1), this.resultMessage.tween(this.resultMessage.getLocalScale()).to({
        x: 1,
        y: 1,
        z: 1
    }, .5, pc.Linear).start(), this.resultHolder.element.height = 100, this.resultHolder.tween(this.resultHolder.element).to({
        height: 300
    }, .5, pc.ExponentialInOut).start(), this.resultMessageOpacity.tween(this.resultMessageOpacity.element).to({
        opacity: 0
    }, .4, pc.Linear).start(), this.resultMessageOpacity.setLocalScale(.1, .1, .1), this.resultMessageOpacity.tween(this.resultMessageOpacity.getLocalScale()).to({
        x: 2,
        y: 2,
        z: 2
    }, .5, pc.Linear).start(), setTimeout((function(t) {
        t.resultMessage.tween(t.resultMessage.getLocalScale()).to({
            x: 1.2,
            y: 1.2,
            z: 1.2
        }, 1.3, pc.Linear).start(), t.resultHolder.tween(t.resultHolder.element).to({
            height: 340
        }, 1.3, pc.Linear).start()
    }), 500, this), this.resultMessage.element.opacity = 0, this.resultMessage.element.spacing = .8, this.resultMessage.tween(this.resultMessage.element).to({
        opacity: 1,
        spacing: 1.3
    }, 1.5, pc.BackOut).start(), this.topLine.element.opacity = 0, this.topLine.tween(this.topLine.element).to({
        opacity: 1
    }, .5, pc.Linear).start(), this.topLine.setLocalScale(.1, .5, 1), this.topLine.tween(this.topLine.getLocalScale()).to({
        x: 1,
        y: 1,
        z: 1
    }, .5, pc.ExponentialInOut).start(), this.bottomLine.element.opacity = 0, this.bottomLine.tween(this.bottomLine.element).to({
        opacity: 1
    }, .5, pc.Linear).start(), this.bottomLine.setLocalScale(.1, .5, 1), this.bottomLine.tween(this.bottomLine.getLocalScale()).to({
        x: 1,
        y: 1,
        z: 1
    }, .5, pc.ExponentialInOut).start(), setTimeout((function(t) {
        t.resultMessage.tween(t.resultMessage.getLocalScale()).to({
            x: 2,
            y: 2,
            z: 2
        }, .8, pc.QuadraticOut).start(), t.resultMessage.tween(t.resultMessage.element).to({
            opacity: 0,
            spacing: 1
        }, .8, pc.BackOut).start(), t.topLine.tween(t.topLine.element).to({
            opacity: 0
        }, .2, pc.Linear).start(), t.topLine.tween(t.topLine.getLocalScale()).to({
            x: .1,
            y: .5,
            z: 1
        }, .5, pc.BackOut).start(), t.bottomLine.tween(t.bottomLine.element).to({
            opacity: 0
        }, .2, pc.Linear).start(), t.bottomLine.tween(t.bottomLine.getLocalScale()).to({
            x: .1,
            y: .5,
            z: 1
        }, .5, pc.BackOut).start()
...
Thumbnail.attributes.add("model", {
    ...
    this.canvas = document.createElement("canvas"), this.context = this.canvas.getContext("2d"), this.currentTextureIndex = 0, this.canvas.width = 1024, this.canvas.height = 1024, this.index = 0, this.currentName = "thumbnail.png"
    ...
    return e.toString().replace(/\s+/g, "-").replace(a, (e => "aaaaaaaaaacccddeeeeeeeegghiiiiiilmnnnnoooooooooprrsssssttuuuuuuuuuwxyyzzz------".charAt(t.indexOf(e)))).replace(/&/g, "-and-").replace(/[^\w\-]+/g, "").replace(/\-\-+/g, "-").replace(/^-+/, "").replace(/-+$/, "") + "-thumbnail"
    ...
    for (var e = this.model.model.material.clone(), t = this.textures[this.currentTextureIndex], a = this.model.model.meshInstances, i = 0; i < a.length; ++i) {
        a[i].material = e
    }
    this.app.assets.load(t), t.ready((function(a) {
    ...
    a.src = pc.app.graphicsDevice.canvas.toDataURL("image/png"), a.onload = function() {
        t.context.clearRect(0, 0, t.canvas.width, t.canvas.height), t.context.drawImage(a, -pc.app.graphicsDevice.width / 2 + 512, -pc.app.graphicsDevice.height / 2 + 512);
        var e = new Image;
        e.src = t.canvas.toDataURL("image/png"), e.onload = function() {
...
Chat.attributes.add("inputEntity", {
    ...
    this.displayed = !1, this.messages = [], this.includeList = ["fuck", "f u c k", "fuk", "f u k", "fuc", "f u c", "rape", "r a p e", "raping", "r a p i n g", "boob", "b o o b", "b00b", "b 0 0 b", "faggot", "f a g g o t", "gay", "g a y", "nigga", "n i g g a", "nigger", "n i g g e r", "niger", "n i g e r", "niga", "n i g a", "dick", "d i c k", "cock", "c o c k", "shlong", "s h l o n g", "dong", "d o n g", "vagina", "v a g i n a", "pussy", "p u s s y"], this.exactList = ["nig", "n i g", "cok", "c o k"], this.messageEntity.enabled = !1, this.on("state", (function(t) {
    ...
    if (t > 0)
        for (var e = 0; t--;) this.messages[t].setLocalPosition(0, (this.messages.length - t) * this.padding + e, 0), e += this.messages[t].element.height;
...
Speaking.attributes.add("subtitles", {
    ...
    this.characterName = "Lilium", this.lastPlayTime = Date.now(), this.currentIndex = 0, this.lastPlayedSound = !1, this.app.on("Player:Speak", this.onPlay, this), this.app.on("Player:StopSpeaking", this.onStop, this), this.app.on("Player:Character", this.onCharacterSet, this)
...
Count.attributes.add("leftPad", {
    ...
    this.currentNumber = 0, this.on("state", (function(t) {
        t ? this.startCounter() : this.app.off("Count:" + this.entity.name, this.setNextNumber, this)
    })), this.startCounter(), this.entity.on("Count", this.setNextNumber, this)
...
Terrain.attributes.add("map", {
    ...
    var e = this;
    this.currentLoaded = 0, this.app.assets.load(this.map), this.app.assets.load(this.red), this.app.assets.load(this.green), this.app.assets.load(this.blue), this.map.ready((function() {
        e.upload()
...
Object.assign(pc, function() {
    ...
    return (ZoomEffect.prototype = Object.create(pc.PostEffect.prototype)).constructor = ZoomEffect, Object.assign(ZoomEffect.prototype, {
...
Zoom.prototype.initialize = function() {
    this.effect = new pc.ZoomEffect(this.app.graphicsDevice), this.effect.offset = this.offset, this.effect.darkness = this.darkness, this.on("attr", (function(e, t) {
        this.effect[e] = t
    }), this);
...
Button.attributes.add("connected", {
    ...
    this.spinner = !1, this.text = !1, this.isActivated = !0, this.isDestroyed = !1, this.linkButton ? (this.createLinkElement(), this.on("state", (function(t) {
        this.entity.enabled ? this.createLinkElement() : this.element.remove()
    }), this)) : Utils.isMobile() ? (this.entity.element.on("touchstart", this.onPress, this), this.entity.element.on("touchend", this.onLeave, this)) : (this.entity.element.on("mouseenter", this.onHover, this), this.entity.element.on("mouseleave", this.onLeave, this), this.entity.element.on("mousedown", this.onPress, this)), this.linkButton || this.on("state", (function(t) {
        this.resolve()
    }), this), this.entity.findByName("Spinner") && (this.spinner = this.entity.findByName("Spinner"), this.spinner.enabled = !1), this.entity.findByName("Text") && (this.text = this.entity.findByName("Text"), this.text.enabled = !0), this.app.on("Button:" + this.entity.name, this.onState, this), this.app.on("Button:" + this.entity.name + ":Resolve", this.resolve, this), this.app.on("Link:" + this.entity.name, this.setLink, this), this.app.on("DOM:Clear", this.onDOMClear, this), this.app.on("DOM:Update", this.onDomUpdate, this)
    ...
    var t = this;
    this.element = document.createElement("a"), this.element.style.width = this.entity.element.width + "px", this.element.style.height = this.entity.element.height + "px", this.element.id = this.entity.name, this.element.className = "container", this.element.onclick = function() {
        pc.firstPressFunction || (console.log("First Press : Link " + t.link), pc.app.fire("Analytics:Event", "Checkpoint", "First Press : Link " + t.link), pc.firstPressFunction = !0)
    }, this.element.setAttribute("href", this.link), this.openNewTab && this.element.setAttribute("target", "_blank"), this.element.style.position = "absolute", this.element.style.overflow = "hidden", document.body.appendChild(this.element), this.updateStyle()
    ...
    if (pc.firstPressFunction || (console.log("First Press : " + this.pressFunction + " - " + this.fireFunction), pc.app.fire("Analytics:Event", "Checkpoint", "First Press : " + this.pressFunction + " - " + this.fireFunction), pc.firstPressFunction = !0), pc.isButtonLocked) return !1;
    ...
    if (this.playSound && this.app.fire("Sound:Play", "Primary-Click"), this.waitResolve && (this.spinner && (this.spinner.enabled = !0, this.text.enabled = !1), this.entity.button && (this.entity.button.active = !1), this.isActivated = !1), this.connected) {
...
Point.attributes.add("playerEntity", {
    ...
    this.activePlayer = !1, this.distance = 100, this.wasInside = !1, this.isFocused = !1, this.app.on("Mode:NextObjective", this.onNextObjective, this), this.app.on("Mode:Objective", this.setObjectivePosition, this), this.app.on("Game:Finish", this.onFinish, this), this.app.on("Objective:Inside", this.onInside, this), this.app.on("Player:Focused", this.onFocusChange, this), this.on("state", this.onStateChange), this.on("destroy", this.onDestroy, this)
}, Point.prototype.onDestroy = function() {}, Point.prototype.onFocusChange = function(t) {
    this.isFocused != t && (!0 === t ? this.entity.setLocalScale(1, .5, 1) : this.entity.setLocalScale(1, 1, 1)), this.isFocused = t
}, Point.prototype.onInside = function(t) {
    t ? (this.objectiveBackground.element.color = pc.colors.capture, this.objectiveBackground.element.opacity = .5) : (this.objectiveBackground.element.color = pc.colors.black, this.objectiveBackground.element.opacity = .15, this.wasInside = !1)
...
SpellManager.attributes.add("playerEntity", {
    ...
    if ("Wind" == e) {
        var i = 1.367,
            a = .878,
            n = 300;
        t && t > 0 && (n = t), this.cameraEntity.camera.fov > 75 && (i = 1.972, a = 1.266), this.windEntity.setLocalScale(i, a, a), this.windEntity.enabled = !0, this.windEntityPlayer.enabled = !0, setTimeout((function(e) {
            e.windEntity.enabled = !1, e.windEntityPlayer.enabled = !1
        }), n, this)
    }
    "DaggerPower" == e && (this.daggerPower.enabled = !0, clearTimeout(this.daggerPowerTimeout), this.daggerPowerTimeout = setTimeout((function(e) {
        e.daggerPower.enabled = !1
    }), 5e3, this))
}, SpellManager.prototype.applySparkySpells = function() {
    this.sparkEntity.enabled = !0, this.activeSpells.push("GrenadeSpell"), this.currentSpell = "SparkySpells", this.entity.sound.play("Negative-Effect-02"), this.entity.sound.play("Ice-Loop"), setTimeout((function(e) {
        e.cancelSparkySpells()
    }), 4500, this)
}, SpellManager.prototype.cancelSparkySpells = function() {
    var e = this;
    e.entity.sound.stop("Ice-Loop"), e.entity.sound.play("Magic-Whoosh-1"), setTimeout((function() {
        e.sparkEntity.enabled = !1
    }), 700), e.activeSpells.splice(e.activeSpells.indexOf("GrenadeSpell"), 1)
}, SpellManager.prototype.applyMidnightCurse = function() {
    this.entity.sound.play("Wolf-Howl"), this.entity.sound.play("Negative-Effect-01"), this.entity.sound.play("Shadow-Loop-2"), this.app.fire("Player:StopSpeaking", !0), this.currentSpell = "MidnightCurse", this.activeSpells.push("GrenadeSpell"), this.app.scene.fogColor = pc.colors.purple, this.app.scene.fogDensity = .01, this.app.tween(this.app.scene).to({
        fogDensity: .3,
        skyboxIntensity: .3
    }, .3, pc.Linear).start(), clearTimeout(this.midnightCurseTimer), this.midnightCurseTimer = setTimeout((function(e) {
    ...
    }, .3, pc.Linear).delay(.2).start(), e.entity.sound.play("Magic-Whoosh-1"), setTimeout((function() {
    ...
    var e = Math.round(2 * Math.random()) + 1,
        ...
        a = 180 * Math.random();
    this.currentSpell = "MuscleShock", this.activeSpells.push("GrenadeSpell"), this.entity.sound.play("Electric-Shock-" + e), this.player.finishEmote(), this.player.movement.disableMovement(), this.app.tween(pc.controls.animation).to({
        cameraBounce: .8
    }, .04, pc.Linear).yoyo(!0).repeat(7).start(), this.app.tween(this.player.movement.animation).to({
        bounceAngle: 3
    }, .03, pc.Linear).yoyo(!0).repeat(7).start(), this.app.fire("Player:StopSpeaking", !0), this.app.fire("Network:Hurt", !0), this.electricityEntity.enabled = !0, this.electricityEntity.setLocalPosition(t, i, 0), this.electricityEntity.setLocalEulerAngles(0, 0, a), setTimeout((function(e) {
        e.player.movement.enableMovement()
    }), 400 * Math.random() + 100, this), setTimeout((function(e) {
        e.electricityEntity.enabled = !1
    }), 150, this), setTimeout((function(e) {
        e.applyMuscleShock()
    }), 600, this), this.spellCount++
    ...
    this.venomEntity.enabled = !0, this.venomEntity.sprite.opacity = .2, this.venomTween = this.app.tween(this.venomEntity.sprite).to({
        opacity: .45
    }, 2, pc.BackIn), this.venomTween.start(), this.entity.sound.play("Venom"), this.entity.sound.play("Negative-Effect-01"), this.entity.sound.play("Heart-Beat"), this.isVenomActive = !1, this.app.fire("Network:Hurt", !0), this.player.movement.slowMovement(1.5), this.activeSpells.push("GrenadeSpell"), setTimeout((function(e) {
        e.cancelVenom()
    }), 2500, this)
}, SpellManager.prototype.cancelVenom = function() {
    this.venomTween && this.venomTween.stop(), this.venomTween = this.app.tween(this.venomEntity.sprite).to({
        opacity: 0
    }, .5, pc.BackIn), this.venomTween.start(), this.app.fire("Player:StopSpeaking", !0), this.player.movement.fastMovement(), this.entity.sound.play("Magic-Whoosh-1"), this.entity.sound.stop("Heart-Beat"), this.isVenomActive = !1, setTimeout((function(e) {
    ...
    var e = this;
    this.iceEntity.enabled = !0, this.iceMaterial = this.iceEntity.model.meshInstances[0].material, this.iceMaterial.opacity = 0, this.isFrostBombActive = !0, this.iceTween = this.app.tween(this.iceMaterial).to({
        opacity: 1
    }, 1, pc.Linear), this.iceTween.on("update", (function(t) {
        e.iceMaterial.update()
    })), this.iceTween.start(), this.entity.sound.play("Ice-Start"), this.app.fire("Player:StopSpeaking", !0), this.player.movement.disableMovement(), this.player.movement.mouseLocked = !0, this.weaponEntity = this.player.weaponManager.currentWeaponEntity, this.weaponMaterial = this.weaponEntity.model.meshInstances[0].material, this.weaponMaterial.emissiveMap = this.iceTexture.resource, this.weaponMaterial.update(), this.armLeftEntity && this.armLeftEntity.model && this.armLeftEntity.model.meshInstances.length > 0 && (this.armsEntityMaterial = this.armLeftEntity.model.meshInstances[0].material, this.armsEntityMaterial.emissiveMap = this.iceTexture.resource, this.armsEntityMaterial.update()), this.app.fire("Network:Hurt", !0), this.app.fire("Weapon:Lock", !0), setTimeout((function(e) {
        e.cancelFrostBomb()
    }), 2e3, this), this.activeSpells.push("GrenadeSpell")
}, SpellManager.prototype.cancelFrostBomb = function() {
    var e = this;
    this.entity.sound.play("Ice-Break"), this.entity.sound.play("Magic-Whoosh-1"), this.isFrostBombActive = !1, this.iceMaterial = this.iceEntity.model.meshInstances[0].material, this.iceTween && this.iceTween.stop(), this.iceTween = this.app.tween(this.iceMaterial).to({
        opacity: 0
    }, .3, pc.Linear), this.iceTween.on("update", (function(t) {
        e.iceMaterial.update()
    })), this.iceTween.start(), this.player.movement.enableMovement(), this.player.movement.mouseLocked = !1, this.app.fire("Weapon:Lock", !1), this.weaponMaterial && (this.weaponMaterial.emissiveMap = !1, this.weaponMaterial.update(), this.armsEntityMaterial && (this.armsEntityMaterial.emissiveMap = !1, this.armsEntityMaterial.update())), setTimeout((function(e) {
        e.iceEntity.enabled = !1
    }), 300, this)
}, SpellManager.prototype.cancelMuscleShock = function() {}, SpellManager.prototype.applyReduce = function() {
    this.isReducedApplied || ("Lilium" == this.characterName ? this.playerAbilities.throwCooldown = 7 : "Shin" == this.characterName && (this.playerAbilities.throwCooldown = 3), this.isReducedApplied = !0, this.app.fire("Overlay:Announce", "Reduce", "Throw cooldown time reduced", !1, "Reduce-Icon"))
}, SpellManager.prototype.onSpellCancel = function() {
    "MidnightCurse" == this.currentSpell && this.cancelMidnightCurse(), "MuscleShock" == this.currentSpell && this.cancelMuscleShock(), "SparkySpells" == this.currentSpell && this.cancelSparkySpells(), "FrostBomb" == this.currentSpell && this.cancelFrostBomb(), "Venom" == this.currentSpell && this.cancelVenom()
}, SpellManager.prototype.onSpellTrigger = function(e, t) {
    if (this.activeSpells.indexOf(e) > -1) return !1;
    "MidnightCurse" == e && (this.applyMidnightCurse(), this.app.fire("Overlay:Announce", "Midnight Curse", "by " + t, !1, "MidnightCurse-Icon")), "FrostBomb" == e && (this.applyFrostBomb(), this.app.fire("Overlay:Announce", "Frost Bomb", "by " + t, !1, "FrostBomb-Icon")), "MuscleShock" == e && (this.applyMuscleShock(), this.app.fire("Overlay:Announce", "Muscle Shock", "by " + t, !1, "MuscleShock-Icon")), "SparkySpells" == e && (this.applySparkySpells(), this.app.fire("Overlay:Announce", "Sparky Sprites", "by " + t, !1, "SparkySpells-Icon")), "Venom" == e && (this.applyVenom(), this.app.fire("Overlay:Announce", "Venom", "by " + t, !1, "Venom-Icon")), "Reduce" == e && this.applyReduce()
...
Tab.attributes.add("menu", {
    ...
    for (var t in this.menuItems = [], this.buttonEntity.enabled = !1, this.menu) {
        ...
        i.enabled = !0, i.findByName("Text").element.text = e, i.script.button.fireArgs = e, i.element.opacity = 0, i.name = e, "Vertical" == this.align ? i.setLocalPosition(0, -parseInt(t) * n, 0) : i.setLocalPosition(parseInt(t) * a, 0, 0), this.menuItems.push(i), this.buttonHolder.addChild(i)
    }
    ...
    for (var n in this.menuItems) {
        ...
        if (this.onlyTabs) i.name == t ? i.element.opacity = 1 : i.element.opacity = 0;
            ...
            var s = this.page[n];
            i.name == t ? (i && (i.element.opacity = 1), s.enabled = !0) : (i && (i.element.opacity = 0), s.enabled = !1)
        }
    }
...
Fetcher.attributes.add("auto", {
    ...
    this.lastCall = -1, this.auto && (this.onFetch(), this.on("state", (function(t) {
        !0 === t && this.onFetch()
    }))), this.onCallback = !1, this.cacheData = !1, this.waitForAction = !1, this.cache ? this.app.on("Fetcher:" + this.entity.name, this.onCache, this) : this.app.on("Fetcher:" + this.entity.name, this.onFetch, this), this.app.on("Trigger:Login", this.setWaitingAction, this)
    ...
    if ((this.onLoading(), this.onCallback = !(!e || "function" != typeof e) && e, this.confirmation && this.data.requireConfirmation) && !confirm("Are you sure to execute this action?")) return !1;
    ...
    n.open("POST", t), n.onreadystatechange = function() {
        n.readyState > 3 && 200 == n.status && (a.cache = JSON.parse(n.responseText), i(JSON.parse(n.responseText)))
    }, n.withCredentials = !0, n.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"), n.send(r)
};
...
Form.attributes.add("inputs", {
    ...
    for (var i in this.keys) {
        ...
        s.input ? this.inputs[i].script.input.setValue(t[e]) : s.checkbox ? this.inputs[i].script.checkbox.setValue(t[e]) : s.select ? this.inputs[i].script.select.setValue(t[e]) : s.hidden && this.inputs[i].script.hidden.setValue(t[e])
    }
    ...
    for (var i in this.keys) {
        var e = this.keys[i],
            s = this.inputs[i].script;
        s.input ? t[e] = this.inputs[i].script.input.getValue() : s.checkbox ? t[e] = this.inputs[i].script.checkbox.getValue() : s.select ? t[e] = this.inputs[i].script.select.getValue() : s.hidden && (t[e] = this.inputs[i].script.hidden.getValue())
    }
...
Table.attributes.add("labels", {
    ...
    this.isDestroyed = !1, this.buttonsDisabled = !1, this.rows = [], this._onInit(), this.on("state", (function(t) {
        this.entity.enabled ? this._onInit() : this.container.remove()
    }), this), this.on("destroy", this.onDestroy, this), this.app.on("DOM:Clear", this.onDOMClear, this), this.app.on("DOM:Update", this.onDomUpdate, this), this.app.on("Table:" + this.entity.name, this.onSet, this)
    ...
    if (this.app.assets.find(a)) {
        var i = document.createElement("img");
        i.src = this.app.assets.find(a).getFileUrl(), i.width = 80, i.height = 15, i.ratingId = t.name, i.className = "table-rating", i.onclick = function() {
            pc.app.fire("View:Menu", "Rating"), pc.app.fire("Template:Rating", {
                map: this.ratingId
            })
        }, e.appendChild(i)
    ...
    if (t[e] && t[e].match(/\$button\[(.*?)\]/) || e && e.match(/\$button\[(.*?)\]/)) {
        ...
        if ((c = document.createElement("button")).innerText = h[0], c.trigger = o[0], c._key = o[1], c._value = t[o[1]], c._row = t, c.onclick = function() {
                var t = {};
        ...
        for (var s in this.buttons) {
            var h, c;
            o = (h = this.buttons[s].split("="))[1].split("@");
            (c = document.createElement("button")).innerText = h[0], c.trigger = o[0], c._key = o[1], c._value = t[o[1]], c.onclick = function() {
                var t = {};
    ...
    if (t && t.replace) {
        var a = t.replace(/\[color="(.*?)"\]/g, '<span style="color:$1">').replace(/\[\/color]/g, "</span>").replace(/\\/g, ""),
            i = "",
            r = "";
        return "username" == e && (username = t.replace(/\[color="(.*?)"\]/g, "").replace(/\[\/color]/g, "").replace(/\\/g, "").replace(/\[(.*?)\]/g, "").trim(), i = '<a target="_blank" href="https://social.venge.io/#' + username + '">', r = "</a>"), i + a + r
    }
    return t
    ...
    for (var i in t) {
        ...
        for (var s in this.keys) {
            ...
            } else "$thumbnail" == o ? this.createThumbnail(r, l) : "$rating" == o ? this.createRating(r, l) : "$button" == o || "$button" == r[o] || r[o] && r[o].length > 0 && r[o].search("\\$button") > -1 || o && o.length > 0 && o.search("\\$button") > -1 ? this.createButtons(r, o, l) : "$index" == o ? l.innerText = parseInt(i) + 1 : l.innerHTML = this.formatMarkup(r[o], o);
            n.appendChild(l)
        }
        a.append(n), this.table.appendChild(a), this.rows.push(n), this.app.fire("DOM:Update", this)
    }
    this.header && (document.querySelector(".table-sortable th") && document.querySelector(".table-sortable th").classList.add("sortable"), document.querySelectorAll(".table-sortable th").forEach((t => {
    ...
    const i = t.tBodies[0],
        ...
        s = r.sort(((t, a) => {
            var i, r;
            return 0 === e ? (i = parseInt(t.querySelector(`td:nth-child(${e+1})`).textContent.trim()), r = parseInt(a.querySelector(`td:nth-child(${e+1})`).textContent.trim())) : (i = t.querySelector(`td:nth-child(${e+1})`).textContent.trim(), r = a.querySelector(`td:nth-child(${e+1})`).textContent.trim()), i > r ? 1 * n : -1 * n
        }));
    for (; i.firstChild;) i.removeChild(i.firstChild);
    i.append(...s), t.querySelectorAll("th").forEach((t => t.classList.remove("th-sort-asc", "th-sort-desc"))), t.querySelector(`th:nth-child(${e+1})`).classList.toggle("th-sort-asc", a), t.querySelector(`th:nth-child(${e+1})`).classList.toggle("th-sort-desc", !a)
};
...
Visibility.attributes.add("visible", {
    ...
    this.app.on("Show:" + this.entity.name, this.onShow, this), this.app.on("Hide:" + this.entity.name, this.onHide, this), this.visible || (this.timer = setTimeout((function(t) {
        t.entity.enabled = !1
    }), 50, this)), this.entity.on("state", this.onStateChange, this)
}, Visibility.prototype.onShow = function() {
    this.entity.enabled = !0
}, Visibility.prototype.onHide = function() {
    this.entity.enabled = !1
}, Visibility.prototype.onStateChange = function(t) {}, Visibility.prototype.trigger = function(t) {
    try {
        this._trigger(t)
    } catch (t) {
        this.entity.enabled = !1
    ...
    if (this.query && data) {
        ...
        query ? (this.entity.enabled = !0, this.hideLater && (clearTimeout(this.timer), this.timer = setTimeout((function(t) {
            t.entity.enabled = !1
...
Template.attributes.add("autoRefresh", {
    ...
    for (var r in t) {
        var i = t[r];
        if (i && i.script && i.script.visibility && i.script.visibility.trigger(e), i && i.script && i.script.bar && i.script.bar.setValue(e), i && i.script && i.script.input && i.script.input.setValue(e), i && i.script && i.script.select && i.script.select.setValue(e), i && i.script && i.script.checkbox && i.script.checkbox.setValue(e), i && i.script && i.script.hidden && i.script.hidden.setValue(e), i && i.script && i.script.button && i.script.button.linkButton) {
    ...
    this.autoRefresh && (clearTimeout(this.timer), this.timer = setTimeout((function(t) {
        t.onUpdate(e)
    }), 1e3, this))
};
...
}), Bar.prototype.initialize = function() {}, Bar.prototype.setValue = function(t) {
    var i = t[this.key];
    this.isParticle, this.particleType;
    t[this.start] && this.entity.setLocalScale(t[this.start], 1, 1), i > 0 ? this.isAnimated ? this.entity.tween(this.entity.getLocalScale()).to({
        x: i
    }, this.animationDuration, pc.SineOut).start().on("complete", (function() {})) : this.entity.setLocalScale(i, 1, 1) : this.entity.setLocalScale(.001, 1, 1)
};
...
Popup.attributes.add("title", {
    ...
    this.popupStyle = !1, this.on("state", (function(t) {
        this.entity.enabled || (this.wrapper && this.wrapper.remove(), this.popupStyle && this.popupStyle.remove(), pc.isButtonLocked = !1)
    }), this), this.on("destroy", this._onDestroy, this), this.app.on("Popup:" + this.entity.name, this.onSet, this), this.app.on("PopupSet:" + this.entity.name, this.setItems, this), this.app.on("Popup:Close", this.onClose, this)
    ...
    if (clearTimeout(this.selectionTimeout), e) {
        ...
        e.className = "item active", this.selectionTimeout = setTimeout((function(e) {
            e._onSet(t)
        }), 200, this)
    } else this._onSet(t)
    ...
    for (var e in this.itemNames) {
        ...
        if (this.itemImages[e]) {
            ...
            i && (r = '<div id="popup_item_' + s + '" class="item" ', r += "onclick=\"pc.app.fire('Popup:" + this.entity.name + "', '" + s + "')\">", n && (r += '<div class="locked"></div>'), r += '<img src="' + p + '">', r += '<span class="label">' + s + "</span>", r += "</div>")
        } else {
            var a = i.match(/(.*?)\((.*?)\)/),
                l = i,
                h = "";
            a && a.length > 0 && (l = a[1].trim(), h = a[2]), r = '<div class="list-item" ', r += "onclick=\"pc.app.fire('Popup:" + this.entity.name + "', '" + l + "')\">", r += '<span class="label">' + l + "<small>" + h + "</small></span>", r += "</div>"
        }
        t.push(r)
    }
    return t.join("")
    ...
    if (t && t.remove(), pc.isButtonLocked = !0, this.wrapper = document.createElement("div"), this.wrapper.id = "shadow", this.container = document.createElement("div"), this.container.id = "popup", this.container.style.width = this.entity.element.width + "px", this.container.style.height = this.entity.element.height + "px", this.wrapper.appendChild(this.container), document.body.appendChild(this.wrapper), !document.getElementById("popup-style")) {
...
Alert.attributes.add("alertEntity", {
    ...
    this.app.fire("DOM:Hide", !0), setTimeout((function(e) {
        e._onAlert(t)
    }), 100, this)
...
SpellWind.attributes.add("material", {
    ...
    this.timestamp = 10, this.animation = {
        scale: 0
    }, this.app.on("Spell:Wind", this.onSet, this)
}, SpellWind.prototype.onSet = function(t, e) {
    var i = 10;
    "Small" == e && (e, i = 3), this.animation.scale = .1, this.timestamp = 0, this.material.resource.opacity = 1, this.entity.setLocalPosition(t), this.app.tween(this.material.resource).to({
        opacity: 0
    }, .5, pc.Linear).delay(this.opacityDelay).start(), this.app.tween(this.animation).to({
        scale: i
    }, .5, pc.BackOut).start(), this.entity.enabled = !0, this.entity.sound.play("Cast")
}, SpellWind.prototype.update = function(t) {
    this.entity.rotateLocal(0, -1500 * t, 0), this.timestamp += t, this.entity.setLocalScale(this.animation.scale, this.animation.scale, this.animation.scale), this.material.resource.update(), this.timestamp > this.time && (this.entity.enabled = !1)
};
...
RoomManager.attributes.add("isDebug", {
    ...
    if ("undefined" != typeof VERSION && (this.isDebug = !1), this.customRoomId = !1, this.currentUsernames = [], this.currentMap = "Sierra - POINT", this.currentMaps = ["Sierra - POINT", "Mistle - PAYLOAD", "Tundra - GUNGAME", "Temple - BLACKCOIN"], this.currentServer = "EU", this.lastTickTime = Date.now(), this.lastSelfTime = Date.now(), this.setRoomSettings(), this.friends = [], this.isSpectator = !1, this.isStarted = !1, this.waitingForInfo = !1, this.time = 0, this.totalTime = 0, this.ws = !1, this.username = "none", this.pack = MessagePack.initialize(4194304), this.maxPlayers = 4, this.isMatchmaking = !1, this.isMatchmakingStarted = !1, this.app.on("RoomManager:ConnectInvite", this.onInviteSet, this), this.app.on("RoomManager:Preroll", this.onPreroll, this), this.app.on("RoomManager:Copy", this.onCopy, this), this.app.on("RoomManager:Match", this.onMatchSet, this), this.app.on("RoomManager:Matchmaking", this.matchmaking, this), this.app.on("RoomManager:Hash", this.onHashSet, this), this.app.on("RoomManager:InviteSet", this.onInviteSet, this), this.app.on("RoomManager:Leave", this.onLeave, this), this.app.on("RoomManager:Private", this.onPrivateChange, this), this.app.on("RoomManager:Start", this.onStart, this), this.app.on("RoomManager:Map", this.onMapSelection, this), this.app.on("RoomManager:Maps", this.onMapsSelection, this), this.app.on("RoomManager:SetServer", this.onServerSelection, this), this.app.on("RoomManager:Rematchmaking", this.rematchmaking, this), this.app.on("RoomManager:PlayMode", this.onPlayMode, this), this.app.on("RoomManager:InviteMode", this.onInviteMode, this), this.app.on("RoomManager:CustomMapInvite", this.onCustomMapInvite, this), this.app.on("RoomManager:SetMapTemplate", this.setMapTemplate, this), this.app.on("RoomManager:PlayCustomGame", this.playCustomGame, this), this.app.on("Game:Found", this.onGameFound, this), this.app.on("Template:Profile", this.setProfile, this), this.app.on("Server:Tick", this.onServerTick, this), this.app.on("RoomManager:CreateInvite", this.onCreateInvite, this), this.app.on(atob("TmV0d29yazpHdWFyZA=="), this.onSelfTime, this), window.location.href.search("map") > -1) {
        var t = window.location.href.split("=")[1];
        setTimeout((function(e) {
            e.setCustomMap(t)
        }), 100, this)
    }
    if (window.location.pathname.length > 1 && "//" != window.location.pathname && "venge.io" == window.location.host) {
    ...
    setTimeout((function(t) {
        t.app.fire("DOM:Update", !0)
    }), 300, this), this.app.fire("RoomManager:Ready", !0)
    ...
    this.currentMaps = [pc.displayMap + " - POINT"], this.currentMap = pc.displayMap + " - POINT", this.currentMode = "POINT", this.app.fire("Page:Menu", "Match"), this.app.fire("Show:Character", "Show"), this.setRoomSettings(), this.startMatchmaking()
}, RoomManager.prototype.setCustomMap = function(t) {
    this.currentMap = t + " - POINT", this.currentMaps = [this.currentMap], this.app.fire("View:Match", "Invite"), this.app.fire("RoomManager:CreateInvite", !0), this.app.fire("DOM:DelayUpdate", !0), console.log("[DEBUG] Create map for custom map", t)
    ...
    this.currentMaps = [pc.displayMap + " - POINT"], this.currentMap = pc.displayMap + " - POINT", this.currentMode = "POINT", this.app.fire("Page:Menu", "Match"), this.app.fire("Show:Character", "Show"), this.app.fire("View:Match", "Invite"), this.app.fire("RoomManager:CreateInvite", !0)
}, RoomManager.prototype.onCustomMapInvite = function(t) {
    this.currentMaps = [t.name + " - POINT"], this.currentMap = t.name + " - POINT", this.currentMode = "POINT", this.app.fire("Page:Menu", "Match"), this.app.fire("Show:Character", "Show"), this.app.fire("View:Match", "Invite"), this.app.fire("RoomManager:CreateInvite", !0)
    ...
    this.app.fire("Analytics:Event", "Invite", "Create"), this.app.fire("Fetcher:Invite", {
        map: this.currentMap,
        version: this.serverCode,
        max_player: this.maxPlayers,
        country: this.currentServer
    }, t), this.app.fire("CustomText:CurrentMap", this.currentMap)
}, RoomManager.prototype.onPreroll = function() {
    var t = this;
    this.app.fire("Analytics:Event", "Checkpoint", "RoomManager:Preroll"), this.app.fire("Menu:Mute", !0);
    try {
    ...
    try {
        SDKLoaded && PokiSDK && PokiSDK.SDK.sdkBooted ? this.app.fire("Ads:Preroll", (function() {
            t.startMatchmaking()
    ...
    this.isMatchmakingStarted = !0, this.app.fire("Analytics:Event", "Checkpoint", "RoomManager:StartMatchmaking"), this.app.fire("RoomManager:Matchmaking", !0), this.app.fire("Fetcher:Match", {
        country: this.currentServer,
        version: this.serverCode,
        maps: this.currentMaps,
        max_player: this.maxPlayers,
        is_mobile: pc.isMobile ? 1 : 0
    }), pc.currentServer = this.currentServer, pc.serverCode = this.serverCode, pc.currentMap = this.currentMap, pc.currentMaps = this.currentMaps, pc.maxPlayers = this.maxPlayers, this.app.fire("Analytics:Event", "Matchmaking", "Start")
}, RoomManager.prototype.onCopy = function() {
    this.app.fire("Notify:Notify", "Link copied!"), this.app.fire("Analytics:Event", "Invite", "LinkCopy")
    ...
    this.ws && (this.ws.close(), this.ws = !1), window.location.hash = "", this.isMatchmaking = !1, this.waitingForInfo = !1, this.isMatchmakingStarted = !1, this.app.fire("View:Match", "QuickMatch"), t ? this.app.fire("Analytics:Event", "Room", "Rematchmaking") : (this.app.fire("Alert:Menu", {
    ...
    this.ws && (this.ws.close(), this.ws = !1), this.keys = this.getKeys(), this.roomId = this.getRoomId(), this.app.fire("Analytics:Event", "Checkpoint", "Connect"), this.roomId && (this.ws = new WebSocket(t + "/?" + this.roomId), this.ws.binaryType = "arraybuffer", this.ws.onopen = this.onOpen.bind(this), this.ws.onclose = this.onClose.bind(this), this.ws.onmessage = this.onMessage.bind(this))
}, RoomManager.prototype.rematchmaking = function() {
    this.time = 0, console.log("Rematchmaking..."), this.app.fire("RoomManager:Leave", !0), this.app.fire("Analytics:Event", "Room", "Rematchmaking"), setTimeout((function(t) {
        t.startMatchmaking()
    }), 100, this)
    ...
    if (t.length > 0) {
        ...
        i || (this.app.fire("View:Match", "Room"), this.app.fire("Analytics:Event", "Invite", "Join"), o && this.start()), "undefined" != typeof app && app.setInviteStatus(i), e.length > 0 && ("undefined" != typeof app && (app.invite.players = e), this.currentUsernames = e), pc.isOwner = i, this.private([a])
    }
    ...
    this.friends = []
}, RoomManager.prototype.setFriendList = function(t) {}, RoomManager.prototype.onStart = function() {
    ...
    if (this.isStarted) return !1;
    window.onhashchange = !1, clearInterval(this.timer), this.isStarted = !0, this.isMatchmakingStarted = !1, this.app.fire("Analytics:Event", "Checkpoint", "RoomManager:GameFound")
...
Container.attributes.add("id", {
    ...
    this.isDestroyed = !1, this.lastUpdate = Date.now(), this.triggerOnInit(), this.on("state", (function(t) {
    ...
    }), this), this.entity.on("DOM:Style", this.setStyle, this), this.app.on("DOM:Clear", this.onDOMClear, this), this.app.on("DOM:Update", this.onDomUpdate, this), this.on("destroy", this._onDestroy, this)
...
Slider.attributes.add("defaultValue", {
    ...
    this._onInit(), this.on("state", (function(t) {
        this.entity.enabled ? this._onInit() : this.element.remove()
    }), this), this.app.on("DOM:Clear", this.onDOMClear, this), this.app.on("DOM:Update", this.onDomUpdate, this), this.on("destroy", this.onDestroy, this)
}, Slider.prototype.onDOMClear = function() {
    this.entity.enabled = !1
}, Slider.prototype.onDomUpdate = function() {
    this.updateStyle()
}, Slider.prototype._onInit = function() {
    this.element = document.createElement("input"), this.element.type = "range", this.element.style.position = "absolute", this.element.style.fontFamily = this.fontFamily, this.element.style.border = "0px", this.element.style.margin = "0px", this.element.style.padding = "0px", this.element.style.background = "transparent", this.element.style.boxSizing = "border-box", this.element.value = this.defaultValue, this.element.min = this.min, this.element.max = this.max, this.element.onchange = this.onChange.bind(this), this.element.style.outline = "none", this.containerEntity ? (this.element.style.position = "fixed", this.containerEntity.script.container.insideElement.appendChild(this.element)) : document.body.appendChild(this.element), this.updateStyle(), this.storeWithName ? this.elementId = this.entity.name : this.elementId = this.entity._guid, Utils.getItem(this.elementId) && this.setValue(Utils.getItem(this.elementId))
    ...
    if (this.entity && this.entity.enabled && this.entity.element && this.entity.element.screenCorners) {
        ...
        if (this.containerEntity) {
            var a = this.containerEntity.scaleX,
                ...
                o = .9 == t.app.graphicsDevice.maxPixelRatio ? e[0].y : e[0].y / t.app.graphicsDevice.maxPixelRatio * .9,
                h = .9 == t.app.graphicsDevice.maxPixelRatio ? this.containerEntity.offsetTop : this.containerEntity.offsetTop / t.app.graphicsDevice.maxPixelRatio * .9;
            n = 1 / .9, s = (e[0].x - this.containerEntity.offsetLeft) / a, l = (o - h) / r - t.entity.element.height + this.containerEntity.element.height - (t.entity.element.height / 2 - 5), this.containerEntity && this.containerEntity.script.container.autoResize && (this.element.style.transform = "scale(" + 1 / a + ", " + 1 / r + ")", this.element.style.transformOrigin = "left bottom")
        } else s = e[0].x, l = e[0].y;
        this.element.style.left = s * i + this.padding / 2 + "px", this.element.style.bottom = l * (0 != n ? n : i) + "px", this.element.style.width = (e[2].x - e[0].x) * i - this.padding + "px", this.element.style.height = (e[2].y - e[0].y) * i + "px"
    }
...
}, Analytics.prototype.onDestroy = function() {}, Analytics.prototype.setEvent = function(t, e) {
...
Checkbox.attributes.add("default", {
    ...
    this.timeout = !1, this._onInit(), this.app.on("DOM:Clear", this.onDOMClear, this), this.app.on("DOM:Update", this.onDomUpdate, this), this.on("state", (function(e) {
        this.entity.enabled ? this._onInit() : this.element.remove()
    }), this)
    ...
    (this.storeWithName ? this.elementId = this.entity.name : this.elementId = this.entity._guid, this.element = document.createElement("input"), this.element.type = "checkbox", this.element.style.position = "absolute", this.element.style.border = "0px", this.element.style.background = "transparent", this.element.style.outline = "none", this.element.style.margin = "0 auto", this.element.style.padding = "auto", this.element.checked = this.default, this.containerEntity ? (this.element.style.position = "fixed", this.containerEntity.script.container.insideElement.appendChild(this.element)) : document.body.appendChild(this.element), this.element.onchange = this.onChange.bind(this), null !== this.sleepValue && this.setValue(this.sleepValue), this.storeValue) && (Utils.getItem(this.elementId) && this.setValue(Utils.getItem(this.elementId)));
    this.updateStyle()
    ...
    if (e.entity && e.entity.element && e.entity.element.screenCorners) {
        ...
        if (this.containerEntity) {
            var l = this.containerEntity.scaleX,
                r = this.containerEntity.scaleY,
                c = .9 == e.app.graphicsDevice.maxPixelRatio ? t[0].y : t[0].y / e.app.graphicsDevice.maxPixelRatio * .9,
                p = .9 == e.app.graphicsDevice.maxPixelRatio ? this.containerEntity.offsetTop : this.containerEntity.offsetTop / e.app.graphicsDevice.maxPixelRatio * .9;
            n = 1 / .9, s = (t[0].x - this.containerEntity.offsetLeft) / l, o = (c - p) / r - e.entity.element.height + this.containerEntity.element.height - (e.entity.element.height / 2 - 5), this.containerEntity && this.containerEntity.script.container.autoResize && (this.element.style.transform = "scale(" + 1 / l + ", " + 1 / r + ")", this.element.style.transformOrigin = "left bottom")
        } else s = t[0].x, o = t[0].y;
        e.element.style.left = s * i + "px", this.element.style.bottom = o * (0 != n ? n : i) + "px", e.element.style.width = h + "px", e.element.style.height = a + "px"
    }
}, Checkbox.prototype.setValue = function(e) {
    if (this.element && this.key && e) return this.element.checked = "true" == e[this.key], !1;
    this.element ? (this.element.checked = "true" == e, this.sleepValue = !1) : this.sleepValue = e
...
MobileController.attributes.add("joystickEntity", {
    ...
    this.direction.dx = (t.x - this.direction.x) * this.speed, this.direction.dy = (t.y - this.direction.y) * this.speed, this.direction.x = t.x, this.direction.y = t.y, this.app.fire("Touch:Direction", this.direction.dx, this.direction.dy)
...
AdsManager.attributes.add("defaultProvider", {
    ...
    "undefined" != typeof adblocked && !0 === adblocked && (isAdsBlocked = !0), "undefined" == typeof SDKLoaded && (SDKLoaded = !1), this.lastPokiBannerContainer = !1, this.lastBannerSetTime = 0, this.lastBannerName = "None", this.app.on("Ads:BannerSet", this.onBannerSet, this), this.app.on("Ads:BannerDestroy", this.onBannerDestroy, this), this.app.on("Ads:Preroll", this.onPreroll, this), this.app.on("Ads:RewardAds", this.onRewardAds, this), this.app.on("Ads:Adblock", this.onAdblockCheck, this), this.startDate = Date.now()
    ...
    if (!SDKLoaded) return setTimeout((function(n) {
        n.onBannerSet(e, t)
    }), 500, this), !1;
    if ("undefined" != typeof PokiSDK && (Date.now() - this.lastBannerSetTime >= 3e4 || this.lastBannerName != e || n)) {
        this.lastPokiBannerContainer && (PokiSDK.destroyAd(this.lastPokiBannerContainer), this.lastPokiBannerContainer = !1);
        var o = document.getElementById(e);
        o ? (PokiSDK.displayAd(o, t), this.lastPokiBannerContainer = o, this.lastBannerSetTime = Date.now(), this.lastBannerName = e) : setTimeout((function(n) {
            n.onBannerSet(e, t)
        }), 500, this)
    }
}, AdsManager.prototype.onRewardAds = function(e, t) {
    var n = this;
    return this.onPrerollCompleted = e, this.app.fire("Network:State", "ads", !0), this.app.fire("Analytics:Event", "Reward", "Triggered"), isAdsBlocked ? (t ? t() : this._onPrerollCompleted(), !1) : (adblockEnabled && (this._onPrerollCompleted(), t && t()), SDKLoaded ? (pc.isDisplayingAds = !0, setTimeout((function() {
        pc.isDisplayingAds = !1
    }), 5e3), this.app.fire("Analytics:Event", "Reward", "PokiTriggered"), void("undefined" != typeof PokiSDK ? PokiSDK.rewardedBreak().then((function() {
        pc.isDisplayingAds = !1, n._onPrerollCompleted()
    })).catch((function() {
        pc.isDisplayingAds = !1, n._onPrerollCompleted()
    })) : (pc.isDisplayingAds = !1, this._onPrerollCompleted()))) : (t ? t() : this._onPrerollCompleted(), !1))
}, AdsManager.prototype.onPreroll = function(e, t) {
    var n = this;
    return this.onPrerollCompleted = e, this.app.fire("Network:State", "ads", !0), this.app.fire("Analytics:Event", "Preroll", "Triggered"), isAdsBlocked ? (this._onPrerollCompleted(), t && t(), !1) : (adblockEnabled && (this._onPrerollCompleted(), t && t()), SDKLoaded ? (pc.isDisplayingAds = !0, setTimeout((function() {
        pc.isDisplayingAds = !1
    }), 5e3), void("undefined" != typeof PokiSDK ? (this.app.fire("Analytics:Event", "Preroll", "PokiTriggered"), Utils.isMobile() ? PokiSDK.rewardedBreak().then((function() {
        pc.isDisplayingAds = !1, n._onPrerollCompleted()
    })).catch((function() {
        pc.isDisplayingAds = !1, n._onPrerollCompleted()
        ...
        pc.isDisplayingAds = !1, n._onPrerollCompleted()
    }))) : (pc.isDisplayingAds = !1, this._onPrerollCompleted()))) : (this._onPrerollCompleted(), t && t(), !1))
...
VengeGuard.prototype.initialize = function() {
    ...
    var o = !0;
    void 0 !== window.gg && (o = !1), void 0 !== window.retard && (o = !1), pc.controls && pc.controls.player && (pc.controls.player.throwCooldown <= 0 && (o = !1), pc.controls.currentWeapon.spread <= 0 && (o = !1), pc.controls.currentWeapon.recoil <= 0 && (o = !1)), this.app.fire("Network:Guard", o)
}, NetworkManager.prototype.selfTick = function() {}, NetworkManager.prototype.token = function(o) {
    if (!0 === o[0]) {
        _$token = function makeid(o) {
            ...
            return e
        }(20), this.send([this.keys.token, _$token])
    }
};
...
Spectator.attributes.add("defaultSensitivity", {
    ...
    pc.settings || (pc.settings = {}), pc.settings.sensivity || (pc.settings.sensivity = 1), this.targets = [], this.targetIndex = 0, this.sensivity = .1;
    var t = this.defaultSpeed;
    this.speed = t, this.isZooming = !1, this.zoomOutTween = !1, this.isMouseLocked = !1, this.currentCameraFov = 50, this.currentState = !0, this.lookX = 0, this.lookY = 0, this.targetVector = new pc.Vec3(0, 0, 0), this.app.mouse.on("mouseup", this.onMouseUp, this), this.app.mouse.on("mousemove", this.onMouseMove, this), this.app.mouse.on("mousedown", this.onMouseDown, this), this.app.mouse.on("mousewheel", this.onMouseWheel, this), this.app.on("Mouse:LockChange", this.setMouseState, this), window.oncontextmenu = function() {
        return !1
    }, this.app.on("Map:Loaded", this.onMapLoaded, this), this.app.on("Game:PlayerJoin", this.onPlayerJoin, this), this.app.on("Camera:State", this.onCameraState, this)
    ...
    this.rightClick && 2 == t.button ? this.app.fire("Mouse:Lock") : this.rightClick || this.app.fire("Mouse:Lock")
    ...
    this.getTargets(), this.currentTarget = this.targets[this.targetIndex], this.isZooming = !0, this.setCameraPoint(), this.zoomOutTween && this.zoomOutTween.stop(), this.zoomOutTween = this.app.tween(this.entity.camera).to({
        fov: 70
    }, .2, pc.Linear), this.zoomOutTween.start(), setTimeout((function(t) {
        t.isZooming = !1
    }), 1e3, this), this.mode = "Follow"
    ...
    this.app.keyboard.wasPressed(pc.KEY_1) && (this.targetIndex = 0, this.focusTarget()), this.app.keyboard.wasPressed(pc.KEY_2) && (this.targetIndex = 1, this.focusTarget()), this.app.keyboard.wasPressed(pc.KEY_3) && (this.targetIndex = 2, this.focusTarget()), this.app.keyboard.wasPressed(pc.KEY_4) && (this.targetIndex = 3, this.focusTarget()), this.app.keyboard.wasPressed(pc.KEY_5) && (this.targetIndex = 4, this.focusTarget()), "Free" == this.mode && (this.app.keyboard.isPressed(pc.KEY_SHIFT) ? this.speed = 1.5 * this.defaultSpeed : this.speed = 1.001 * this.defaultSpeed, this.app.keyboard.isPressed(pc.KEY_W) && this.entity.translateLocal(0, 0, -this.speed), this.app.keyboard.isPressed(pc.KEY_S) && this.entity.translateLocal(0, 0, this.speed), this.app.keyboard.isPressed(pc.KEY_A) && this.entity.translateLocal(-this.speed, 0, 0), this.app.keyboard.isPressed(pc.KEY_D) && this.entity.translateLocal(this.speed, 0, 0), this.app.keyboard.isPressed(pc.KEY_E) && this.entity.translate(0, this.speed, 0), this.app.keyboard.isPressed(pc.KEY_Q) && this.entity.translate(0, -this.speed, 0))
}, Spectator.prototype.update = function(t) {
    if (this.currentTarget && "Follow" == this.mode) {
        if (this.targetVector = this.targetVector.lerp(this.targetVector, this.currentTarget.getPosition(), .05), !this.isZooming) {
            var e = this.entity.getPosition().clone().sub(this.targetVector).length(),
                s = 70;
            e > 8 && (s = 60), e > 15 && (s = 50), this.entity.camera.fov = pc.math.lerp(this.entity.camera.fov, s, .35), this.currentCameraFov = s
        }
        this.entity.lookAt(this.targetVector), this.setCameraPoint()
    }
    "Free" == this.mode && (this.entity.setEulerAngles(this.lookX, this.lookY, 0), this.entity.camera.fov = pc.math.lerp(this.entity.camera.fov, this.currentCameraFov, .1)), this.setKeyboard()
};
...
SpectatorScreen.attributes.add("cameraEntity", {
    ...
    for (var a in t) {
        ...
        c.enabled = !0, c.setLocalPosition(-3 * parseInt(a), i, 0), c.setLocalScale(n, n, n), c.findByName("Bar").setLocalScale(o.bar, 1, 1), c.findByName("Tier").element.textureAsset = r, c.findByName("Rank").element.text = s + 1 + ".", c.findByName("Username").element.text = o.username, c.findByName("KillDeath").element.text = o.kill + " / " + o.death, c.findByName("Score").element.text = o.score, o.isMe && (c.findByName("Username").element.color = pc.colors.me, c.findByName("Leader").element.color = pc.colors.me, s), c.element.width = c.findByName("Username").element.width + 70, c.findByName("Leader").enabled = 0 === s, this.leaderboardEntity.addChild(c), this.leaderboardItems.push(c), i += -45 * (n -= .15) - 10
    }
    ...
    this.announceIconEntity.element.textureAsset = a, this.announceIconEntity.element.opacity = 0, this.announceIconEntity.tween(this.announceIconEntity.element).to({
        opacity: 1
    }, .15, pc.SineOut).start(), this.announceTextEntity.element.text = t.toUpperCase(), this.announceTextEntity.element.opacity = 0, this.announceTextEntity.tween(this.announceTextEntity.element).to({
        opacity: 1
    }, .15, pc.SineOut).delay(.15).start(), this.announceStripeEntity.setLocalScale(2.5, 1, 1), this.announceStripeEntity.tween(this.announceStripeEntity.getLocalScale()).to({
        ...
        opacity: 1
    }, .3, pc.SineOut).delay(.5).start(), this.announceInfoEntity.setLocalPosition(0, -7, 0), this.announceInfoEntity.tween(this.announceInfoEntity.getLocalPosition()).to({
        x: 0,
        y: -22,
        z: 0
    }, .3, pc.SineOut).delay(.5).start(), clearTimeout(this.announceTimer), this.announceTimer = setTimeout((function(t) {
        t.announceEntity.enabled = !1
    }), 4500, this), this.lastAnnounceDate = Date.now()
    ...
    this.app.keyboard.wasPressed(pc.KEY_TAB) && (this.shortcutsEntity.enabled = !this.shortcutsEntity.enabled), this.app.keyboard.wasPressed(pc.KEY_ESCAPE) && (this.pauseEntity.enabled = !this.pauseEntity.enabled, this.app.fire("Camera:State", this.pauseEntity.enabled))
...
Preview.attributes.add("baseEntity", {
    ...
    this.isDragging = !1, this.isStatic = !1, this.lookAngle = 0, this.state = !0, this.isAnimatedSkin = !1, this.isDanceLoaded = !1, this.lastDanceLoopTime = Date.now() - 6e3, this.animation = {
        lidAxis: 0
    }, this.backgroundEntity.element.on("mousedown", this.onMouseDown, this), this.backgroundEntity.element.on("mousemove", this.onMouseMove, this), this.backgroundEntity.element.on("mouseup", this.onMouseUp, this), this.pitches = {
        Common: 1,
        Uncommon: 1.05,
        Rare: 1.1,
        Legendary: 1.15,
        Mythical: 1.2,
        Xmas: 1.05
    }, this.app.on("Preview:Clear", this.onClear, this), this.app.on("Preview:Set", this.onSet, this), this.app.on("Preview:Buy", this.onBuy, this), this.app.on("Preview:Open", this.onOpen, this), this.app.on("Preview:Equip", this.onEquip, this), this.app.on("Game:Found", this.onGameFound, this), this.on("state", this.onStateChange, this)
    ...
    this.entity.sound.play("Equip"), this.lookAngle = 0, this.baseEntity.setLocalScale(1.1, 1.1, 1.1), this.baseEntity.tween(this.baseEntity.getLocalScale()).to({
        x: 1,
        y: 1,
        z: 1
    }, .15, pc.BackOut).start()
}, Preview.prototype.onOpen = function(t) {
    this.itemPreview.enabled = !1, this.entity.sound.play("Device-Start"), this.animation.lidAxis = 0, this.crateEntity.setLocalEulerAngles(0, 0, 0), this.baseEntity.setLocalEulerAngles(0, -1, 0), this.baseEntity.tween(this.baseEntity.getLocalEulerAngles()).to({
        x: 0,
        y: 1,
        z: 0
    }, .05, pc.Linear).yoyo(!0).repeat(8).start(), this.crateOpenEffect.enabled = !0, setTimeout((function(e) {
    ...
    }), 700, this), this.baseEntity.setLocalScale(1, 1, 1), this.baseEntity.tween(this.baseEntity.getLocalScale()).to({
        x: 1.2,
        y: 1.2,
        z: 1.2
    }, .7, pc.Linear).start();
    ...
    this.lookAngle = 0, this.crateOpenEffect.enabled = !1, this.confettiEntity.sprite.play("Fire"), this.entity.sound.play("Buy"), this.entity.sound.play("Successful"), this.baseEntity.setLocalScale(1, 1, 1), this.baseEntity.tween(this.baseEntity.getLocalScale()).to({
        x: 1.2,
        y: 1.2,
        z: 1.2
    }, .2, pc.BackOut).start(), setTimeout((function(t) {
    ...
    }), 200, this), this.crateEntity.tween(this.crateEntity.getLocalEulerAngles()).rotate({
        x: 20,
        y: 0,
        z: 0
    }, .3, pc.BackOut).delay(.2).start(), this.lidEntity && (this.animation.lidAxis = 0, this.app.tween(this.animation).rotate({
        lidAxis: -65
    }, .3, pc.BackOut).start()), this.itemPreview.enabled = !0, this.itemPreview.setLocalScale(.3, .3, .3), this.itemPreview.tween(this.itemPreview.getLocalScale()).rotate({
        x: 1,
        y: 1,
        z: 1
    }, .25, pc.BackOut).delay(.2).start()
}, Preview.prototype.onBuy = function() {
    this.lookAngle = 0, this.app.tween(this).to({
        lookAngle: 360
    }, .8, pc.QuadraticOut).start(), this.confettiEntity.sprite.play("Fire"), this.entity.sound.play("Buy"), this.entity.sound.play("Successful"), this.baseEntity.setLocalScale(1.1, 1.1, 1.1), this.baseEntity.tween(this.baseEntity.getLocalScale()).to({
        x: 1,
        y: 1,
        z: 1
    }, .15, pc.BackOut).start()
    ...
    return s.addEventListener("canplay", (function(t) {
        n.setSource(s)
    })), s.setAttribute("webkit-playsinline", "webkit-playsinline"), s.muted = !0, s.src = Utils.prefixCDN + i, s.crossOrigin = "anonymous", s.loop = !0, s.play(), this.isAnimatedSkin = !0, this.videoTexture = n, n
    ...
    var n = e;
    if (n && t) {
        var s, a = t.model.material.clone(),
            r = !1;
        if (n.search(".glb") > -1) return (s = this.app.assets.find(n)) && s.ready((function() {
            t.model.asset = s
        })), this.app.assets.load(s), !1;
        if (n.search("Animated") > -1 ? (r = this.createAnimatedSkin(n), a.diffuseMap = r, a.update()) : this.getSkinFromURL(n, (function(t) {
                a.diffuseMap = t, i && (a.opacityMap = t), a.update()
            })), s = this.app.assets.get(t.model.asset)) s.ready((function() {
    ...
    Date.now() - this.lastDanceLoopTime > 6e3 && (this.entity.sound.play("Emote"), this.currentCharacterEntity.animation.animations[this.danceName] && this.currentCharacterEntity.animation.play(this.danceName), this.lastDanceLoopTime = Date.now())
}, Preview.prototype.setAnimation = function(t, e, i) {
    var n = e + "-" + i + "-Animation",
        s = this.app.assets.find(n),
        a = this.app.assets.find(i + "-Music.mp3"),
        r = this;
    this.app.assets.load(s), this.currentCharacterEntity = t, this.danceName = n, s.ready((function() {
        if (s) {
            var e = t.animation,
                i = e.assets;
...
Shop.attributes.add("shopType", {
    ...
    this.items = [], this.currentItemIndex = 0, this.currentTab = "Offers", this.buyTimeout = !1, this.lastSelectedSKU = "750VG", this.rarities = [], this.currentItem = {}, this.transactionToken = !1, this.currentQuantity = 750, this.contentCreatorCode = "", this.quantities = {
        "0.99 USD": 1500,
        "1.99 USD": 1500,
        "5.99 USD": 5e3,
        "9.99 USD": 1e4,
    ...
    }, this.app.on("Shop:TransactionToken", this.onTransactionToken, this), this.app.on("Shop:Buy", this.onShopBuy, this), this.app.on("Shop:BuyOffer", this.onShopBuyOffer, this), this.app.on("Shop:CreatorCode", this.setCreatorCode, this), this.app.on("Shop:ApplyCreatorCode", this.applyCreatorCode, this), this.app.on("Shop:SetItems", this.setShopItems, this), this.app.on("Shop:Select", this.onItemSelect, this), this.app.on("Shop:Preview", this.setPreview, this), this.app.on("Shop:Bought", this.onBuy, this), this.app.on("Shop:Equip", this.onEquip, this), this.app.on("Shop:Equiped", this.onEquiped, this), this.app.on("Shop:Transaction", this.onTransaction, this), this.app.on("Shop:Watch", this.onWatch, this), this.app.on("Shop:SetItem", this.setItem, this), this.app.on("Shop:BuyState", this.setBuyOfferState, this), this.app.on("Buy:State", this.onMobileBuyState, this), this.app.on("Shop:Unlock", this.onItemUnlock, this), this.app.on("Tab:Shop:Changed", this.onTabChange, this)
    ...
    t.success ? this.app.fire("Shop:Bought", t) : !0 === t.buy_coin ? (this.app.fire("Notify:Notify", "You don't have enough coins"), setTimeout((function(t) {
        t.app.fire("Popup:Coins")
    }), 1e3, this)) : this.app.fire("Alert:Menu", t.message)
}, Shop.prototype.setItem = function(t) {
    this.currentItem = t
}, Shop.prototype.onMobileBuyState = function(t) {
    "error" == t ? this.app.fire("Alert:Menu", "An error occured on payment!") : ("successful" == t || "restored" == t) && this.app.fire("Fetcher:MobilePayment", {
        token: "mobile-process",
    ...
    this.currentQuantity = this.quantities[t], this.app.fire("Fetcher:TransactionToken", {
        quantity: this.currentQuantity,
        content_creator: this.contentCreatorCode
    })
}, Shop.prototype.onShopBuyOffer = function(t) {
    this.transactionToken = !1, this.app.fire("Fetcher:TransactionToken", {
        quantity: t,
        content_creator: this.contentCreatorCode
    }), setTimeout((function() {
    ...
    i.type = "text/javascript", i.async = !0, i.src = "//static.xsolla.com/embed/paystation/1.0.7/widget.min.js", i.addEventListener("load", (function(t) {
        ...
        })), XPayStationWidget.init(e), setTimeout((function() {
            XPayStationWidget.open()
        }), 100)
    }), !1), document.getElementsByTagName("head")[0].appendChild(i)
    ...
    "Crates" == this.currentTab ? this.app.fire("Fetcher:Crates") : "Offers" == this.currentTab || "Featured" == this.currentTab ? this.app.fire("Fetcher:Offers") : "Buy VG" == this.currentTab ? (this.shopType = "VirtualCoin", this.app.fire("Fetcher:BuyVG")) : "Inventory" == this.currentTab && (this.app.fire("Page:Menu", "Account"), pc.session && void 0 !== pc.session.hash && setTimeout((function() {
        pc.app.fire("Tab:Profile", "Inventory")
    }), 100))
}, Shop.prototype.onTransaction = function(t) {}, Shop.prototype.onStateChange = function(t) {}, Shop.prototype.onBuy = function(t) {
    ...
    for (var e = this.items.length; e--;) this.items[e].element.opacity = .8, this.items[e].selection.enabled = !1;
    ...
    var t = this.currentItem;
    "Offers" == this.shopType ? this.app.fire("Fetcher:BuyOffer", {
        offer_id: t.id
    }) : (this.app.fire("Fetcher:BuyOffer", {
        offer_id: t.id
    }), this.buyTimeout = !0, setTimeout((function(t) {
        t.buyTimeout = !1
    }), 1500, this))
    ...
    for (var n in e) {
        ...
        if (r = r.toLowerCase(), this.rarityNumbers[t][r]) {
            ...
            a.enabled = !0, a.element.color = this[r + "Color"], a.findByName("Text").element.text = r.toUpperCase() + " (%" + this.rarityNumbers[t][r] + ")", a.setLocalPosition(10, 20 * -parseInt(o) - 10, 0), this.raritiesEntity.addChild(a), this.rarities.push(a), o++
        }
    }
    this.raritiesEntity.element.height = 20 * o + 15
}, Shop.prototype.setPreview = function(t) {
    this.itemPriceEntity.element.text = t.price, this.itemRarityColor.element.color = this.getRarityColor(t.rarity), this.itemRarityText.element.text = t.rarity, this.itemTitle.element.text = t.name + "", this.itemOwner.element.text = t.owner + "", this.itemBackground.element.color = this.getColor(t.color), this.itemRarityColor.enabled = !0, this.creatorCodeForm.enabled = !1, this.raritiesEntity.enabled = !1, this.showcaseDisplay.enabled = !1, "Crate" == t.type ? (this.buyButton.enabled = !1, this.unlockButton.enabled = !0, this.equipButton.enabled = !1, this.raritiesEntity.enabled = !0, this.showRarities(t.name, t.rarity.split(", "))) : "VirtualCoin" == t.type ? (this.unlockButton.enabled = !1, this.equipButton.enabled = !1, this.buyButton.enabled = !0, this.itemRarityColor.enabled = !1, "" !== this.contentCreatorCode || Utils.isMobile() || (this.creatorCodeForm.enabled = !0), this.buyPriceEntity.element.text = t.price, this.currentQuantity = t.quantity) : t.unlocked ? (this.buyButton.enabled = !1, this.unlockButton.enabled = !1, this.equipButton.enabled = !0, t.equiped ? (this.equipText.element.text = "EQUIPED", this.equipedIcon.enabled = !0, this.equipButton.element.color = this.greenColor) : (this.equipText.element.text = "EQUIP", this.equipedIcon.enabled = !1, this.equipButton.element.color = this.grayColor), this.equipButton.script.button.pressFunction = "Shop:Equip@" + t.item_id) : (this.buyButton.enabled = !1, this.equipButton.enabled = !1, "1" == t.is_showcase ? (this.unlockButton.enabled = !1, this.showcaseDisplay.enabled = !0) : (this.unlockButton.enabled = !0, this.showcaseDisplay.enabled = !1))
    ...
    if ("ScarSkin" == t.type && (a = "Scar-Thumbnail-White.png"), "ShotgunSkin" == t.type && (a = "Shotgun-Thumbnail-White.png"), "SniperSkin" == t.type && (a = "Sniper-Thumbnail-White.png"), "Tec9Skin" == t.type && (a = "Tec-9-Thumbnail-White.png"), "LiliumDance" == t.type && (a = "Dance-Icon.png"), "ShinDance" == t.type && (a = "Dance-Icon.png"), "WeaponAccessory" == t.type && (a = "KeyChain-Icon.png"), "Crate" == t.type && (a = "Loot-Icon.png"), "Offers" == this.shopType) this.app.assets.find(a);
    o.rarity = t.rarity, o.price = t.price, o.color = t.color, o.name = t.name, o.owner = t.owner, o.type = t.type, o.filename = t.filename, o.unlocked = t.unlocked, o.equiped = t.equiped, o.item_id = t.id, o.quantity = t.quantity ? t.quantity : 0, o.is_showcase = t.is_showcase, o.script.button.pressFunction = "Shop:Select@" + e, o.element.opacity = .8, o.selection = o.findByName("Selection"), o.selection.enabled = !1, this.itemHolder.addChild(o), this.items.push(o)
};
...
Coins.attributes.add("coinEntity", {
    ...
    h.enabled = !0, h.rigidbody.applyForce(0, -5, 0), h.rigidbody.teleport(t.x + n, t.y + e, t.z + s, a, y, o), setTimeout((function(t) {
        t.entity.sound.slots.Coin.pitch = .8 + .25 * Math.random(), t.entity.sound.play("Coin")
    }), 270, this), this.entity.addChild(h), this.coins.push(h)
};
...
Miniplay.attributes.add("URL", {
    ...
    if (i && (i.search("lechuck") > -1 || i.search("miniplay") > -1 || i.search("minijuegos") > -1)) {
        ...
        t.src = this.URL, t.onload = function() {
            e.initalizeAPI()
        }, document.body.appendChild(t), this.isReady = !1, this.app.on("Miniplay:Save", this.onSave, this)
    }
...
Objective.attributes.add("mode", {
    ...
    this.labelEntity = e, this.labelIcon = this.labelEntity.findByName("Icon"), this.labelTime = this.labelEntity.findByName("Time"), this.labelEntity.reparent(t), this.labelIcon.element.textureAsset = this.icon, this.iconColor && (this.labelIcon.element.color = this.iconColor);
    var i = this.app.assets.find("Objective-Material"),
        s = this;
    i.ready((function(t) {
        s.objectiveMaterial = t.resource
    })), this.app.assets.load(i), this.app.on("Game:Mode", this.setMode, this), this.app.on("Game:Finish", this.onFinish, this), this.app.on("Mode:ShowObjective", this.setModeState, this), this.app.on("Server:Tick", this.setTick, this), this.on("state", this.onStateChange, this), this.on("destroy", this.onDestroy, this)
}, Objective.prototype.onDestroy = function() {}, Objective.prototype.setModeState = function(t) {
    ...
    return this.mode == pc.currentMode && (!(Date.now() - this.lastUpdateTime < 500) && (this.distance < this.radius ? (this.app.fire("Objective:Inside", !0), this.app.fire("Network:Point", !0), this.objectiveMaterial && (this.objectiveMaterial.emissiveIntensity = 10, this.objectiveMaterial.update()), this.wasInside || this.entity.sound.play("Deep-Whoosh"), this.wasInside = !0) : (this.app.fire("Objective:Inside", !1), this.wasInside = !1, this.objectiveMaterial && (this.objectiveMaterial.emissiveIntensity = 1, this.objectiveMaterial.update())), void(this.lastUpdateTime = Date.now())))
}, Objective.prototype.update = function(t) {
    if (this.distance = this.playerEntity.getPosition().sub(this.entity.getPosition()).length(), this.nextCapture(), !this.isActive) return this.labelEntity.enabled = !1, !1;
    ...
    if (!i) return !1;
    i.worldToScreen(h, e), e.x *= s, e.y *= s, e.x > 0 && e.x < this.app.graphicsDevice.width && e.y > 0 && e.y < this.app.graphicsDevice.height && e.z > 0 ? (this.labelEntity.setLocalPosition(e.x / a, (n.height - e.y) / a, 0), this.labelEntity.enabled = !0) : this.labelEntity.enabled = !1
};
...
Payload.attributes.add("startIndex", {
    ...
    this.entity.sound.data.positional = !0, this.entity.sound.data.slots = this.entity.sound.slots, this.percentage = 0, this.index = -1, this.nextPoint = new pc.Vec3(0, 0, 0), this.lerpPoint = new pc.Vec3(0, 0, 0), this.wheelsBack = !1, this.wheelsFront = !1, this.setWheels(), this.cartEntity.tween(this.cartEntity.getLocalEulerAngles()).rotate({
        x: -1
    }, .4, pc.Linear).yoyo(!0).loop(!0).start(), this.app.on("Map:Loaded", this.onMapLoaded, this), this.app.on("Objective:Payload", this.setNextNumber, this), this.app.on("Objective:Inside", this.onInside, this), this.on("state", this.onStateChange)
}, Payload.prototype.onInside = function(t) {}, Payload.prototype.onStateChange = function(t) {
    t ? this.app.on("Objective:Inside", this.onInside, this) : this.app.off("Objective:Inside")
    ...
    this.points = this.app.root.findByTag("Point"), this.index = Math.floor(.5 * this.points.length), this.points && this.points[this.index] && this.entity.setPosition(this.points[this.index].getPosition().clone()), this.checkNextPoint()
}, Payload.prototype.setNextNumber = function(t) {
    if (!(this.points && this.points.length > 0)) return !1;
    this.index = Math.floor(t * this.points.length), this.nextPoint = this.points[this.index].getPosition().clone(), this.percentage = 0, this.redBarEntity.setLocalScale(t, 1, 1), this.blueBarEntity.setLocalScale(1 - t, 1, 1), this.redPercentageEntity.element.text = Math.floor(100 * t) + "%", this.bluePercentageEntity.element.text = Math.floor(100 * (1 - t)) + "%", this.payloadIcon.setLocalPosition(200 * (t - .5), 5.011, 0)
...
Object.assign(pc, function() {
    ...
    return (OutlineEffect.prototype = Object.create(pc.PostEffect.prototype)).constructor = OutlineEffect, Object.assign(OutlineEffect.prototype, {
        render: function(e, t, i) {
            var o = this.device,
                r = o.scope;
            r.resolve("uWidth").setValue(e.width), r.resolve("uHeight").setValue(e.height), r.resolve("uOutlineCol").setValue(this.color.data), r.resolve("uColorBuffer").setValue(e.colorBuffer), r.resolve("uOutlineTex").setValue(this.texture), pc.drawFullscreenQuad(o, t, this.vertexBuffer, this.shader, i)
        }
    }), {
...
Object.assign(pc, function() {
    ...
    return (OutlineEffect.prototype = Object.create(pc.PostEffect.prototype)).constructor = OutlineEffect, Object.assign(OutlineEffect.prototype, {
        render: function(e, t, o) {
            var i = this.device,
                u = i.scope;
            u.resolve("uWidth").setValue(e.width), u.resolve("uHeight").setValue(e.height), u.resolve("uOutlineCol").setValue([1, 1, 1, .5]), u.resolve("uColorBuffer").setValue(e.colorBuffer), u.resolve("uOutlineTex").setValue(this.texture), pc.drawFullscreenQuad(i, t, this.vertexBuffer, this.shader, o)
        }
    }), {
        OutlineEffect: OutlineEffect
    }
...
River.attributes.add("material", {
    ...
    this.disabled || (this.material.resource.diffuseMapOffset.x = .005 * Math.cos(pc.app._time / 500), this.material.resource.diffuseMapOffset.y = .003 * Math.sin(pc.app._time / 200), this.material.resource.emissiveMapOffset.x += this.speed * e, this.material.resource.update())
...
Settings.prototype.initialize = function() {
    pc.settings = {
        ...
        crosshairScale: 1,
        hideCrosshair: !1
    }, this.app.on("Menu:Settings", this.setSettings, this), this.app.on("Menu:KeyboardConfiguration", this.setKeyboardConfiguration, this), this.app.on("Menu:setKeyOverlay", this.setKeyOverlay, this), this.setKeyboardConfiguration(), this.setSettings()
    ...
    a > 0 ? (pc.settings.resolution = parseInt(a) / 100, this.app.graphicsDevice.maxPixelRatio = .9 * pc.settings.resolution) : this.app.graphicsDevice.maxPixelRatio = .9;
    var r = parseInt(this.getSetting("Volume"));
    r > -1 ? (pc.settings.volume = parseInt(r) / 100, pc.app.systems.sound.volume = .25 * pc.settings.volume) : pc.app.systems.sound.volume = .25;
    var g = this.getSetting("InvertMouse");
    pc.settings.invertAxis = "true" === g, "true" === this.getSetting("DisableMenuMusic") ? (pc.settings.disableMenuMusic = !0, this.app.fire("Menu:Music", !1)) : (pc.settings.disableMenuMusic = !1, this.app.fire("Menu:Music", !0));
    ...
    e > 0 && (pc.settings.cameraSpeed = M / 100), this.setKeyOverlay(), this.app.fire("Game:Settings", pc.settings)
};
...
TransformTool.attributes.add("cameraEntity", {
    ...
    this.mode = "Translate", this.lastDt = 0, this.mouseX = 0, this.mouseY = 0, this.deltaMouseX = 0, this.deltaMouseY = 0, this.lockAxis = !1, this.app.mouse.on("mousedown", this.onMouseDown, this), this.app.mouse.on("mousemove", this.onMouseMove, this), this.app.mouse.on("mouseup", this.onMouseUp, this), this.app.fire("Outline:Add", this.currentEntity, !0)
    ...
    var i = !1;
    t.entity == this.axisX && (this.lockAxis = "X", i = !0), t.entity == this.axisY && (this.lockAxis = "Y", i = !0), t.entity == this.axisZ && (this.lockAxis = "Z", i = !0), i || (this.app.fire("Outline:Remove", this.currentEntity, !0), t.entity.parent && (this.currentEntity = t.entity.parent, t.entity.rigidbody.type = pc.BODYTYPE_KINEMATIC), this.app.fire("Outline:Add", this.currentEntity, !0)), this.lockAxis ? (this.app.fire("Mouse:Lock"), this.app.fire("Camera:State", !1)) : (this.app.fire("Mouse:Unlock"), this.app.fire("Camera:State", !0))
...
FlagShader.attributes.add("texture", {
    ...
    this.currentLoaded = 0, this.isLoaded = !1, this.app.assets.load(this.texture), this.app.assets.load(t), this.app.assets.load(e), this.texture.ready((function() {
        a.onReady()
    })), t.ready((function() {
        a.onReady()
    })), e.ready((function() {
...
Digit.attributes.add("backgroundEntity", {
    ...
    if (o.on("complete", (function() {
        ...
        })), o.start(), this.backgroundEntity && this.defaultBackgroundColor) {
...
ElementAnimation.attributes.add("animation", {
    ...
    var t = [];
    return "Attention" == this.animation && (this.entity.setLocalScale(1, 1, 1), this.entity.setLocalEulerAngles(0, 0, 0), t.push(this.entity.tween(this.entity.getLocalScale()).to({
        x: 1.1,
        y: 1.1,
        z: 1.1
    }, .6, pc.QuinticInOut).yoyo(!0).repeat(2)), t.push(this.entity.tween(this.entity.getLocalEulerAngles()).rotate({
        z: 8
    }, .15, pc.CubicOut).yoyo(!0).repeat(4)), t.push(this.entity.tween(this.entity.getLocalEulerAngles()).rotate({
        z: -8
    }, .15, pc.CubicOut).delay(.15).yoyo(!0).repeat(4))), "Flash" == this.animation && (this.entity.element.opacity = 1, t.push(this.entity.tween(this.entity.element).to({
        opacity: .3
    }, .2, pc.Linear).delay(.4).yoyo(!0).repeat(4))), "Beat" == this.animation && (this.entity.element.opacity = 1, this.entity.timer = 0, this.entity.setLocalScale(1, 1, 1), t.push(this.entity.tween(this.entity).to({
        timer: 1
    }, .35, pc.Linear).delay(2)), t.push(this.entity.tween(this.entity.getLocalScale()).to({
        x: 1.5,
        y: 1.5,
        z: 1.5
    }, .35, pc.Linear)), t.push(this.entity.tween(this.entity.element).to({
        opacity: 0
    }, .35, pc.Linear)), this.playSound && this.entity.sound.play("Sound")), "Pulse" == this.animation && (this.entity.setLocalScale(1, 1, 1), t.push(this.entity.tween(this.entity.getLocalScale()).to({
        x: 1.3,
        y: 1.15,
        z: 1.3
    }, .175, pc.Linear).delay(.4).yoyo(!0).repeat(4))), "ShakeX" == this.animation && (this.entity.setLocalPosition(1, 1, 1), t.push(this.entity.tween(this.entity.getLocalPosition()).rotate({
        x: 10
    }, .1, pc.CubicOut).yoyo(!0).repeat(4)), t.push(this.entity.tween(this.entity.getLocalPosition()).rotate({
        x: -10
    }, .1, pc.CubicOut).delay(.4).yoyo(!0).repeat(4))), "ShakeY" == this.animation && (this.entity.setLocalPosition(1, 1, 1), t.push(this.entity.tween(this.entity.getLocalPosition()).rotate({
        y: 5
    }, .1, pc.CubicOut).yoyo(!0).repeat(4)), t.push(this.entity.tween(this.entity.getLocalPosition()).rotate({
        y: -5
    }, .1, pc.CubicOut).delay(.4).yoyo(!0).repeat(4))), "PickMe" == this.animation && (this.entity.setLocalScale(1, 1, 1), this.entity.setLocalPosition(1, 1, 1), t.push(this.entity.tween(this.entity.getLocalScale()).to({
        x: 1.2,
        y: 1.2,
        z: 1.2
    }, .3, pc.BackOut).yoyo(!0).repeat(2)), t.push(this.entity.tween(this.entity.getLocalPosition()).to({
        y: 5
    }, .3, pc.BackIn).yoyo(!0).repeat(2))), "LowRise" == this.animation && (this.entity.setLocalPosition(1, 1, 1), this.entity.setLocalScale(1, 1, 1), t.push(this.entity.tween(this.entity.getLocalScale()).to({
        x: 2,
        y: 2,
        z: 2
    }, .8, pc.QuadraticInOut).yoyo(!0).repeat(2)), t.push(this.entity.tween(this.entity.getLocalPosition()).to({
        x: -30
    }, .4, pc.SineInOut).yoyo(!0).repeat(2)), t.push(this.entity.tween(this.entity.getLocalPosition()).to({
        x: 30
    }, .4, pc.SineInOut).delay(.8).yoyo(!0).repeat(2))), t
...
CustomChat.attributes.add("isDebug", {
    ...
    this.pack = MessagePack.initialize(4194304), this.ws = !1, this.keys = this.getKeys(), this.on("state", (function(t) {
    ...
    if (this.ws && this.ws.close(), this.roomId = t, this.roomId) {
        var s = this.URL;
        this.isDebug && (s = this.testURL), this.ws = new WebSocket(s + "/?" + this.roomId), this.ws.binaryType = "arraybuffer", this.ws.onopen = this.onOpen.bind(this), this.ws.onclose = this.onClose.bind(this), this.ws.onmessage = this.onMessage.bind(this)
    }
...
Damageable.attributes.add("explosion", {
    ...
    this.health = t, this.app.fire("EffectManager:CustomSound", "Hit-Sound", 1 - .005 * this.health, e), this.material.opacity = Math.max(.008 * this.health, .05), this.material.update(), this.health <= 0 && (this.app.fire("EffectManager:ExplosionEffect", e), this.entity.destroy())
};
...
CustomImage.attributes.add("key", {
    ...
    var i = document.createElement("img");
    this.fromURL ? this.fullURL || this.cdnURL ? i.src = this.cdnURL + t[this.key] : i.src = Utils.prefixCDN + t[this.key] : i.src = t[this.key], i.crossOrigin = "anonymous", i.addEventListener("load", (function(t) {
        e.autoResize && (e.entity.element.width = this.width, e.entity.element.height = this.height), this.src.search("gif") > -1 ? (e.entity.fire("DOM:Style", {
            backgroundImage: 'url("' + this.src + '")',
            backgroundSize: "100% 100%"
        }), e.entity.enabled = !1, setTimeout((function(t) {
            t.entity.enabled = !0
        }), 100, e)) : (s.setSource(i), e.entity.element.texture = s)
    }))
};
...
Tooltip.attributes.add("text", {
    ...
    this.tooltipEntity = this.app.root.findByName("Tooltip"), this.entity.element.on("mouseenter", this.onHover, this), this.entity.element.on("mouseleave", this.onLeave, this), this.on("state", (function(t) {
    ...
    this.tooltipText = this.tooltipEntity.findByName("Text").element, this.tooltipText.text = this.text, this.tooltipEntity.enabled = !0, this.tooltipEntity.element.height = this.tooltipText.height + 10, this.tooltipEntity.element.width = this.tooltipText.width + 20
    ...
    this.onHoverTimeout && clearTimeout(this.onHoverTimeout), this.onHoverTimeout = setTimeout((function(t) {
        t.setText(), t.openTooltip()
    }), 1e3 * this.delay, this)
}, Tooltip.prototype.onLeave = function(t) {
    this.closeTooltip()
}, Tooltip.prototype.openTooltip = function() {
    this.tooltipEntity.setLocalScale(0, 1, 1), this.tooltipText.opacity = 0, this.tooltipEntity.enabled = !0, this.tooltipTweenScale = this.tooltipEntity.tween(this.tooltipEntity.getLocalScale()).to({
        x: 1
    }, .3, pc.ExponentialOut).start(), this.tooltipTweenOpacity = this.tooltipEntity.tween(this.tooltipText).to({
        opacity: 1
...
Reward.attributes.add("baseEntity", {
    ...
    this.app.tween(this.app).to({
        timeScale: .2
    }, .7, pc.Linear).start(), this.app.tween(this.animation).to({
        fov: 35
    }, .3, pc.ExponentialOut).start(), setTimeout((function(t) {
        t.app.tween(t.animation).to({
            fov: 45,
            lookHeight: 10
        }, 1.5, pc.ExponentialOut).start()
    }), 300, this), setTimeout((function(t) {
    ...
    for (var n = 0; n < 20; n++) setTimeout((function(t) {
    ...
    this.app.tween(this.animation).to({
        rotation: 980
    }, .6, pc.Linear).start(), setTimeout((function(t) {
        t.app.tween(t.animation).rotate({
            rotation: -5
        }, .8, pc.ExponentialOut).start()
    }), 600, this), setTimeout((function(t) {
        t.lidOpen()
    }), 1e3, this), setTimeout((function(t) {
        t.entity.sound.play("Time")
    }), 600, this), this.isOpening = !0, this.crateOpen.enabled = !0, this.entity.sound.play("Device-Start")
}, Reward.prototype.lidOpen = function() {
    this.lidEntity = this.crateEntity.findByName("Lid"), this.animation.lidAxis = 0, this.slowTime(), this.app.tween(this.animation).rotate({
        lidAxis: -95
    }, .3, pc.BackOut).start(), setTimeout((function(t) {
        t.app.tween(t.animation).rotate({
            lidAxis: -105,
            verticalAxis: 0,
            height: 0
        }, .1, pc.BackOut).start()
    }), 300, this), this.explodeCoins(), setTimeout((function(t) {
        t.animation.cameraShake = 1, t.app.tween(t.animation).rotate({
            cameraShake: -1
        }, .05, pc.Linear).yoyo(!0).repeat(5).start(), t.entity.sound.play("Coins")
    }), 100, this), setTimeout((function(t) {
        t.app.tween(t.animation).rotate({
            cameraShake: 0
        }, .05, pc.Linear).start()
    }), 900, this), this.entity.sound.play("Explosion-1"), this.entity.sound.play("Particles"), this.crateOpen.enabled = !1, this.confettiEntity.enabled = !0
}, Reward.prototype.update = function(t) {
    this.app.keyboard.wasPressed(pc.KEY_Z) && this.explode(), this.baseEntity.setLocalEulerAngles(this.animation.verticalAxis, this.animation.rotation, 0), this.baseEntity.setLocalPosition(0, this.animation.height, 0), this.lidEntity && this.lidEntity.setLocalEulerAngles(this.animation.lidAxis, 0, 0), this.isOpening || (this.animation.rotation += 10 * t), this.cameraEntity.camera.fov = this.animation.fov, this.cameraEntity.setLocalEulerAngles(this.animation.lookHeight, 0, this.animation.cameraShake)
};
...
Snow.attributes.add("materialAsset", {
    ...
    var t = this;
    this.material = !1, this.timestamp = 0, this.lastTime = Date.now(), this.materialAsset.ready((function() {
        t.onReady()
    }))
    ...
    this.spritesheet ? Date.now() - this.lastTime > this.time && (this.material.opacityMapOffset.x -= this.speedX, this.material.opacityMapOffset.y -= this.speedY, this.lastTime = Date.now()) : (this.material.opacityMapOffset.x -= t * this.speedX, this.material.opacityMapOffset.y -= t * this.speedY), this.material.update()
};
...
Ocean.attributes.add("normalMap", {
    ...
    t.blendType = pc.BLEND_NORMAL, t.setShader(this.shader), t.setParameter("uTime", 0), t.setParameter("sunColor", this.getRGB(this.sunColor)), t.setParameter("sunDirection", [-1, .2, 0]), t.setParameter("horizonColor", this.getRGB(this.horizonColor)), t.setParameter("zenithColor", this.getRGB(this.zenithColor)), t.setParameter("uNormalMap", this.normalMap.resource), t.setParameter("uCameraBottom", this.cameraBottom.resource), this.entity.model.model.meshInstances[0].material = t, this.material = t, this.time = 0
...
Grapple.attributes.add("ropeEntity", {
    ...
    if (this.currentPlayerEntity = t, !1 === e && (e = this.currentPlayerEntity.getPosition().clone()), this.currentPlayerEntity && this.currentPlayerEntity.script && this.currentPlayerEntity.script.enemy && (this.currentPlayerEntity.script.enemy.isGrappling = !0, this.currentPlayerEntity.script.enemy.playGrappleAnimation()), e.clone().sub(i).length() > 47) return !1;
    this.holderEntity.enabled = !0, this.entity.setPosition(e), this.entity.lookAt(i), this.originEntity.reparent(this.entity), this.originEntity.setLocalPosition(0, 0, 0), this.ropeEntity.reparent(this.originEntity), this.ropeEntity.setLocalPosition(0, 0, 0), this.swingEntity.setPosition(i), this.swingEntity.setLocalEulerAngles(0, 0, 0), this.swingRopeEntity.setLocalScale(1, 1, 1), this.scaleRope(e, i), setTimeout((function(t) {
        t.entity.sound.play("Foley-Start")
    }), 100, this), setTimeout((function(t) {
        t.entity.sound.play("Whip")
    }), 300, this), this.active = !0
}, Grapple.prototype.scaleRope = function(t, e) {
    var i = e.clone().sub(t).length() / 3.8;
    this.ropeEntity.setLocalScale(.5, .1, .5), this.ropeEntity.tween(this.ropeEntity.getLocalScale()).to({
        x: .5,
        y: i,
        z: .5
    }, .55, pc.ElasticOut).start(), this.grappleEntity.setLocalPosition(0, .6, 0), this.grappleEntity.tween(this.grappleEntity.getLocalPosition()).to({
        x: 0,
        y: 3.1 * i,
        z: 0
    }, .55, pc.ElasticOut).start();
    var n = 3 * Math.random();
    this.grappleEntity.setLocalEulerAngles(85, 50, 30), this.grappleEntity.tween(this.grappleEntity.getLocalEulerAngles()).rotate({
        x: 0,
        y: 0,
        z: -n
    }, .5, pc.ElasticOut).start(), setTimeout((function(t, e) {
        t.swing(e)
    }), 200, this, i)
}, Grapple.prototype.swing = function(t) {
    this.entity.sound.play("Zipline"), this.originEntity.reparent(this.swingEntity), this.originEntity.setLocalPosition(0, 0, 3.8 * t), this.ropeEntity.reparent(this.swingRopeEntity), this.ropeEntity.setLocalPosition(0, 3.9 * -t, 0), this.swingRopeEntity.tween(this.swingRopeEntity.getLocalScale()).to({
        x: 1,
        y: .1,
        z: 1
    }, .5, pc.Linear).start(), setTimeout((function(t) {
        t.swingEntity.tween(t.swingEntity.getLocalEulerAngles()).rotate({
            ...
            y: 0,
            z: 0
        }, .5, pc.BackOut).start(), t.swingRopeEntity.tween(t.swingRopeEntity.getLocalScale()).to({
            x: 1,
            y: .2,
            z: 1
        }, .3, pc.BackOut).delay(.05).start()
    }), 300, this), pc.controls && pc.controls.entity == this.currentPlayerEntity && this.app.fire("Player:SpeedUp", !0), setTimeout((function(t) {
        t.active = !1, t.kickForce()
    }), 400, this)
}, Grapple.prototype.kickForce = function() {
    var t = this.entity.forward.scale(20);
    this.currentPlayerEntity.rigidbody.applyImpulse(t), this.holderEntity.enabled = !1, this.currentPlayerEntity && this.currentPlayerEntity.script && this.currentPlayerEntity.script.enemy && (this.currentPlayerEntity.script.enemy.isGrappling = !1), this.entity.sound.play("Foley-Strong")
...
ModeManager.attributes.add("objects", {
    ...
    if ("TeamFlagBlue" == e.type || "TeamFlagRed" == e.type) {
        ...
        "TeamFlagRed" == e.type && (t = pc.colors.redTeam), "TeamFlagBlue" == e.type && (t = pc.colors.blueTeam), this.app.fire("Overlay:WorldToScreen", e, {
            color: t
        })
    }
    ...
    var t = e.getPosition();
    "BlackCoin" != e.type && "TeamPointBlue" != e.type && "TeamPointRed" != e.type || (this.app.fire("EffectManager:CustomSound", "Coin", 1, t), this.app.fire("EffectManager:CustomSound", "Spell-1", 1, t)), "HealthPack" == e.type && (this.app.fire("EffectManager:CustomSound", "Spell-1", 1, t), this.app.fire("EffectManager:CustomSound", "Potion-Pickup", 1, t))
}, ModeManager.prototype.onModeSet = function(e, t, a) {
    this.currentMode = e, this.currentModeOptions = a, this.variables.kills = 0
}, ModeManager.prototype.onMapLoaded = function() {}, ModeManager.prototype.onModeEvent = function(e) {
    ...
    this.variables.kills++, "GUNGAME" == this.currentMode && (t.indexOf("Rank") > -1 && (this.variables.kills = 0), this.app.fire("Overlay:WeaponText", this.variables.kills + " / " + this.variables.gungame.weaponLevels[this.currentWeapon]))
...
CustomSkin.attributes.add("key", {
    ...
    if (!this.isModelLoaded) return setTimeout((function(i) {
        i.setCustomSkin(t, e)
    }), 500, this), !1;
    this.clearTemplate();
    var i = this,
    ...
    t && t.emission;
    s && s.search && s.search("Template-") > -1 ? this.setTemplate(s) : s && s.search && (s.search("Model-") > -1 || s.search("glb") > -1) ? this.setModelSkin(s) : s && s.search && (s.search("Animated-") > -1 || s.search("mp4") > -1) ? this.setSkin(this.entity, s, !0) : this.setCustomImage(t, (function(t) {
    ...
    i.minFilter = pc.FILTER_LINEAR, i.magFilter = pc.FILTER_LINEAR, i.addressU = pc.ADDRESS_REPEAT, i.addressV = pc.ADDRESS_REPEAT;
    var s = document.createElement("img");
    s.src = Utils.prefixCDN + t, s.crossOrigin = "anonymous", s.addEventListener("load", (function(t) {
    ...
    this.entity.currentTemplate && this.entity.currentTemplate.destroy(), this.entity.model.enabled = !0
}, CustomSkin.prototype.setTemplate = function(t) {
    if (!t) return !1;
    var e = this,
        i = this.getTemplate(t);
    i && (i.ready((function(t) {
        var i = t.resource.instantiate();
        e.entity.currentTemplate = i, e.entity.addChild(i), e.entity.model.enabled = !1, pc.app.fire("CustomSkin:Loaded", !0)
    })), this.app.assets.load(i))
}, CustomSkin.prototype.setModelSkin = function(t) {
    this.entity.model.defaultAsset || (this.entity.model.defaultAsset = this.entity.model.asset), this.entity.model.asset = this.app.assets.find(t).id, setTimeout((function() {
    ...
    s.minFilter = pc.FILTER_LINEAR, s.magFilter = pc.FILTER_LINEAR, s.addressU = pc.ADDRESS_REPEAT, s.addressV = pc.ADDRESS_REPEAT;
    var n = document.createElement("img");
    n.src = Utils.prefixCDN + i, n.crossOrigin = "anonymous", n.addEventListener("load", (function(t) {
    ...
    })), s.setAttribute("webkit-playsinline", "webkit-playsinline"), s.muted = !0, s.src = Utils.prefixCDN + t, s.crossOrigin = "anonymous", s.loop = !0, s.play(), this.isAnimatedSkin = !0, this.videoTexture = i, i
}, CustomSkin.prototype.setSkin = function(t, e, i) {
    var s = t.model.material.clone();
    if (this.setDefaultModelSkin(), i ? (e = this.createAnimatedSkin(e), s.diffuseMap = e, s.update()) : (s.diffuseMap = e, s.update()), t && t.model && t.model.meshInstances)
...
PlayerAbilities.attributes.add("meleeCenter", {
    ...
    this.isDashing = !1, this.isThrowing = !1, this.isHitting = 0, this.isGrappling = !1, this.resetKeyE = !1, this.resetKeyF = !1, this.hittingTime = .7, this.throwCooldown = 5, this.dashCooldown = 10, this.animation = {
        inspectOpacity: 0
    }, this.player = this.entity.script.player, this.movement = this.entity.script.movement, this.character = this.player.characterName, this.effectManager = this.effectManagerEntity.script.effectManager, this.grappleEntities = [], this.timestamp = this.movement.timestamp, this.lastThrowDate = this.now() - 5e3, this.lastDashDate = this.now() - 5e3, this.lastHookIndicatorTime = Date.now(), this.lastAttentionDate = Date.now(), this.lastHookPoint = new pc.Vec3(0, 0, 0), this.lastDirectionVector = new pc.Vec3(0, 0, 0), this.app.on("Player:Character", this.onCharacterSet, this), this.app.on("Map:Loaded", this.onMapLoaded, this), this.inspectEntities = [], this.createInspectBatch()
}, PlayerAbilities.prototype.onCharacterSet = function(t) {
    var e = this.meleeCenter.findByTag("Melee");
    for (var i in e) {
        e[i].enabled = !1
    }
    "Lilium" == t ? (this.hittingTime = .7, this.hammerEntity.enabled = !0, this.throwCooldown = 10) : "Shin" == t ? (this.hittingTime = .7, this.katanaEntity.enabled = !0, this.throwCooldown = 5, this.dashCooldown = 10) : "Echo" == t ? (this.hittingTime = .7, this.grappleEntity.enabled = !0, this.throwCooldown = 3, this.dashCooldown = 5) : "Kulu" == t && (this.hittingTime = 1, this.throwCooldown = 7, this.dashCooldown = 7), this.character = t, this.hideMelee()
    ...
    "Lilium" == this.character ? this.throwGrenadeAnimation() : "Shin" == this.character ? this.throwShurikenAnimation() : "Echo" == this.character ? this.throwAxeAnimation() : "Kulu" == this.character && this.throwTotemAnimation(), this.resetKeyF = !1
}, PlayerAbilities.prototype.triggerKeyE = function() {
    "Lilium" == this.character ? this.triggerAxeMelee() : "Shin" == this.character ? this.triggerDash() : "Echo" == this.character ? this.triggerGrapple() : "Kulu" == this.character && this.triggerSmash(), this.resetKeyE = !1
    ...
    s && i.distance > s.distance ? this.app.fire("Network:Place", "Totem", s.point) : this.app.fire("Network:Place", "Totem", i.point), this.app.fire("Player:Speak", "Throw", 1), this.app.fire("Overlay:SkillTimer", this.throwCooldown)
}, PlayerAbilities.prototype.triggerSmash = function() {
    if (Date.now() - this.lastDashDate < 1e3 * this.dashCooldown && !this.resetKeyE) return this.app.fire("Overlay:Attention", "Melee"), !1;
    this.shoulderEntity.tween(this.shoulderEntity.getLocalEulerAngles()).rotate({
        x: 171.75,
        y: 72.79,
        z: 162.1
    }, .1, pc.SineOut).start(), this.shoulderEntity.tween(this.shoulderEntity.getLocalPosition()).to({
        x: -.37,
        y: -.311,
        z: -.675
    }, .1, pc.BackOut).start(), setTimeout((function(t) {
        t.wandEntity.enabled = !0, t.shoulderEntity.tween(t.shoulderEntity.getLocalPosition()).to({
            x: -.37,
            y: .266,
            z: -.675
        }, .1, pc.BackOut).start(), t.shoulderEntity.tween(t.shoulderEntity.getLocalEulerAngles()).rotate({
            x: 85.1,
            y: 33.08,
            z: 134.29
        }, .1, pc.BackOut).start()
    }), 200, this), this.armRightOrigin.tween(this.armRightOrigin.getLocalEulerAngles()).rotate({
        x: 0,
        y: 0,
        z: -90
    }, .2, pc.BackOut).start(), setTimeout((function(t) {
        t.shoulderEntity.tween(t.shoulderEntity.getLocalPosition()).to({
            x: -.37,
            y: -.599,
            z: -.675
        }, .2, pc.BackOut).start(), t.shoulderEntity.tween(t.shoulderEntity.getLocalEulerAngles()).rotate({
            x: 85.1,
            y: 33.08,
            z: 56.2
        }, .15, pc.BackOut).start()
    }), 400, this), setTimeout((function(t) {
        t.setCrack()
    }), 500, this), this.isHitting = this.timestamp + this.hittingTime, this.lastDashDate = Date.now(), this.app.fire("Player:Speak", "Attack", 1)
    ...
    if (null !== i && -1 === i.entity.tags.list().indexOf("Wood")) {
        ...
        this.app.fire("EffectManager:Crack", i.point, s), this.app.fire("Network:Throw", "Crack", i.point, s), this.entity.sound.play("Throw"), this.app.fire("Overlay:MeleeTimer", this.dashCooldown), this.movement.slowMovement(.1)
    }
    setTimeout((function(t) {
        t.shoulderEntity.tween(t.shoulderEntity.getLocalEulerAngles()).rotate({
            ...
            y: 45.79,
            z: 161.27
        }, .4, pc.BackOut).start(), t.movement.fastMovement()
    }), 700, this), setTimeout((function(t) {
        t.wandEntity.enabled = !1, t.shoulderEntity.tween(t.shoulderEntity.getLocalEulerAngles()).rotate({
            x: 0,
            y: 0,
            z: 0
        }, .3, pc.BackOut).start(), t.armRightOrigin.tween(t.armRightOrigin.getLocalEulerAngles()).rotate({
            x: 0,
            y: 0,
            z: 0
        }, .3, pc.SineOut).start(), t.shoulderEntity.tween(t.shoulderEntity.getLocalPosition()).to({
            x: -.379,
            y: -.297,
            z: -.345
        }, .2, pc.SineOut).start()
    ...
    this.meleeCenter.enabled = !0, this.meleeCenter.tween(this.meleeCenter.getLocalPosition()).to({
        y: -.246
    }, .2, pc.BackOut).start()
}, PlayerAbilities.prototype.hideMelee = function() {
    this.meleeCenter.tween(this.meleeCenter.getLocalPosition()).to({
        y: -1.5
    }, .15, pc.BackOut).start(), setTimeout((function(t) {
    ...
    this.meleeOrigin.setLocalPosition(-1.341, -2.65, -3.462), this.meleeOrigin.tween(this.meleeOrigin.getLocalPosition()).to({
        y: .67
    }, .2, pc.BackOut).start(), this.movement.playEffortSound(), Math.random() > .5 ? (this.meleeOrigin.setLocalEulerAngles(66.97, -17.07, 29.54), this.meleeOrigin.tween(this.meleeOrigin.getLocalEulerAngles()).rotate({
        x: -20.32,
        y: 40.6,
        z: -108.25
    }, .25, pc.BackOut).delay(.2).start()) : (this.meleeOrigin.setLocalEulerAngles(-42.45, -13.74, 21.08), this.meleeOrigin.tween(this.meleeOrigin.getLocalEulerAngles()).rotate({
        x: 37.81,
        y: -38.75,
        z: -130.44
    }, .25, pc.BackOut).delay(.2).start()), setTimeout((function(t) {
        t.meleeTrigger(), t.entity.sound.play("Throw"), t.app.tween(t.movement.animation).to({
            cameraImpact: -3
        }, .1, pc.BackOut).start()
    }), 200, this), setTimeout((function(t) {
    ...
    var e = this.movement.raycastShootFrom,
        ...
        s = Math.round(20 * Math.random()) + 80;
    t > 0 && (s = t), this.app.fire("EffectManager:Hit", "Melee", e, i, this.player.playerId, s, this.meleePoints)
    ...
    for (var i in this.grappleEntities) {
        ...
        s.getPosition().clone().sub(e).length() < 50 && this.inspectEntities[t] && (this.inspectEntities[t].enabled = !0, this.inspectEntities[t].setPosition(s.getPosition().clone()), this.inspectEntities[t].setRotation(s.getRotation().clone()), this.inspectEntities[t].setLocalScale(s.collision.halfExtents.clone().scale(2.1)), t++)
    }
    ...
    })), t.start(), this.entity.sound.play("Attention-Echo")
    ...
    return s ? s && s.distance > 47 || s && s.entity && -1 === s.entity.tags.list().indexOf("Grapple") ? (this.showGrappleIndicators(), !1) : (this.player.fireNetworkEvent("grapple"), this.isGrappling = !0, this.lastDirectionVector = i.clone(), this.inspectEntity.enabled = !1, this.throwAnimation((function() {
        t.movement.setCameraMovementLock(!0), t.hookGrapple()
    }), !0, 200), this.app.fire("Overlay:MeleeTimer", 5), void(this.lastDashDate = Date.now())) : (this.showGrappleIndicators(), !1)
}, PlayerAbilities.prototype.hookGrapple = function() {
    this.app.fire("EffectManager:Grapple", this.entity, this.throwPoint.getPosition().clone(), this.lastDirectionVector, this.player.playerId, this.player.cards.length > 0), this.app.fire("Network:Throw", "Grapple", this.throwPoint.getPosition().clone(), this.lastDirectionVector), this.app.tween(this.movement.animation).to({
        takeX: 0,
        takeY: 0,
        takeZ: 0
    }, .2, pc.BackInOut).start(), this.hideWeapons(), this.entity.sound.play("Whoosh-High"), this.entity.sound.slots["Whoosh-High"].pitch = 1 + .2 * Math.random(), setTimeout((function(t) {
    ...
    }), 800, this), setTimeout((function(t) {
        t.showWeapons()
    }), 1e3, this)
}, PlayerAbilities.prototype.throwAxe = function() {
    if (this.isGrappling) return !1;
    var t = this.throwPoint.forward.scale(110);
    this.app.fire("EffectManager:Axe", this.throwPoint.getPosition().clone(), t, this.player.playerId, this.player.cards.length > 0), this.app.fire("Network:Throw", "Axe", this.throwPoint.getPosition().clone(), t), this.entity.sound.play("Throw"), this.app.fire("Overlay:SkillTimer", this.throwCooldown)
}, PlayerAbilities.prototype.throwGrenade = function() {
    this.app.fire("EffectManager:Throw", "Grenade", this.throwHandPoint.getPosition().clone(), this.throwHandPoint.forward, this.player.playerId, this.player.cards.length > 0), this.app.fire("Network:Throw", "Grenade", this.throwHandPoint.getPosition().clone(), this.throwHandPoint.forward), this.entity.sound.play("Throw"), this.app.fire("Overlay:SkillTimer", this.throwCooldown)
}, PlayerAbilities.prototype.triggerDash = function() {
    if (Date.now() - this.lastDashDate < 1e3 * this.dashCooldown && !this.resetKeyE) return this.entity.sound.play("Error"), !1;
    if (!this.movement.isLanded) return !1;
    var t = this.angleEntity.forward.scale(110);
    this.isDashing = !0, this.showMelee(), this.hideWeapons(), this.entity.rigidbody.applyImpulse(t), this.player.melee(), this.app.fire("Effect:Trigger", "Wind"), this.app.fire("Overlay:MeleeTimer", 10), this.player.fireNetworkEvent("dash"), this.entity.sound.play("Buff-Attack"), this.entity.sound.play("Whoosh-High"), this.entity.sound.slots["Whoosh-High"].pitch = 1 + .2 * Math.random(), this.app.tween(this.movement.animation).to({
        fov: 10
    }, .2, pc.BackOut).start(), this.meleeOrigin.setLocalEulerAngles(106.08, 39.04, 48.43), this.meleeOrigin.tween(this.meleeOrigin.getLocalEulerAngles()).rotate({
        x: 48.79,
        y: -44.81,
        z: 34.89
    }, .25, pc.BackOut).delay(.08).start(), setTimeout((function(t) {
        t.isDashing = !1, t.showWeapons(), t.hideMelee()
    }), 200, this), this.isHitting = this.timestamp + this.hittingTime, this.lastDashDate = Date.now()
    ...
    this.movement.setShootDirection(), this.entity.sound.play("Whoosh-High"), this.entity.sound.slots["Whoosh-High"].pitch = 1 + .2 * Math.random(), this.app.fire("EffectManager:Shuriken", this.throwHandPoint.getPosition(), [this.shurikenPoint1.getPosition(), this.shurikenPoint2.getPosition(), this.shurikenPoint3.getPosition()], this.player.playerId), this.app.fire("Network:Throw", "Shuriken", this.throwHandPoint.getPosition(), [this.shurikenPoint1.getPosition(), this.shurikenPoint2.getPosition(), this.shurikenPoint3.getPosition()])
}, PlayerAbilities.prototype.throwShuriken = function() {
    for (var t = 0; t < 3; t++) setTimeout((function(t) {
        t._throwShuriken()
    }), 90 * t, this);
    ...
    var n = 400;
    i && i > 0 && (n = i), this.shoulderEntity.tween(this.shoulderEntity.getLocalEulerAngles()).rotate({
        x: 42.75,
        y: 30.65,
        z: -57.65
    }, n / 1e3, pc.SineOut).start(), this.shoulderEntity.reparent(this.handEntity), this.app.tween(this.movement.animation).to({
        takeX: -.52,
        takeY: 22.19,
        takeZ: -55.11
    }, n / 2500, pc.BackInOut).start(), setTimeout((function(t) {
        t.shoulderEntity.tween(t.shoulderEntity.getLocalEulerAngles()).rotate({
            x: 147.77,
            y: 3.9,
            z: 138.54
        }, n / 2e3, pc.Linear).start()
    }), n / 2, this), setTimeout((function(i) {
        i.movement.playEffortSound(s), i.shoulderEntity.tween(i.shoulderEntity.getLocalEulerAngles()).rotate({
            x: 113.4,
            y: -9.2,
            z: 25.38
        }, n / 700, pc.QuinticInOut).start(), setTimeout((function() {
            t(), e && i.app.tween(i.movement.animation).to({
                cameraImpact: -3
            }, .1, pc.BackOut).start()
        }), n / 2)
    }), n, this), setTimeout((function(t) {
        t.shoulderEntity.tween(t.shoulderEntity.getLocalEulerAngles()).rotate({
            x: 64.6,
            y: 4.31,
            z: 1.91
        }, .2, pc.BackOut).start()
    }), 2.8 * n, this), setTimeout((function(t) {
        t.isThrowing = !1, t.shoulderEntity.reparent(t.armEntity), t.shoulderEntity.tween(t.shoulderEntity.getLocalEulerAngles()).rotate({
            x: 0,
            y: 0,
            z: 0
        }, .2, pc.BackOut).start(), t.app.tween(t.movement.animation).to({
            takeX: 0,
            takeY: 0,
            takeZ: 0
        }, .2, pc.BackInOut).start()
    ...
    var i = new pc.Vec3,
        ...
        r = e;
    if (!s) return !1;
    s.worldToScreen(r, i), i.x *= n, i.y *= n, i.x > 0 && i.x < this.app.graphicsDevice.width && i.y > 0 && i.y < this.app.graphicsDevice.height && i.z > 0 ? (t.setLocalPosition(i.x / a, (o.height - i.y) / a, 0), t.enabled = !0) : t.enabled = !1
    ...
    this.resetKeyE = !0, this.resetKeyF = !0, this.app.fire("Overlay:MeleeTimer", 0), this.app.fire("Overlay:SkillTimer", 0)
}, PlayerAbilities.prototype.update = function(t) {
    this.visionUpdate(), this.player.isDeath && this.cooldownReset(), this.timestamp = this.movement.timestamp
};
...
Timeline.attributes.add("autoplay", {
    ...
    this.animation = {
        custom: 0
    }, this.eventListener = !1, this.app.on("Timeline:" + this.entity.name, this.onPlay, this), this.on("destroy", this.onDestroy, this), this.on("state", this.onStateChange, this), this.autoplay && this.onPlay()
    ...
    if (this.position && this.entity.setLocalPosition(this.startFrame.position), this.rotation && this.entity.setLocalEulerAngles(this.startFrame.rotation), this.scale && this.entity.setLocalScale(this.startFrame.scale), this.opacity && (this.entity.element.opacity = this.startFrame.opacity), this.custom) {
    ...
    if ("object" == typeof _options && (options.isReverse = !!_options.isReverse), options.isReverse && (options.delay = 0), this.reset(), this.setFirstFrame(), this.position && (this.positionFrames = this.entity.tween(this.entity.getLocalPosition()).to({
            x: this.endFrame.position.x,
            y: this.endFrame.position.y,
            z: this.endFrame.position.z
        }, this.duration, this.getEase()).delay(options.delay), this.eventListener || (this.eventListener = this.positionFrames.on("complete", this.onComplete, this)), this.loop && this.positionFrames.loop(!0), this.yoyo && this.positionFrames.yoyo(!0), options.isReverse && this.positionFrames.reverse(), this.positionFrames.start()), this.rotation && (this.rotationFrames = this.entity.tween(this.entity.getLocalEulerAngles()).rotate({
            x: this.endFrame.rotation.x,
            y: this.endFrame.rotation.y,
            z: this.endFrame.rotation.z
        }, this.duration, this.getEase()).delay(options.delay), this.eventListener || (this.eventListener = this.rotationFrames.on("complete", this.onComplete, this)), this.loop && this.rotationFrames.loop(!0), this.yoyo && this.rotationFrames.yoyo(!0), options.isReverse && this.rotationFrames.reverse(), this.rotationFrames.start()), this.scale && (this.scaleFrames = this.entity.tween(this.entity.getLocalScale()).to({
            x: this.endFrame.scale.x,
            y: this.endFrame.scale.y,
            z: this.endFrame.scale.z
        }, this.duration, this.getEase()).delay(options.delay), this.eventListener || (this.eventListener = this.scaleFrames.on("complete", this.onComplete, this)), this.loop && this.scaleFrames.loop(!0), this.yoyo && this.scaleFrames.yoyo(!0), options.isReverse && this.scaleFrames.reverse(), this.scaleFrames.start()), this.opacity && (this.opacityFrames = this.entity.tween(this.entity.element).to({
            opacity: this.endFrame.opacity
        }, this.duration, this.getEase()).delay(options.delay), this.eventListener || (this.eventListener = this.opacityFrames.on("complete", this.onComplete, this)), this.loop && this.opacityFrames.loop(!0), this.yoyo && this.opacityFrames.yoyo(!0), options.isReverse && this.opacityFrames.reverse(), this.opacityFrames.start()), this.custom) {
        ...
        })), options.isReverse && this.customFrames.reverse(), this.customFrames.start()
    }
};
...
Shader.attributes.add("autoplay", {
    ...
    var e = this;
    this.loadedCount = -1, this.time = 0, this.operators = {
        Add: "+",
        Subtract: "-",
        Multiply: "*",
        Divide: "/"
    ...
    for (var a in this.app.assets.load(t), t.ready((function() {
            e.onAssetLoad()
        })), this.layers) {
        var i = this.layers[a];
        this.app.assets.load(i.texture), i.texture.ready((function() {
            e.onAssetLoad()
        }))
    }
    ...
    for (var n in this.shader = new pc.Shader(this.app.graphicsDevice, o), this.material = new pc.Material, this.material.shader = this.shader, this.material.alphaWrite = !0, this.material.alphaTest = !0, this.material.depthWrite = !1, this.material.depthTest = !0, this.material.cull = pc.CULLFACE_NONE, this.material.blendType = pc.BLEND_ADDITIVEALPHA, this.layers) {
        var l = this.layers[n];
        this.material.setParameter("layer_" + n, l.texture.resource), this.material.setParameter("position_" + n, [l.position.x, l.position.y]), this.material.setParameter("scale_" + n, [l.scale.x, l.scale.y]), this.material.setParameter("color_" + n, l.color.data)
    }
...
Notify.attributes.add("notifyElement", {
    ...
    n.findByName("Text").element.text = e, n.element.width = 10 * e.length + 50, n.enabled = !0, n.setLocalPosition(50, i, 0), n.tween(n.getLocalPosition()).to({
        x: 0,
        y: i,
        z: 0
    }, .1, pc.BackOut).start(), this.entity.addChild(n), this.entity.sound.play("Notify"), this.notifyIndex++, setTimeout((function(t, e) {
...
NewsSlider.attributes.add("items", {
    ...
    }), 1e3 * this.duration, this), this.index++, void(this.items.length - 1 < this.index && (this.index = 0))))
};
...
Gamepad.prototype.initialize = function() {
    pc.isGamepadActive = !1, this.lookAngleX = 0, this.lookAngleY = 0, window.addEventListener("gamepadconnected", (function(p) {
    ...
    if (pc.app.gamepads && pc.app.gamepads.current && pc.app.gamepads.current.length > 0) {
        var a = pc.app.gamepads.current[0].pad.axes[3],
            ...
            G = e > 0,
            h = a > 0;
        this.app.fire("Gamepad:Tick", "TICK"), this.app.fire("Gamepad:Shoot", h), this.app.fire("Gamepad:Aim", G), this.app.fire("Gamepad:Movement", "EMPTY"), s < .05 && s > -.05 && (s = 0), d < .05 && d > -.05 && (d = 0), this.lookAngleX = pc.math.lerp(this.lookAngleX, s, .25), this.lookAngleY = pc.math.lerp(this.lookAngleY, d, .25), this.app.fire("Gamepad:Look", 50 * this.lookAngleX, 50 * this.lookAngleY), r > 0 && r < 15 && this.app.fire("Gamepad:Movement", "DOWN"), r > 15 && r < 35 && this.app.fire("Gamepad:Movement", "LEFT-DOWN"), r > -20 && r < 0 && this.app.fire("Gamepad:Movement", "RIGHT-DOWN"), r > -60 && r < -45 && this.app.fire("Gamepad:Movement", "UP"), r > -45 && r < 0 && this.app.fire("Gamepad:Movement", "RIGHT-UP"), r > 45 && r < 60 && this.app.fire("Gamepad:Movement", "LEFT-UP"), r > 35 && r < 60 && this.app.fire("Gamepad:Movement", "LEFT"), r > -40 && r < -20 && this.app.fire("Gamepad:Movement", "RIGHT");
        var g = -.5,
            f = .5;
        t < g && i < g ? r = "LEFT-UP" : t > f && i < g ? r = "RIGHT-UP" : t < g && i > f ? r = "LEFT-DOWN" : t > f && i > f ? r = "RIGHT-DOWN" : i > .1 ? r = "DOWN" : i < -.1 ? r = "UP" : t < g ? r = "LEFT" : t > f && (r = "RIGHT"), this.app.fire("Gamepad:Movement", r), m.pressed && this.app.fire("Gamepad:Action", "JUMP"), n.pressed && this.app.fire("Gamepad:Action", "BUTTON1"), c.pressed && this.app.fire("Gamepad:Action", "BUTTON2"), o.pressed && this.app.fire("Gamepad:Action", "BUTTON3"), pc.isGamepadActive = !0
    }
};
...
Water.attributes.add("normal", {
    ...
    this.material = !1, this.loadedCount = 0, this.totalAssetCount = 2, this.normal || this.foam || (this.normal = this.app.assets.find("Water-Normal-Small.jpg"), this.foam = this.app.assets.find("Foam-Texture.png")), this.loadAsset(this.normal), this.loadAsset(this.foam)
...
Ripple.attributes.add("gradient", {
    ...
    var t = this,
        ...
        i = this.app.assets.get(e);
    this.loadedCount = 0, this.app.assets.load(i), i.ready((function() {
        t.onAssetLoad()
    })), this.app.assets.load(this.gradient), this.gradient.ready((function() {
        t.onAssetLoad()
    }))
}, Ripple.prototype.onAssetLoad = function() {
    this.loadedCount++, 2 == this.loadedCount && this.onReady()
}, Ripple.prototype.onReady = function() {
    this.loop ? this.material = this.entity.model.meshInstances[0].material : this.material = this.entity.model.meshInstances[0].material.clone(), this.material.chunks.opacityPS = "uniform sampler2D texture_opacityMap;\nuniform sampler2D gradient;\nuniform float scale;\nuniform float time;\nvoid getOpacity() {\ndAlpha = 1.0;\ndAlpha *= texture2D(texture_opacityMap, $UV+ vec2(scale, 0.0)).r;\ndAlpha += texture2D(texture_opacityMap, $UV+ vec2(scale * 0.5, 0.0)).g;\ndAlpha *= texture2D(gradient, $UV).r;\ndAlpha *= time;\n}\n", this.material.setParameter("gradient", this.gradient.resource), this.entity.model.meshInstances[0].material = this.material, this.scale = 0, this.nextScale = 0, this.time = 0, this.lastSet = Date.now(), this.entity.on("Trigger", this.onTrigger, this)
}, Ripple.prototype.onTrigger = function() {
    this.scale = 4.5
}, Ripple.prototype.update = function(t) {
    if (!this.material) return !1;
    this.material.setParameter("scale", this.scale), this.material.setParameter("time", this.time), !0 === this.loop ? (this.scale += t * this.speed, this.time = 1) : (this.scale += t * this.speed, this.time = Math.cos(this.scale))
};
...
Lightmapped.prototype.initialize = function() {
    ...
    this.app.lightmapper.bake(), setTimeout((function(t) {
...
Trap.prototype.initialize = function() {
    ...
    this.app.assets.get(i).ready((function() {
        t.onReady()
    })), this.state = -100, this.nextState = -100, this.app.on("Trigger:" + this.entity.name, this.onTrigger, this), this.on("destroy", this.onDestroy, this)
    ...
    this.nextState = 0, this.entity.sound && (this.entity.sound.play("Open"), this.app.fire("Overlay:Sound", "Buff-Attack-1"), this.app.fire("Player:Shake", !0)), clearTimeout(this.trapTimer), this.trapTimer = setTimeout((function(t) {
        t.nextState = -25, t.entity.sound && t.entity.sound.play("Close")
    }), 2e3, this)
}, Trap.prototype.update = function() {
    if (!this.stick) return !1;
    this.state = pc.math.lerp(this.state, this.nextState, .3), this.stick.setLocalPosition(0, this.state, 0)
};
...
GroupTrigger.attributes.add("entities", {
    ...
    t && this.entity.setPosition(t.clone()), clearTimeout(this.timer), this.timer = setTimeout((function(t) {
        t.entity.setPosition(new pc.Vec3(0, -100, 0))
    }), 1e3 * this.timeout, this)
};
...
Splash.attributes.add("gradient", {
    ...
    this.time = -1, this.scale = 0, this.material = this.entity.model.meshInstances[0].material.clone(), this.material.chunks.opacityPS = "uniform sampler2D texture_opacityMap;\nuniform sampler2D gradient;\nuniform float scale;\nuniform float time;\nvoid getOpacity() {\ndAlpha = 1.0;\ndAlpha *= texture2D(texture_opacityMap, $UV+ vec2(scale * 0.1, scale)).r;\ndAlpha += texture2D(texture_opacityMap, $UV+ vec2(scale * 0.1, scale * 0.5)).g;\nvec2 alphaVec = $UV + vec2(0.0, scale);\ndAlpha *= texture2D(gradient, alphaVec).r;\ndAlpha *= time;\n}\n", this.material.setParameter("gradient", this.gradient.resource), this.entity.model.meshInstances[0].material = this.material, this.entity.model.meshInstances[1].material = this.material, this.entity.model.meshInstances[2].material = this.material, this.entity.on("Trigger", this.onTrigger, this)
}, Splash.prototype.onTrigger = function(t) {
    this.isPlaying = !0, this.scale = -1.5, this.time = 1
}, Splash.prototype.update = function(t) {
    this.isPlaying && (this.material.setParameter("scale", this.scale), this.material.setParameter("time", Math.cos(this.scale + 1)), this.scale += t * this.speed, this.time = pc.math.lerp(this.time, 0, .01))
};
...
BakedPhysicsPlayer.attributes.add("staticEntity", {
    ...
    this.isLoaded = !1, this.app.on("BakedPhysics:" + this.entity.name, this.onPlay, this), this.autoplay && this.app.fire("BakedPhysics:" + this.entity.name, new pc.Vec3(0, 0, 0)), this.on("destroy", this.onDestroy, this)
    ...
    this.isPlaying = !1, this.fps = 60, this.pool = [], this.data = {}, this.frames = [], this.frameIndex = 0, this.frameTime = 0, this.isHidden = !1, this.childVertices = !1, this.childScale = !1, this.app.assets.load(this.file), this.file.ready((function(i) {
        ...
        t.data = e, t.count = e.count, t.duration = e.duration, t.frames = e.frames, t.childVertices = e.childVertices, t.childScale = e.childScale, t.isLoaded = !0
    })), this.staticEntity.enabled = !1, this.createPhysicalObjects(), this.hidePool()
...
AutoResize.attributes.add("entities", {
    type: "entity",
    array: !0
}), AutoResize.prototype.initialize = function() {}, AutoResize.prototype.update = function(e) {
...
WorldToScreen.attributes.add("guideEntity", {
    ...
    this.lockEntities = [], this.guideEntities = [], this.cameraEntity = this.app.root.findByName("Lens"), this.guideEntity.enabled = !1, this.app.on("Overlay:WorldToScreen", this.setEntity, this), this.on("destroy", this.onDestroy, this)
    ...
    e.worldToScreen(n, i), i.x *= s, i.y *= s, i.x > 0 && i.x < this.app.graphicsDevice.width && i.y > 0 && i.y < this.app.graphicsDevice.height && i.z > 0 ? (this.guideEntities[t].setLocalPosition(i.x / o, (r.height - i.y) / o, 0), this.guideEntities[t].enabled = !0) : this.guideEntities[t].enabled = !1
...
Rating.attributes.add("stars", {
    ...
    this.app.fire("Fetcher:Rating", {
        score: t,
        map: pc.displayMap
    }), this.app.fire("Notify:Notify", "Thank you for your vote!"), this.app.fire("View:Menu", "Custom")
};
var Domcontroller = pc.createScript("domcontroller");
Domcontroller.prototype.initialize = function() {
    this.app.on("DOM:Hide", this.onHide, this), this.app.on("DOM:Show", this.onShow, this), this.app.on("DOM:DelayUpdate", this.onDelayUpdate, this), window.addEventListener("resize", (function() {
...
AssetLoader.prototype.initialize = function() {
    ...
    var t = this.app.assets.findByTag("LoadLater");
    for (var a in t) {
        var e = t[a];
        this.app.assets.load(e), e.ready((function() {}))
    }
...
GroupAction.attributes.add("actions", {
    ...
    for (var o in this.actions) {
        ...
        n.delay > 0 ? setTimeout((function(o) {
            i.triggerAction(o.global, o.entity, o.action, t)
        }), 1e3 * n.delay, n) : i.triggerAction(n.global, n.entity, n.action, t)
    }
};
...
PlaySound.prototype.initialize = function() {
    this.entity.on("PlaySound", this.onPlaySound, this), this.app.on("Sound:" + this.entity.name, this.onPlaySound, this)
...
Hover.attributes.add("hasOrigin", {
    ...
    this.items = [], this.app.on("Hover:" + this.entity.name, this.onSet, this), this.app.on("Select:" + this.entity.name, this.onSelect, this), this.app.on("Index:" + this.entity.name, this.onIndexTrigger, this), this.on("destroy", this.onDestroy, this)
    ...
    for (var e in this.items) {
        var i = this.items[e],
            o = i;
        this.hasOrigin && (o = i.findByName("Origin")), "Scale" == this.hoverType ? o && (t == i ? o.setLocalScale(1.15, 1.15, 1.15) : o.setLocalScale(1, 1, 1)) : i.element.opacity = t == i ? 1 : .3
    }
...
Select.attributes.add("options", {
    ...
    this.isDestroyed = !1, this.createElement(), this.updateStyle(), this.app.on("DOM:Clear", this.onDOMClear, this), this.app.on("DOM:Update", this.onDomUpdate, this), this.on("state", (function(t) {
        this.entity.enabled ? this.createElement() : this.onDestroy()
    }), this), this.on("destroy", (function(t) {
        this.onDestroy()
    }), this)
}, Select.prototype.createElement = function() {
    this.element = document.createElement("select"), this.element.style.position = "absolute", this.element.style.fontFamily = this.fontFamily, this.element.style.border = "0px", this.element.style.background = "transparent", this.element.style.fontSize = this.fontSize + this.scaleUnit, this.element.style.padding = this.padding + this.scaleUnit, this.element.style.boxSizing = "border-box";
    var t = "rgb(" + 255 * this.color.r + ", " + 255 * this.color.g + ", " + 255 * this.color.b + ")";
    for (var e in this.element.style.color = t, this.element.style.outline = "none", this.containerEntity ? (this.element.style.position = "fixed", this.containerEntity.script.container.insideElement.appendChild(this.element)) : document.body.appendChild(this.element), this.isDestroyed = !1, this.options) {
        var i = this.options[e],
            n = document.createElement("option");
        n.value = i, n.innerText = i, this.defaultIndex == parseInt(e) && (n.selected = !0), this.element.appendChild(n)
    }(this.element.selectedIndex = this.defaultIndex, this.element.onchange = this.onChange.bind(this), this._updateStyle(), this.storeValue) && (window.localStorage.getItem(this.entity._guid) && (this.element.selectedIndex = window.localStorage.getItem(this.entity._guid)))
    ...
    if (t.entity && t.entity.element && t.entity.element.screenCorners) {
        ...
        if (this.containerEntity) {
            var r = this.containerEntity.scaleX,
                ...
                c = .9 == t.app.graphicsDevice.maxPixelRatio ? e[0].y : e[0].y / t.app.graphicsDevice.maxPixelRatio * .9,
                p = .9 == t.app.graphicsDevice.maxPixelRatio ? this.containerEntity.offsetTop : this.containerEntity.offsetTop / t.app.graphicsDevice.maxPixelRatio * .9;
            n = 1 / .9, s = (e[0].x - this.containerEntity.offsetLeft) / r, l = (c - p) / h - t.entity.element.height + this.containerEntity.element.height - (t.entity.element.height / 2 - 5), this.containerEntity && this.containerEntity.script.container.autoResize && (this.element.style.transform = "scale(" + 1 / r + ", " + 1 / h + ")", this.element.style.transformOrigin = "left bottom")
        } else s = e[0].x, l = e[0].y;
        t.element.style.left = s * i + "px", this.element.style.bottom = l * (0 != n ? n : i) + "px", t.element.style.width = o + "px", t.element.style.height = a + "px"
    }
    ...
    checkHardware: function() {
        if (!window.localStorage.getItem("HardwareCheck")) {
            var e = document.querySelector("#application-canvas").getContext("webgl2"),
                r = document.querySelector("#application-canvas").getContext("webgl2").getExtension("WEBGL_debug_renderer_info");
...
CustomCss.attributes.add("files", {
    ...
    for (var t in this.files) {
        var a = this.files[t];
        this.app.assets.load(a), a.ready((function(t) {
...
var accountManager = {
        ...
        init: function() {
            Credentials.createElement(), Credentials.navbarTop(), Credentials.LoginModal(), Credentials.SignupModal(), pc.app.on("AccountManager:Signup", (function() {
        ...
        login: function(e) {
            ...
            n.style.backgroundColor = "#870909", n.style.width = "70%", n.innerHTML = "" + e.message, setTimeout((function() {
            ...
            }), 5e3), 1 == e.success ? (pc.app.fire("Trigger:Login", !0), pc.app.fire("Fetcher:MiniProfile", !0), accountManager.close()) : (loginButton.innerHTML = 'LOGIN<div id="chevron-arrow-right"></div>', loginButton.classList.remove("button-disable"))
        },
        signup: function(e) {
            var n = document.getElementById("modal-signup-text");
            n.style.backgroundColor = "#870909", n.style.width = "70%", n.innerHTML = "" + e.message, !0 === e.success ? (pc.app.fire("Fetcher:MiniProfile", !0), accountManager.close()) : "undefined" != signupButton && (signupButton.innerHTML = 'SIGNUP<div id="chevron-arrow-right"></div>', signupButton.classList.remove("button-disable")), setTimeout((function() {
        ...
        service: function(e, n, t) {
            ...
            o.open("POST", this.serviceURL + e), o.onreadystatechange = function() {
                a.loading = !1, o.readyState > 3 && 200 == o.status && t(JSON.parse(o.responseText))
            }, o.withCredentials = !0, o.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"), o.send(i)
        }
    },
    Credentials = {
        ...
        navbarTop: function() {
            ...
            n.id = "navbarUL", this.navbarLogin = document.createElement("li"), this.navbarLogin.id = "navbarLoginBtn", this.navbarLogin.innerHTML = "<p>Login</p>", this.navbarLogin.onclick = function() {
                accountManager.switch("Login")
            }, this.navbarSignup = document.createElement("li"), this.navbarSignup.id = "navbarSignupBtn", this.navbarSignup.innerHTML = "<p>Signup</p>", this.navbarSignup.classList.add("inactive"), this.navbarSignup.onclick = function() {
                accountManager.switch("Signup")
            };
            var t = document.createElement("div");
            t.id = "closeBtnContainer";
            var a = document.createElement("button");
            a.id = "modal-close-button", a.innerHTML = "&times;", a.onclick = function() {
                accountManager.close()
            }, this.navbar.append(e, t), e.appendChild(n), n.append(this.navbarLogin, this.navbarSignup), t.appendChild(a)
        },
        LoginModal: function() {
            ...
            s.id = "modal-login-button-container", loginButton = document.createElement("button"), loginButton.classList.add("login-button"), loginButton.innerHTML = 'LOGIN<div id="chevron-arrow-right"></div>', loginButton.addEventListener("click", (function(e) {
                e.preventDefault(), loginButton.innerHTML = '<svg class="spinner" viewBox="0 0 50 50"><circle class="path" cx="25" cy="25" r="20" fill="none" stroke-width="5"></circle></svg>', loginButton.classList.add("button-disable");
                ...
                accountManager.service("?request=login", {
                    username: t,
                    password: a
                }, accountManager.login)
            })), this.loginModal.append(n, a), a.appendChild(e), e.append(i, d, s), n.appendChild(t), i.appendChild(o), d.appendChild(r), s.appendChild(loginButton)
        },
        SignupModal: function() {
            ...
            c.classList.add("signup-button"), c.innerHTML = 'SIGNUP<div id="chevron-arrow-right"></div>', c.addEventListener("click", (function(e) {
                e.preventDefault(), c.innerHTML = '<svg class="spinner" viewBox="0 0 50 50"><circle class="path" cx="25" cy="25" r="20" fill="none" stroke-width="5"></circle></svg>', c.classList.add("button-disable");
                ...
                accountManager.service("?request=create_account", {
                    username: t,
                    password: a
                }, accountManager.signup)
            })), this.signupModal.append(n, a), a.append(e), e.append(i, d, s), n.appendChild(t), i.appendChild(o), d.appendChild(r), s.appendChild(c)
        }
    };
...
Fresnel.attributes.add("MeshInstance", {
    ...
    var e = this;
    this.app.assets.load(this.burningTexture), this.burningTexture.ready((function() {
        e.isTextureLoaded = !0
    ...
    if (!this.isLoaded) return !1;
    this.isBurning && this.isTextureLoaded && (this.material.setParameter("time", this.time), this.time += e * this.burningSpeed), Date.now() - this.lastDamage < 2e3 && Date.now() - this.lastDamage > 100 && (this.material.setParameter("material_emissiveIntensity", this.intensity), this.intensity = pc.math.lerp(this.intensity, 0, .25))
};
...
DealtDamage.attributes.add("numberEntity", {
    ...
    s.on("complete", (function() {
        this.entity.tween(this.entity.getLocalScale()).to({
            ...
            y: 1,
            z: 1
        }, .5, pc.BounceOut).start()
    })), s.start(), this.entity.sound.play("Hit-Impact"), i.tween(i.element).to({
        opacity: 1
    }, .4, pc.Linear).start().on("complete", (function() {
        i.tween(i.element).to({
            opacity: 0,
            offsetY: 150
        }, o, pc.Linear).start()
    })), setTimeout((function(t, e) {
        t.destroyEntity(e)
    }), 3e3, this, i), this.numbers.push(i), this.entity.addChild(i)
    ...
    return !!a && (!!t && (a.worldToScreen(s, e), e.x *= i, e.y *= i, void(e.x > 0 && e.x < this.app.graphicsDevice.width && e.y > 0 && e.y < this.app.graphicsDevice.height && e.z > 0 ? (t.setLocalPosition(e.x / n + t.element.offsetX, (o.height - e.y) / n + t.element.offsetY, 0), t.element.outlineThickness = t.element.opacity, t.enabled = !0) : t.enabled = !1)))
...
MapLoader.attributes.add("mapHolder", {
    ...
    this.loadedModelsCount = 0, this.totalModelsCount = 0, this.entities = [], this.mapEntities = [], this.willBeBatched = [], this.loadedTextures = 0, this.totalTextures = 0, this.mapData = {}, this.app.loader.getHandler("container").crossOrigin = "Anonymous", this.app.loader.getHandler("texture").crossOrigin = "Anonymous", this.app.loader.getHandler("model").crossOrigin = "Anonymous", this.app.on("MapLoader:Load", this.setMap, this), this.app.on("MapLoader:Clear", this.clearMap, this), this.app.on("MapLoader:Remove", this.removeItem, this), this.on("destroy", this.onDestroy, this)
    ...
    clearTimeout(this.loadTimer), this.currentMapWrapper = new pc.Entity("MapHolder"), this.mapHolder.addChild(this.currentMapWrapper), console.log("Map loader set map", e, this.mapHolder), this.willBeBatched = [], this.mapData = e, this.prepare(), this.loadingEntity && (this.loadingEntity.enabled = !0)
    ...
    this.loadingEntity && (this.loadingEntity.enabled = !1), this.prepareBatches(), console.log("Fully loaded!"), clearTimeout(this.loadTimer), this.loadTimer = setTimeout((function(e) {
        console.log("Batched!"), e.app.fire("CollisionScaler:Scale"), e.app.fire("BatchManager:Generate", !0)
    }), 1e4, this)
    ...
    for (var e = this.mapEntities.length; e--;) this.mapEntities[e] && this.mapEntities[e].destroy()
    ...
    if (!e) return !1;
    this.app.assets.load(t), t.ready((function() {
        pc.app.scene.skybox = t.resource
    }));
    var a = this.lightEntity.clone();
    a.light.color = Utils.hex2RGB(e.sunColor), a.light.intensity = e.intensity, a.enabled = !0, this.currentMapWrapper.addChild(a), this.mapEntities.push(a);
    var o = Utils.hex2RGB(e.ambientColor);
    this.app.scene.ambientLight.r = o.r, this.app.scene.ambientLight.g = o.g, this.app.scene.ambientLight.b = o.b, this.app.scene.skyboxIntensity = e.skyboxIntensity, this.app.fire("Loader:SetSkybox", e)
    ...
    t.setLocalPosition(e.position.x, e.position.y, e.position.z), e.scale && e.scale.x && e.scale.y && e.scale.z && t.setLocalScale(e.scale.x, e.scale.y, e.scale.z), t.enabled = !0, this.currentMapWrapper.addChild(t), this.mapEntities.push(t)
    ...
    var a = t.clone();
    if (a.model.castShadows = !0, a.model.receiveShadows = !0, this.willBeBatched.push(a), e.script_data && (a.addComponent("script"), a.script.create(e.script_data.name, e.script_data.attributes)), e.guid && (a.server_id = e.guid), e.tags)
        for (var o in e.tags) a.tags.add(e.tags[o]);
    a.setEulerAngles(e.rotation.x, e.rotation.y, e.rotation.z), a.setPosition(e.position.x, e.position.y, e.position.z), a.originalScale = e.originalScale, e.scale && e.scale.x && e.scale.y && e.scale.z && a.setLocalScale(e.scale.x, e.scale.y, e.scale.z), a.enabled = !0, this.currentMapWrapper.addChild(a), this.mapEntities.push(a)
    ...
    this.app.assets.loadFromUrl(e.model, "container", (function(a, o) {
        ...
        for (var s in i.addComponent("model"), i.model.asset = o.resource.model, t.totalTextures += e.textures.length, e.textures) {
            var r = e.textures[s];
            t.loadTexture(s, r, i)
        }
        for (var n in i.setLocalScale(e.scale[0], e.scale[1], e.scale[2]), e.children) {
            ...
            for (var l in d.addComponent("collision", p.collision), d.addComponent("rigidbody", {
                    friction: .5,
                    restitution: .5,
            ...
            d.setLocalPosition(p.position[0], p.position[1], p.position[2]), d.setLocalEulerAngles(p.rotation[0], p.rotation[1], p.rotation[2]), i.addChild(d)
        }
        for (var h in e.tags) i.tags.add(e.tags[h]);
        i.enabled = !1, t.currentMapWrapper.addChild(i), t.entities.push(i), t.loadedModelsCount++, t.loadedModelsCount == t.totalModelsCount && t.loadMap()
    }))
}, MapLoader.prototype.loadTexture = function(e, t, a) {
    var o = new pc.StandardMaterial,
        i = this;
    t.diffuseTexture && (console.log("Load :", e, t.diffuseTexture), this.app.assets.loadFromUrl(t.diffuseTexture, "texture", (function(s, r) {
        console.log("Loaded asset : ", t.diffuseTexture), r && r.resource && (o.diffuseMap = r.resource, t.diffuseTiling && (o.diffuseMapTiling.x = t.diffuseTiling[0], o.diffuseMapTiling.y = t.diffuseTiling[1]), t.diffuseColor && (o.diffuseTint = !0, o.diffuse = new pc.Color(t.diffuseColor[0], t.diffuseColor[1], t.diffuseColor[2])), i.loadedTextures++, a.model.meshInstances[e].material = o, console.log(e, o, r.resource), i.loadedTextures >= i.totalTextures && i.onLoaded())
    }))), t.opacityTexture && this.app.assets.loadFromUrl(t.opacityTexture, "texture", (function(e, t) {
        t && t.resource && (o.opacityMap = t.resource, o.opacityMapChannel = "a", o.blendType = pc.BLEND_NORMAL, o.cull = pc.CULLFACE_NONE)
    })), t.diffuseTexture || t.opacityTexture || (i.loadedTextures++, i.loadedTextures >= i.totalTextures && i.onLoaded())
}, MapLoader.prototype.service = function(e, t) {
    var a = window.XMLHttpRequest ? new XMLHttpRequest : new ActiveXObject("Microsoft.XMLHTTP");
    a.open("GET", e), a.onreadystatechange = function() {
        a.readyState > 3 && 200 == a.status && t(JSON.parse(a.responseText))
    }, a.setRequestHeader("X-Requested-With", "XMLHttpRequest"), a.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"), a.send()
};
...
BatchManager.prototype.initialize = function() {
    ...
    console.log("[DEBUG] Batch group created : ", a.name), t || (this.lastBatchId++, this.app.batcher.addGroup(a.name, !0, 100, this.lastBatchId), t = this.app.batcher.getGroupByName(a.name), this.groupIds.push(t.id)), a.model.batchGroupId = t.id
};
...
Banner.attributes.add("bannerEntity", {
    ...
    this.index = 0, this.total = 0, this.dots = [], this.bannerEntity.enabled = !1, this.dotEntity.enable = !1, this.timer = setInterval((function(t) {
        t && t.nextBanner && t.nextBanner()
    }), 1e3 * this.duration, this), this.app.on("Banner:" + this.entity.name, this.setBanners, this), this.on("destroy", this.onDestroy, this)
    ...
    if (this.groupEntity && this.groupEntity.tween) {
        for (var n in this.groupEntity.tween(this.groupEntity.getLocalPosition()).to({
                x: t,
                y: 0,
                z: 0
            }, .6, pc.ExponentialOut).start(), this.dots) {
            this.dots[n].setLocalScale(1, 1, 1)
        }
        var e = this.dots[this.index];
        e && e.tween(e.getLocalScale()).to({
            x: 2,
            y: 2,
            z: 2
        }, .4, pc.ExponentialOut).start()
    }
    ...
    for (var n in t.banners) {
        ...
        a.setLocalPosition(i, 0, 0), "Fire" == e.type ? a.script.button.fireFunction = e.action : a.script.button.triggerFunction = 'window.open("' + e.action + '")', a.enabled = !0, a.fire("CustomImage:Set", e), a.fire("EventButton:Set", "Banner", e.slug);
        var s = this.dotEntity.clone();
        s.setLocalPosition(r, 0, 0), s.script.button.fireFunction = "Banner:" + this.entity.name + "@" + n, s.enabled = !0, this.dotHolder.addChild(s), this.dotHolder.element.width = 30 * t.banners.length, this.dots.push(s), this.groupEntity.addChild(a)
    }
...
TypingText.attributes.add("speed", {
    ...
    e = e.replace(/_(.[a-zA-Z]*)/g, '[color="#000000"]\\[$1][/color]'), this.entity.element.text = e, this.text.length > this.index && (this.index += this.speed * t), this.background && (this.background.element.width = this.entity.element.width + 20)
};
...
Quests.attributes.add("cardEntity", {
    ...
    this.holderEntity.enabled = !1, this.closeButtonEntity.enabled = !1, clearTimeout(this.nextQuestTimer)
    ...
    var e = this.cardEntity.clone(),
        ...
        a = 0;
    e.enabled = !0, s.element.textureAsset = this.app.assets.find(t.icon), e.sound.pitch = .8 + .1 * this.index, u.enabled = !1, h.enabled = !1, e.setLocalPosition(0, -98 * this.realIndex, 0);
    var l = t.title.substr(0, 32),
        r = "." == l[l.length - 1] ? "" : "...";
    if (i.fire("TypingText", l + r), n.script.timeline.endFrame.scale.x = 1 * t.total / t.goal, n.script.timeline.onPlay(), setTimeout((function() {
            o.fire("Count", t.total)
        }), 1e3), t.total == t.goal && (setTimeout((function(t) {
            u.enabled = !0, e.tween(e.getLocalScale()).to({
                x: 1.1,
                y: 1.1,
                z: 1.1
            }, .2, pc.BackOut).start(), t.entity.sound.play("Successful")
        }), 1500, this), h.enabled = !0, a += 200), this.holderEntity.addChild(e), this.realIndex++, setTimeout((function() {
            e.tween(e.getLocalScale()).to({
                x: .9,
                y: .9,
                z: .9
            }, .2, pc.BackOut).start()
        }), 1600 + a), this.index > this.quests.length - 1) return this.hideQuests(), !1;
    this.holderEntity.tween(this.holderEntity.element).to({
        height: 98 * (this.realIndex + 1)
    }, .5, pc.BackOut).delay(1.5 + .001 * a).start(), setTimeout((function(t) {
        t.entity.sound.play("Whoosh")
    }), 1500 + .001 * a, this), this.nextQuestTimer = setTimeout((function(t) {
        t.setQuest()
    }), 1900 + a, this)
};
...
Camera.attributes.add("maxShakeDuration", {
    ...
    this.cameraOffset = new pc.Vec3(0, 0, 0), this.shakeDuration = 0, this.app.on("Camera:Shake", this.onCameraShake, this), this.app.on("View:State", this.onState, this), this.on("destroy", this.onDestroy, this), pc.dt = 1 / 60
    ...
    console.log("Camera destroyed!"), this.app.off("Camera:Shake", this.onCameraShake, this), this.app.off("View:State", this.onState, this), this.entity.audiolistener.enabled = !1
    ...
    if (this.shakeDuration > 0) this.cameraOffset.x = pc.math.random(-this.currentShakeAmount, this.currentShakeAmount), this.cameraOffset.y = pc.math.random(-this.currentShakeAmount, this.currentShakeAmount), this.cameraOffset.z = pc.math.random(-this.currentShakeAmount, this.currentShakeAmount);
    else {
        var e = this.fixedUpdate(.1, t);
        this.cameraOffset.x = pc.math.lerp(this.cameraOffset.x, 0, e), this.cameraOffset.y = pc.math.lerp(this.cameraOffset.x, 0, e), this.cameraOffset.z = pc.math.lerp(this.cameraOffset.x, 0, e)
    }
...
PushAlert.attributes.add("key", {
    ...
    t.src = "https://cdn.pushalert.co/integrate_" + this.key + ".js", document.body.appendChild(t), (pushalertbyiw = window.pushalertbyiw || []).push(["onSuccess", this.callbackOnSuccess], ["onFailure", this.callbackOnFailure]), this.app.on("PushAlert:" + this.entity.name, this.subscribeStatus, this)
}, PushAlert.prototype.subscribeStatus = function() {
    PushAlertCo.forceSubscribe(), "subscribed" != PushAlertCo.getSubsInfo().status ? this.app.fire("Alert:Menu", "Check browser settings for notifications") : this.app.fire("Alert:Menu", "Yeeeyy Subscribed")
...
Spray.attributes.add("baseShader", {
    ...
    pc.shaderChunks.cookiePS = this.baseShader.resource, pc.shaderChunks.combineDiffuseSpecularPS = this.sprayShader.resource
};
...
RedeemVg.attributes.add("bannerEntity", {
    ...
    "undefined" == typeof adblockEnabled && (adblockEnabled = !0), this.app.on("Menu:SetHome", this.setHomeEvent, this), this.app.on("RedeemVG", this.trigger, this), this.app.fire("Analytics:Event", "Checkpoint", "SDKLoaded")
}, RedeemVg.prototype.setHomeEvent = function(e) {
    if (adblockEnabled) return pc.app.fire("View:Menu@Close"), e && e.can_redeem && pc.app.fire("Analytics:Event", "Checkpoint", "RedeemFail"), !1;
    e && e.can_redeem && (this.app.fire("View:Menu", "RedeemVG"), this.app.fire("Analytics:Event", "Checkpoint", "CanRedeem"))
}, RedeemVg.prototype.trigger = function(e) {
    if (adblockEnabled) return !1;
    window.location.host;
    pc.app.systems.sound.volume = 0, this.bannerEntity.enabled = !1, this.app.fire("Analytics:Event", "Checkpoint", "RedeemTrigger"), this.app.fire("Ads:RewardAds", (function() {
        pc.app.fire("Fetcher:RedeemReward"), pc.app.fire("Analytics:Event", "Checkpoint", "RedeemSuccess"), pc.app.systems.sound.volume = .25, setTimeout((function() {
            pc.app.fire("View:Menu@Close")
        }), 500)
    }), (function() {
        pc.app.fire("View:Menu@Close"), pc.app.fire("Analytics:Event", "Checkpoint", "RedeemFail"), pc.app.fire("Alert:Menu", "Please disable adblock to enable rewards!"), pc.app.systems.sound.volume = .25
    }))
};
var MouseLock = pc.createScript("mouseLock");
MouseLock.prototype.initialize = function() {
    this.onLock = !1, this.onUnlock = !1, this.lastLockTime = 0, this.isLocked = !1, this.isActive = !1, this.isTrying = !1, Utils.isMobile() || (document.addEventListener("pointerlockchange", this.onChange.bind(this), !0), document.addEventListener("pointerlockerror", this.lockError.bind(this), !0), this.app.on("Mouse:Lock", this.lock, this), this.app.on("Mouse:Unlock", this.unlock, this), this.on("destroy", this.onDestroy, this))
}, MouseLock.prototype.onDestroy = function() {
    document.removeEventListener("pointerlockchange", this.onChange), document.removeEventListener("pointerlockerror", this.lockError), this.isLocked = !1, this.isActive = !1, this.isTrying = !1, this.unlock(), clearTimeout(this.lockTimer)
}, MouseLock.prototype.lockError = function() {
    this.isActive && !this.isTrying && this.tryLock()
}, MouseLock.prototype.tryLock = function() {
    this.isTrying = !0, this.lock(), clearTimeout(this.lockTimer), this.lockTimer = setTimeout((function(o) {
        o.tryLock()
    }), 1e3, this)
}, MouseLock.prototype.lock = function(o) {
    if ("undefined" != typeof app && !0 === app.isWatchingAds) return !1;
    var t = document.body;
    t.requestPointerLock = t.requestPointerLock || t.mozRequestPointerLock, t.requestPointerLock(), this.isActive = !0, document.body.style.cursor = "wait", o && (this.onLock = o)
}, MouseLock.prototype.unlock = function(o) {
    document.exitPointerLock = document.exitPointerLock || document.mozExitPointerLock, document.exitPointerLock(), o && (this.onUnlock = o)
}, MouseLock.prototype.onChange = function() {
    var o = document.pointerLockElement == document.body || document.pointerLockElement == pc.app.graphicsDevice.canvas;
    !0 === o ? (this.onLock && this.onLock(), clearTimeout(this.lockTimer), this.isActive = !1, this.isLocked = !0, this.isTrying = !1, this.lastLockTime = Date.now()) : (this.onUnlock && this.onUnlock(), this.isTrying = !1, this.isActive = !1, this.isLocked = !1), document.body.style.cursor = "default", this.app.fire("Mouse:LockChange", o)
};
...
CollisionScaler.attributes.add("mapHolder", {
    ...
    for (var i in a) {
        var e = a[i];
        this.scaleCollision(e), e && e.model && e.model.ready((function() {
            l.scaleMaterial(e)
        }))
    }
    ...
    for (var i in a) {
        ...
        if (e.collision) {
            ...
            if (l.originalScale) {
                ...
                c.x /= r.x, c.y /= r.y, c.z /= r.z, c.x = c.x * o, c.y = c.y * n, c.z = c.z * t, e.collision.halfExtents = c
            }
        }
    }
    ...
    if (l.originalScale) {
        ...
        if (i.x /= a.x, i.y /= a.y, i.z /= a.z, l.model && l.model.meshInstances && l.model.meshInstances.length > 0) {
            var e = !1;
            l.originalMaterialScale ? e = l.model.meshInstances[0].material : (e = l.model.meshInstances[0].material.clone(), l.originalMaterialScale = e.diffuseMapTiling.clone()), 1.01 === l.originalMaterialScale.x && (e.diffuseMapTiling.x = l.originalMaterialScale.x * i.x), 1.01 === l.originalMaterialScale.y && (e.diffuseMapTiling.y = l.originalMaterialScale.y * i.x), 1.02 === l.originalMaterialScale.x && (e.diffuseMapTiling.x = l.originalMaterialScale.x * i.z), 1.02 === l.originalMaterialScale.y && (e.diffuseMapTiling.y = l.originalMaterialScale.y * i.z), e.update(), l.model.meshInstances[0].material = e
        }
    }
};
...
KeyboardConfiguration.prototype.initialize = function() {
    this.currentKey = !1, this.app.on("Menu:KeyboardCall", this.setKeyboardTable, this), this.app.on("Menu:KeyboardReset", this.resetKeyboardTable, this), this.app.on("Menu:KeyChange", this.setKey, this), this.app.on("Tab:Settings", this.onSettings, this), this.app.fire("Menu:KeyboardConfiguration", !0), this.on("destory", this.onDestroy, this)
}, KeyboardConfiguration.prototype.onSettings = function(e) {
    "Controls" != e && "Keyboard" != e || setTimeout((function(e) {
        e.setKeyboardTable()
    }), 100, this)
    ...
    e.key;
    var t = Utils.getItem("KeyConfiguration");
    t = t ? JSON.parse(t) : {}, this.currentKey && (t[this.currentKey] = e.key), Utils.setItem("KeyConfiguration", JSON.stringify(t)), this.setKeyboardTable(), this.app.fire("Menu:KeyboardConfiguration", !0), this.currentKey = !1
}, KeyboardConfiguration.prototype.onDestroy = function() {
    this.app.off("Menu:KeyboardCall", this.setKeyboardTable, this), this.app.off("Menu:KeyboardReset", this.resetKeyboardTable, this), this.app.off("Menu:KeyChange", this.setKey, this), this.app.off("Tab:Settings", this.onSettings, this)
};
...
SceneLoader.attributes.add("defaultScenes", {
    ...
    if (this.index = 0, this.app.on("SceneLoader:Load", this.loadIndex, this), this.sceneSetting) {
    ...
    if (this.defaultScenes.length - 1 < this.index) return this.app.fire("NetworkManager:Connect"), !1;
    var e = this;
...
OptimizedLight.prototype.initialize = function() {
    ...
    Date.now() - this.lastLightCheck > 2e3 && (this.entity.light.shadowUpdateMode = pc.SHADOWUPDATE_THISFRAME, this.lastLightCheck = Date.now())
...
MenuController.attributes.add("heroCamera", {
    ...
    this.app.systems.sound.volume = t ? .25 : 0
}, MenuController.prototype.setState = function(t) {
    this.heroCamera.enabled = "Hero" == t, this.mapCamera.enabled = "Pause" == t, this.currentState = t
}, MenuController.prototype.onMapParented = function() {
    clearTimeout(this.parentTimer), this.parentTimer = setTimeout((function(t) {
...
HeroSelector.attributes.add("heroes", {
    ...
    this.currentState = "Hero", this.app.on("View:State", this.setState, this), this.app.on("HeroSelector:Select", this.setHero, this), this.app.on("Transition:Show", this.onTransitionShow, this), this.app.on("Transition:Hide", this.onTransitionHide, this), "undefined" != typeof app ? this.setHero(app.session.character) : this.setHero("Lilium")
    ...
    t && t.model.ready((function() {
        t.enabled = !0, t.findByName("DefaultWeaponHolder").enabled = !1, setTimeout((function(e) {
            t.findByName("DefaultWeaponHolder").enabled = !0
        }), 1e3, this), pc.app.fire("HeroSelector:Loaded", !0)
    }))
};
...
SpecialEffectController.attributes.add("entities", {
    ...
    this.disabled = !1, this.app.on("Game:Settings", this.onSettingsChange, this), this.onSettingsChange(), this.on("destroy", this.onDestroy, this)
    ...
    pc.settings && !0 === pc.settings.disableSpecialEffects ? (this.disabled = !1, this.setStateEntities(!1)) : (this.disabled = !0, this.setStateEntities(!0))
...
AutoResolution.attributes.add("maxSample", {
    ...
    var t = this.avgFPS / this.totalSample,
        o = "HIGH";
    t > 50 && (o = "HIGH"), t > 30 && t <= 50 && (o = "MEDIUM"), t > 1 && t <= 30 && (o = "LOW"), this.app.fire("AutoResolution:Set", o)
}, AutoResolution.prototype.update = function(t) {
    if (!this.isCollecting) return !1;
    this.checkResolution(t), this.totalSample > this.maxSample && (this.setAutoResolution(), this.isCollecting = !1)
};
...
ShopController.attributes.add("holderEntity", {
    ...
    var o = t.touches[0];
    Math.abs(this.lastAngle - o.x) > 1 ? this.entity.sound.slots.Spin.isPlaying || this.entity.sound.play("Spin") : this.entity.sound.stop("Spin"), this.lastAngle = o.x, this.nextRotationAngle = o.x - this.startX
}, ShopController.prototype.onTouchEnd = function(t) {
    if (!this.holderEntity.enabled) return !1;
    this.isMouseDown = !1, this.entity.sound.stop("Spin"), this.isRotating = !1, this.nextRotationAngle = 0
}, ShopController.prototype.onMouseDown = function(t) {
    if (!this.holderEntity.enabled) return !1;
    t.button == pc.MOUSEBUTTON_LEFT && (this.isMouseDown = !0, this.startX = t.x), this.isRotating = !0
}, ShopController.prototype.onMouseMove = function(t) {
    return !!this.holderEntity.enabled && (!!this.isRotating && (Math.abs(this.lastAngle - t.x) > 1 ? this.entity.sound.slots.Spin.isPlaying || this.entity.sound.play("Spin") : this.entity.sound.stop("Spin"), this.lastAngle = t.x, void(this.nextRotationAngle = t.x - this.startX)))
}, ShopController.prototype.onMouseUp = function(t) {
    if (!this.holderEntity.enabled) return !1;
    t.button == pc.MOUSEBUTTON_LEFT && (this.isMouseDown = !1), this.entity.sound.stop("Spin"), this.isRotating = !1, this.nextRotationAngle = 0
    ...
    this.rotatingAngle = pc.math.lerpAngle(this.rotatingAngle, this.nextRotationAngle, .1), "Crate" == this.currentItemName ? (this.view3D.setLocalEulerAngles(0, -25, 0), this.crateResultEntity.setLocalEulerAngles(0, this.rotatingAngle, 0)) : this.view3D.setLocalEulerAngles(0, this.rotatingAngle, 0), this.isRotating || (this.nextRotationAngle += t * this.rotationSpeed)
...
CustomShader.attributes.add("isDebug", {
    ...
    type: "string",
    default: "Ly92ZWMzIHRleHR1cmUgPSB0ZXh0dXJlMkQodGV4dHVyZV8wLCAkVVYpLnJnYjsKCmNvbG9yLnJnYiA9IHZlYzMoMS4wLCAxLjAsIDEuMCk7Cm9wYWNpdHkgPSAxLjA7"
}), CustomShader.prototype.initialize = function() {
    this.reset(), this.isDebug ? this.addCodeEditor() : this.emissive = atob(this.shader), this.on("attr:textures", this.onAttributeChange, this), this.on("attr:colors", this.onAttributeChange, this), this.on("attr:vectors", this.onAttributeChange, this), this.on("attr:numbers", this.onAttributeChange, this), this.on("attr:shader", this.onAttributeChange, this), this.on("state", this.onStateChange, this), this.onAttributeChange()
    ...
    e.style.position = "fixed", e.style.left = "10px", e.style.top = "340px", e.style.width = "100px", e.style.height = "40px", e.style.background = "rgba(0, 0, 0, 0.5)", e.style.color = "#fff", e.textContent = "Copy", e.onclick = function() {
        t.copy(t.emissiveCode.value)
    }, document.body.appendChild(e);
    var a = document.createElement("textarea");
    a.style.position = "fixed", a.style.left = "10px", a.style.top = "10px", a.style.width = "400px", a.style.height = "300px", a.style.padding = "10px", a.style.background = "rgba(0, 0, 0, 0.5)", a.style.outline = "none", a.style.color = "white", a.onkeyup = this.onShaderChange.bind(this);
    var r = document.createElement("style");
    r.innerText = "#application-console{max-height: 80px;}", document.body.appendChild(r), this.emissiveCode = a, this.emissiveCode.value = atob(this.shader), this.emissive = this.emissiveCode.value, this.updateMaterial(), document.body.appendChild(a)
    ...
    return "vec3(" + this.number(t.data[0]) + ", " + this.number(t.data[1]) + ", " + this.number(t.data[2]) + ")"
}, CustomShader.prototype.colorRGBA = function(t) {
    return "vec4(" + this.number(t.data[0]) + ", " + this.number(t.data[1]) + ", " + this.number(t.data[2]) + ", " + this.number(t.data[3]) + ")"
}, CustomShader.prototype.addParameter = function(t, e) {
    var a = "";
    for (var r in this[t]) {
        var s = this[t][r],
            i = !1;
        a += this.line("uniform " + e + " " + s.name + ";"), "textures" == t && (i = s.texture.resource), "colors" == t && (i = s.color.data), "vectors" == t && (i = s.vector.data), "numbers" == t && (i = s.number), this.parameters.push({
            name: s.name,
            resource: i
        })
    }
    ...
    var t = "";
    return t += this.addParameter("textures", "sampler2D"), t += this.addParameter("colors", "vec4"), t += this.addParameter("vectors", "vec2"), t += this.addParameter("numbers", "float"), t += this.line("uniform float timestamp;"), t += this.line("uniform float alpha_ref;"), t += this.line("vec3 getEmission() {"), t += this.line("vec3 color = vec3(0.0);"), t += this.line(this.emissive), t += this.line("dAlpha = opacity;"), t += this.line("return color;"), t += this.line("}"), t += this.line("void getOpacity() {"), t += this.line("}"), t += this.line("void alphaTest(float a) {"), t += this.line("if (a < alpha_ref) discard;"), t += this.line("}")
    ...
    if (this.currentMaterial) {
        ...
        this.currentMaterial.setParameter("timestamp", this.timestamp), this.currentMaterial.setParameter("alpha_ref", this.alpha_ref)
    }
    this.timestamp += t
};
...
Motion.attributes.add("motions", {
    ...
    this.isPlaying = !0, this.timestamp = 0, this.currentMotion = e, this.triggerStartEvent(this.currentMotion)
}, Motion.prototype.triggerEvents = function(t) {
    for (var i in this.events) {
        var e = this.events[i],
            n = e.time;
        e.animationName == this.currentMotion.name && n > this.timestamp && n <= this.timestamp + t && this.app.fire(e.eventName)
    }
...
Chest.attributes.add("airEntity", {
    ...
    this.isClosed = !0, this.slowDown = !1, this.nextFov = 25, this.fovSpeed = .05, this.weaponEntity.enabled = !1, this.app.on("Chest:Start", this.onStart, this), this.app.on("Chest:Close", this.close, this), this.app.on("Chest:Explode", this.onExplode, this), this.app.on("Chest:Open", this.open, this)
}, Chest.prototype.onStart = function(t) {
    this.airEntity.enabled = !0, this.entity.sound.play("Device"), this.entity.sound.play("WhiteShadow"), clearTimeout(this.timer0), this.timer0 = setTimeout((function(t) {
        t.airEntity.enabled = !1
    }), 700, this)
}, Chest.prototype.onExplode = function(t) {
    this.entity.animation.currentTime = 0, this.entity.animation.play("CrateOpen"), this.entity.animation.speed = 1, this.entity.sound.play("Spark"), this.entity.sound.play("Unlock"), this.weaponEntity.enabled = !0, this.app.fire("Motion:Weapon", "Bounce"), this.slowDown = !1, this.originEntity.script.rotate.speed = 20, this.originEntity.setLocalEulerAngles(0, 0, 0), this.sparkEntity.enabled = !0, this.sparkEntity.particlesystem.reset(), this.sparkEntity.particlesystem.play(), clearTimeout(this.timer0), this.timer0 = setTimeout((function(t) {
        t.sparkEntity.enabled = !1, t.entity.animation.speed = 0, t.slowDown = !0
    }), 900, this), clearTimeout(this.timer1), this.timer1 = setTimeout((function(t) {
        t.fovSpeed = .05, t.nextFov = 15
    }), 300, this), clearTimeout(this.timer2), this.timer2 = setTimeout((function(t) {
        t.entity.animation.speed = 0
    }), 500, this)
}, Chest.prototype.close = function(t) {
    this.fovSpeed = .2, this.nextFov = 25, this.entity.animation.speed = 6, this.weaponEntity.enabled = !1, this.isClosed = !0, t && setTimeout((function(i) {
        i.open(t)
    }), 700, this)
}, Chest.prototype.playRarity = function(t) {
    "Legendary" == t.rarity && this.entity.sound.play("Legendary"), "Mythical" == t.rarity && this.entity.sound.play("Mythical"), "Rare" == t.rarity && this.entity.sound.play("Rare"), "Limited" == t.rarity && this.entity.sound.play("Limited")
}, Chest.prototype.open = function(t) {
    if (!this.isClosed) return this.close(t), !1;
    if (this.app.fire("Motion:Chest", "Openning"), this.app.fire("Motion:Origin", "Openning"), t) {
    ...
    } else this.items.forEach((function(t) {
        t.enabled = !1
    }));
    this.isClosed = !1
}, Chest.prototype.update = function(t) {
    this.slowDown && (this.originEntity.script.rotate.speed = pc.math.lerp(this.originEntity.script.rotate.speed, .8, .1)), this.cameraEntity.camera.fov = pc.math.lerp(this.cameraEntity.camera.fov, this.nextFov, this.fovSpeed)
};
...
Mvp.attributes.add("heroes", {
    ...
    this.app.on("View:State", this.setState, this), this.app.on("MVP:Select", this.setHero, this), this.setState("Hero")
    ...
    e && e.model.ready((function() {
        e.enabled = !0, e.animation.play("Taunt"), e.findByName("DefaultWeaponHolder").enabled = !1, setTimeout((function(t) {}), 100, this), pc.app.fire("MVP:Loaded", !0)
    }))
};
...
Transition.attributes.add("cameraEntity", {
    ...
    this.isAlreadyActive = !1, this.blackShadow.enabled = !1, this.app.on("Transition:Show", this.show, this), this.app.on("Transition:Hide", this.hide, this)
}, Transition.prototype.show = function(t, i, e) {
    if (this.isAlreadyActive) return !1;
    this.cameraEntity.enabled = !0, this.modeEntity.element.text = t, this.blackShadow.enabled = !0, this.mapNameEntity.element.text = i.toLowerCase(), this.mapImageEntity.element.textureAsset = Utils.getAssetFromURL(i + "-Large.jpg", "map"), this.mapImageEntity.element.color = pc.colors.white, this.app.fire("Timeline:Map"), this.entity.sound.play("Loading"), this.entity.sound.play("Respawn"), this.isAlreadyActive = !0
}, Transition.prototype.hide = function() {
    this.cameraEntity.enabled = !1, this.mapImageEntity.element.color = pc.colors.black, clearTimeout(this.blackTimer), this.blackTimer = setTimeout((function(t) {
        t.blackShadow.enabled = !1
    }), 500, this), this.isAlreadyActive = !1
};
...
MaterialShader.attributes.add("inEditor", {
    ...
    this.once = !1, this.reset(), this.isDebug ? this.addCodeEditor() : (this.emissive = atob(this.shader), this.updateMaterial()), this.on("attr:textures", this.onAttributeChange, this), this.on("attr:colors", this.onAttributeChange, this), this.on("attr:vectors", this.onAttributeChange, this), this.on("attr:numbers", this.onAttributeChange, this), this.on("attr:curves", this.onAttributeChange, this), this.on("attr:shader", this.onAttributeChange, this), this.entity.on("MaterialShader:Set", this.setVariable, this), this.on("state", this.onStateChange, this), this.entity.on("Model:Loaded", this.onModelLoaded, this), this.app.on("MaterialShader:Reset", this.onStateChange, this), this.material && (this.totalAssets = 2 + this.textures.length, this.loaded = 0, this.loadAllAssets())
    ...
    for (var r in a.ready((function() {
            t.loaded++, t.isLoaded()
        })), this.app.assets.load(a), this.material.ready((function() {
            t.loaded++, t.isLoaded()
    ...
    for (var a in this.parameters) {
        ...
        this.currentMaterial.setParameter(r.name, r.resource), r.name == t && (this.parameters[a].resource = e)
    }
    ...
    var t = this,
        e = document.createElement("button");
    e.style.position = "fixed", e.style.left = "10px", e.style.top = "340px", e.style.width = "100px", e.style.height = "40px", e.style.zIndex = "5000", e.style.background = "rgba(0, 0, 0, 0.5)", e.style.color = "#fff", e.textContent = "Copy", e.onclick = function() {
        t.copy(t.emissiveCode.value)
    }, document.body.appendChild(e);
    var a = document.createElement("textarea");
    ...
    for (var r in this[t]) {
        var i = this[t][r],
            s = !1;
        if (a += this.line("uniform " + e + " " + i.name + ";"), "textures" == t && (s = i.texture.resource), "colors" == t && (s = i.color.data), "vectors" == t && (s = i.vector.data), "curves" == t) {
            var o = i.curve.value(this.timestamp * i.speed);
            s = [o[0], o[1], o[2]]
        }
        "numbers" == t && (s = i.number), this.parameters.push({
            name: i.name,
            resource: s
        })
    }
    ...
    var t = "";
    return t += this.addParameter("textures", "sampler2D"), t += this.addParameter("colors", "vec4"), t += this.addParameter("vectors", "vec2"), t += this.addParameter("numbers", "float"), t += this.addParameter("curves", "vec3"), t += this.line("uniform float timestamp;"), t += this.line("uniform float alpha_ref;"), t += this.line("vec4 color  = vec4(0.0);"), t += this.line("vec3 vertex = vec3(0.0);"), t += this.line(this.emissive), t += this.line("void getEmission() {"), t += this.line("}"), t += this.line("void getAlbedo() {"), t += this.line("}"), t += this.line("void getOpacity() {"), t += this.line("}"), t += this.line("void alphaTest(float a) {"), t += this.line("if (a < alpha_ref) discard;"), t += this.line("}")
...
var MapTesting = pc.createScript("mapTesting");
MapTesting.prototype.initialize = function() {
    var e = this.app.scenes.find("Prototype"),
        p = this.app.root,
        t = "1.0.0";
    "undefined" != typeof VERSION && (t = VERSION);
    var i = window.location.hash;
    i = (i = i.split("#"))[1], this.app.scenes.loadSceneHierarchy(e.url + "?v=" + t, (function(e, t) {
        t.reparent(p), pc.app.fire("Network:Options", {
            map: i
        })
    }))
};
...
TouchFix.prototype.initialize = function() {
    if (!this.app.touch) return !1;
    this.app.touch.detach(), this.app.elementInput.detach(), this.app.touch.getTouchTargetCoords = function(i) {
        return console.log(i), window.innerHeight > window.innerWidth ? {
            y: i.pageX,
            x: window.innerHeight - i.pageY
        } : {
            x: i.pageX,
            y: i.pageY
        }
    }, this.app.elementInput._calcMouseCoords = function(i) {
        return window.innerHeight > window.innerWidth ? {
            y: i.clientX,
            x: window.innerHeight - i.clientY
        } : {
            x: i.clientX,
            y: i.clientY
        }
    }, this.app.elementInput._calcTouchCoords = function(i) {
        return window.innerHeight > window.innerWidth ? {
            y: i.pageX,
            x: window.innerHeight - i.pageY
        } : {
    ...
    }, this.app.elementInput.attach(this.app.graphicsDevice.canvas), this.app.touch.attach(this.app.graphicsDevice.canvas)
};